...
static ADDRESS_MAP_START(mbc55x_io, AS_IO, 8)
	AM_RANGE( 0X0000, 0X0003) AM_READWRITE( pic8259_r, pic8259_w)
	...
	AM_RANGE( 0X0020, 0X0027) AM_READWRITE( pit8253_r, pit8253_w)
	AM_RANGE( 0x0028, 0x002B) AM_READWRITE( mbc55x_usart_r, mbc55x_usart_w)
    AM_RANGE( 0x0030, 0x0033) AM_READWRITE( mbc55x_video_io_r, mbc55x_video_io_w)
...
static MACHINE_CONFIG_START( mbc55x, mbc55x_state )
    ...
    MCFG_SCREEN_UPDATE(mbc55x)
    MCFG_SCREEN_EOF(mbc55x)
...
COMP( 1983, mbc55x,     0,      0,      mbc55x, mbc55x, 0,   "Sanyo", "mbc55x", 0 /*GAME_NO_SOUND*/)
