...
NOTES ABOUT THE TEST ROM (-bios 1):
...
static INPUT_PORTS_START( okean240a )
	...
	PORT_START("X7")
	PORT_BIT(0x01, IP_ACTIVE_HIGH, IPT_UNUSED) //92
	...
	PORT_BIT(0x40, IP_ACTIVE_HIGH, IPT_UNUSED) //85
	PORT_BIT(0x80, IP_ACTIVE_HIGH, IPT_KEYBOARD) PORT_NAME("_") PORT_CODE(KEYCODE_END)

	PORT_START("X8")
	PORT_BIT(0x01, IP_ACTIVE_HIGH, IPT_UNUSED) //83
...
static MACHINE_CONFIG_START( okean240, okean240_state )
	...
	MCFG_GENERIC_TERMINAL_ADD(TERMINAL_TAG, okean240_terminal_intf)
MACHINE_CONFIG_END
