...
DEFINES = -DFLAC__NO_ASM -DFLAC__NO_DLL -DFLAC__ALIGN_MALLOC_DATA
...
VERSION=\"1.2.1\"
CONFIG_CFLAGS=-DHAVE_INTTYPES_H -DHAVE_ICONV  -DFLAC__NO_ASM -DFLAC__NO_DLL -D__MINGW32__ -DHAVE_LANGINFO_CODESET -DHAVE_SOCKLEN_T -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64
LIBFLACCFLAGS = -O3 -fomit-frame-pointer -DNDEBUG $(CONFIG_CFLAGS) $(RELEASE_CFLAGS) -Wno-int-to-pointer-cast -Wno-pointer-to-int-cast -DVERSION=$(VERSION) $(DEFINES) $(INCLUDES)
ifdef MSVC_BUILD
LIBFLACCFLAGS += -DFLaC__INLINE=__inline
else
LIBFLACCFLAGS += -DFLaC__INLINE=__inline__ -funroll-loops -finline-functions
endif
