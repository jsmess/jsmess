...
//printf("dma8237_r() %08x: offset = %02x, data = %02x\n", activecpu_get_pc(), offset, data);
	return data;
}
...
//printf("dma8237_w() %08x: offset = %02x, data = %02x\n", activecpu_get_pc(), offset, data);
	offset &= 0x0F;
...
void dma8237_run_transfer(const device_config *device, int channel)
{
	...
	logerror("dma8237_run_transfer: please do not use me anymore\n");
