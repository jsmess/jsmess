...
{
public:
	de_3_state(running_machine &machine, const driver_device_config_base &config)
...
GAME(1998,	titanic,		0,			de_3,	de_3,	de_3,	ROT0,	"Sega",			"Titanic (Coin dropper)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(2002,	monopred,		0,			de_3,	de_3,	de_3,	ROT0,	"Stern",		"Monopoly (Coin dropper)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(1998,	wackadoo,		0,			de_3,	de_3,	de_3,	ROT0,	"Sega",			"Wack-A-Doodle-Doo (Redemption)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
