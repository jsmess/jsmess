...
ROM_START( macsbios )
	...
	ROM_COPY( REGION_USER1,   0x00000, 0x010000, 0x400000 )
...
ROM_START( kisekaem )
	...
	ROM_COPY( REGION_USER2,   0x00000, 0x000000, 0x0008000 )
ROM_END
...
ROM_START( cultname ) // uses printer - two different games ? (slot a - checks for printer, slot b - not)
	...
	ROM_REGION( 0x400000, REGION_USER3, 0 ) // Slot A
	...
	ROM_REGION( 0x400000, REGION_USER2, 0 ) // Slot B
...
ROM_START( yuka )
	...
	ROM_REGION( 0x400000, REGION_USER3, ROMREGION_ERASE00 ) // Slot B
...
GAME( 1999, yuka,     macsbios, macs, macs, macs, ROT0, "Yubis / T.System", "Yu-Ka",  0 )
GAME( 1999, yujan,    macsbios, macs, macs, macs, ROT0, "Yubis / T.System", "Yu-Jan",  0 )
