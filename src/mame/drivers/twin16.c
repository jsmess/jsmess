...
ROM_START( vulcan )
	...
	ROM_REGION( 0x20000, REGION_GFX3, ROMREGION_ERASE00 )	// tile data; mapped at 0x80000 on CPUB
...
ROM_START( cuebrick )
	...
	ROM_REGION( 0x200000, REGION_GFX2, ROMREGION_ERASE00 )	// gfx data used at runtime
	// unpopulated
