...
static GFXDECODE_START( hcastle )
	GFXDECODE_ENTRY( REGION_GFX1, 0, charlayout,       0, 8*16 )	/* 007121 #0 */
	GFXDECODE_ENTRY( REGION_GFX2, 0, charlayout, 8*16*16, 8*16 )	/* 007121 #1 */
GFXDECODE_END
...
static MACHINE_DRIVER_START( hcastle )
	...
	MDRV_SCREEN_VBLANK_TIME(DEFAULT_60HZ_VBLANK_DURATION	/* frames per second verified by comparison with real board */)
