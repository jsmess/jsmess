...
{
public:
	whitestar_mod_state(running_machine &machine, const driver_device_config_base &config)
		: driver_device(machine, config) { }
};


static ADDRESS_MAP_START( whitestar_mod_map, ADDRESS_SPACE_PROGRAM, 8 )
...
//ROM_LOAD( "ripsnd.u7",     0x0000, 0x10000, CRC(e5c7edea) SHA1(c0075fb35c746afe54808d4901ddb61ba396f36d))
//ROM_LOAD( "ripsndf.u7",    0x0000, 0x10000, CRC(00fc94de) SHA1(207ceea5ccd39a99c5b5ed1f945dce3f1fc076d7))
//ROM_LOAD( "ripsndg.u7",    0x0000, 0x10000, CRC(ff7b6b55) SHA1(e2e0e1f6cfae0fbcb5151bf2cb17fbb52f2d9f23))
//ROM_LOAD( "ripsndi.u7",    0x0000, 0x10000, CRC(b966a2c1) SHA1(1aa83dc5b87fc16fc4281f577e61eb2661cfad09))
...
ROM_START(lotr)
	ROM_REGION(0x80000, "user1", 0)
	ROM_LOAD("lotrcpua.a00", 0x00000, 0x20000, CRC(00e43b70) SHA1(7100da644a1b166051915870d01cfa6baaf87293)) // ver 10.00
	//ROM_LOAD("lotrcpu.401",   0x0000, 0x20000, CRC(b69cdecc) SHA1(40f7c2d25a1028255be8fe25e3aa6d11976edd25)) // ver 4.01
	//ROM_LOAD("lotrcpu.700",   0x0000, 0x20000, CRC(208a4653) SHA1(570f3070c6b0f128d451f3dea01e41a9944081f2)) // ver 7.00
	//ROM_LOAD("lotrcpu.800",   0x0000, 0x20000, CRC(655e5b3c) SHA1(bd6fd25e17cee40d6bb842367b1ce922bbd46003)) // ver 8.00
	//ROM_LOAD("lotrcpu.900",   0x0000, 0x20000, CRC(eff1ab83) SHA1(cd9cfa3fa150224e44078602db7d8bbfe223b926)) // ver 9.00
	ROM_RELOAD(0x20000, 0x20000)
	ROM_RELOAD(0x40000, 0x20000)
	ROM_RELOAD(0x60000, 0x20000)
	ROM_REGION(0x10000, "maincpu", 0)
	...
	//ROM_LOAD( "lotrdspa.403",  0x0000, 0x80000, CRC(2630cef1) SHA1(1dfd929e7eb57983f2fd9184d471f2e919359de0)) // ver 4.03
	//ROM_LOAD( "lotrdspa.700",  0x0000, 0x80000, CRC(233ef0ad) SHA1(1564ae806639dac49add0c464f4499f46b5589ab)) // ver 7.00
	//ROM_LOAD( "lotrdspa.800",  0x0000, 0x80000, CRC(2aa1f00d) SHA1(e9df5b61b467c307aacdb5a6980a78af26492e6a)) // ver 8.00
	//ROM_LOAD( "lotrdspa.900",  0x0000, 0x80000, CRC(2b1debd3) SHA1(eab1ffa7b5111bf224c47688bb6c0f40ee6e12fb)) // ver 9.00
	ROM_REGION32_LE(0x600000, "cpu2", 0)
	ROM_LOAD("bios.u8", 0x400000, 0x200000, CRC(c049bf99) SHA1(89e76760e8010fe642ed4312732de81c8a25f548))
	ROM_RELOAD(0x0,0x200000)
	ROM_REGION(0x10000, "sound1", 0)
...
ROM_START(lotr_sp)
	...
	//ROM_LOAD( "lotrcpul.401",  0x0000, 0x20000, CRC(a9571728) SHA1(f21dd77003f42fafd9293fab3a077c5abf6d572a)) // ver 4.01
	//ROM_LOAD( "lotrcpul.700",  0x0000, 0x20000, CRC(58d8611b) SHA1(ff1e1668993c7c31f04efc22f04ae53112219a1d)) // ver 7.00
	//ROM_LOAD( "lotrcpul.800",  0x0000, 0x20000, CRC(38e83068) SHA1(603b1236bf195c72d32e5a1088a2806e77176436)) // ver 8.00
	//ROM_LOAD( "lotrcpul.900",  0x0000, 0x20000, CRC(155b5d5b) SHA1(c032e3828ed256240a5155ec4c7820d615a2cbe1)) // ver 9.00
	ROM_RELOAD(0x20000, 0x20000)
	ROM_RELOAD(0x40000, 0x20000)
	ROM_RELOAD(0x60000, 0x20000)
	ROM_REGION(0x10000, "maincpu", 0)
...
//ROM_LOAD( "lotrdspl.403",  0x0000, 0x80000, CRC(6d4075c9) SHA1(7944ba597cb476c33060cead4feaf6dcad4f4b16)) // ver 4.03
//ROM_LOAD( "lotrdspl.700",  0x0000, 0x80000, CRC(3be0283d) SHA1(e019c69cd452b67d6427ddda12b5c3f341afb414)) // ver 7.00
//ROM_LOAD( "lotrdspl.800",  0x0000, 0x80000, CRC(137c1255) SHA1(43d9ffec18ab2aa80f30b195ca5270d4574d7b8d)) // ver 8.00
//ROM_LOAD( "lotrdspl.900",  0x0000, 0x80000, CRC(00f98242) SHA1(9a0e7e572e209b20691392a694a524192daa0d2a)) // ver 9.00
	ROM_REGION32_LE(0x600000, "cpu2", 0)
	ROM_LOAD("bios.u8", 0x400000, 0x200000, CRC(c049bf99) SHA1(89e76760e8010fe642ed4312732de81c8a25f548))
	ROM_RELOAD(0x0,0x200000)
	ROM_REGION(0x10000, "sound1", 0)
...
//ROM_LOAD( "lotrdspg.403",  0x0000, 0x80000, CRC(74e925cb) SHA1(2edc8666d53f212a053b7a356d2bf6e3180d7bfb)) // ver 4.03
//ROM_LOAD( "lotrdspg.700",  0x0000, 0x80000, CRC(137f223c) SHA1(bb06a6f587bf86555aea85bc1c0402e2137e1c76)) // ver 7.00
//ROM_LOAD( "lotrdspg.800",  0x0000, 0x80000, CRC(55765c23) SHA1(690a72e8cb1099a6873eb3214e72bb0fea54fa22)) // ver 8.00
//ROM_LOAD( "lotrdspg.900",  0x0000, 0x80000, CRC(f5fdd2c2) SHA1(0c5f1b1efe3d38063e2327e2ccfe40936f3988b8)) // ver 9.00
	ROM_REGION32_LE(0x600000, "cpu2", 0)
	ROM_LOAD("bios.u8", 0x400000, 0x200000, CRC(c049bf99) SHA1(89e76760e8010fe642ed4312732de81c8a25f548))
	ROM_RELOAD(0x0,0x200000)
	ROM_REGION(0x10000, "sound1", 0)
...
//ROM_LOAD( "lotrdspf.403",  0x0000, 0x80000, CRC(d02a77cf) SHA1(8cf4312a04ad486714de5c0041cacb1eb475478f)) // ver 4.03
//ROM_LOAD( "lotrdspf.700",  0x0000, 0x80000, CRC(c98aeb30) SHA1(16b0ae41db8b4083121cc5ebf2706320d554dd08)) // ver 7.00
//ROM_LOAD( "lotrdspf.800",  0x0000, 0x80000, CRC(e1ccc04b) SHA1(1d5c7ea06f0cb2e1965c968ed01330867aae8e2b)) // ver 8.00
//ROM_LOAD( "lotrdspf.900",  0x0000, 0x80000, CRC(f2d8296e) SHA1(3eb6e1e6ba299b720816bf165b1e20e02f6c0c1e)) // ver 9.00
	ROM_REGION32_LE(0x600000, "cpu2", 0)
	ROM_LOAD("bios.u8", 0x400000, 0x200000, CRC(c049bf99) SHA1(89e76760e8010fe642ed4312732de81c8a25f548))
	ROM_RELOAD(0x0,0x200000)
	ROM_REGION(0x10000, "sound1", 0)
...
//ROM_LOAD( "lotrdspi.700",  0x0000, 0x80000, CRC(6a0d2a6d) SHA1(2b3ca8b26d79919b7102c60515972ab142d1cbf1)) // ver 7.00
//ROM_LOAD( "lotrdspi.800",  0x0000, 0x80000, CRC(b80730d7) SHA1(552c0bfac1c7a6b246829378a30d58769e695f7e)) // ver 8.00
//ROM_LOAD( "lotrdspi.900",  0x0000, 0x80000, CRC(a09407d7) SHA1(2cdb70ee0bae7f67f4bf12b0dd3e6cf574087e3d)) // ver 9.00
	ROM_REGION32_LE(0x600000, "cpu2", 0)
	ROM_LOAD("bios.u8", 0x400000, 0x200000, CRC(c049bf99) SHA1(89e76760e8010fe642ed4312732de81c8a25f548))
	ROM_RELOAD(0x0,0x200000)
	ROM_REGION(0x10000, "sound1", 0)
...
////ROM_LOAD( "sopsndf.u17",  0x0000, 0x100000, CRC(9e0dd4a8) SHA1(82b772eb7081f22f1203ed113ec7b05f2e26258c))
...
////ROM_LOAD( "sopsndg.u21",  0x0000, 0x100000, CRC(caae114a) SHA1(84703649d7ba05d011348f84e4cac31a023146c0))
...
////ROM_LOAD( "sopsndi.u17",  0x0000, 0x100000, CRC(7cb762dd) SHA1(84ec54d6495ccb02052c8d5b6b66c018a702bb4e))
...
////ROM_LOAD( "sopsndl.u21",  0x0000, 0x100000, CRC(66cdb90d) SHA1(d96e1b92e54a94b5e0ed9d62cff9220b9e215e85))
////ROM_LOAD( "sopsnda.u17",  0x0000, 0x100000, CRC(1ecc5ecc) SHA1(42897387b90df8da8ae556ccc46e281ca461c063))
////ROM_LOAD( "sopsnda.u7",    0x0000, 0x10000, CRC(4f6748b5) SHA1(63e953a1455dee2a44484fef951fa34cb2e55d7b))
//ROM_LOAD( "sopcpuf.107",   0x0000, 0x20000, CRC(1cc86040) SHA1(0b4322eca8a5be7ea92356adf65b6c6c6f4205ca))
//ROM_LOAD( "sopdspf.100",   0x0000, 0x80000, CRC(18c36c19) SHA1(2b2e5cb00b92d7c8875de2d2d19b82305d9fb27f))
...
ROM_START(soprano3)
	...
	ROM_REGION(0x400000, "sound2", 0)
	ROM_LOAD("sopsnda.u17", 0x000000, 0x100000, CRC(21e0cfd2) SHA1(d2ff1242f1f4a206e0b2884c079ef2be5df143ac))
	ROM_LOAD("sopsnd3.u21", 0x100000, 0x100000, CRC(257ab09d) SHA1(1d18e279139b1658ce02160d9a37b4bf043393f0))
	ROM_LOAD("sopsnd3.u36", 0x200000, 0x100000, CRC(db33b45c) SHA1(d3285008a3c770371389be470c1ec5ca49c1e568))
	ROM_LOAD("sopsnd3.u37", 0x300000, 0x100000, CRC(06a2a6e1) SHA1(fdbe622223724ac2b4c5183c43d3e635654864bf))
ROM_END
...
GAME(2004,	elvisl,		elvisp,		whitestar_mod,	whitestar_mod,	whitestar_mod,	ROT0,	"Stern",	"Elvis (Spain)",					GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(2004,	elvisg,		elvisp,		whitestar_mod,	whitestar_mod,	whitestar_mod,	ROT0,	"Stern",	"Elvis (Germany)",					GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(2004,	elvisf,		elvisp,		whitestar_mod,	whitestar_mod,	whitestar_mod,	ROT0,	"Stern",	"Elvis (France)",					GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(2004,	elvisi,		elvisp,		whitestar_mod,	whitestar_mod,	whitestar_mod,	ROT0,	"Stern",	"Elvis (Italy)",					GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
...
GAME(2005,	gprixg,		gprix,		whitestar_mod,	whitestar_mod,	whitestar_mod,	ROT0,	"Stern",	"Grand Prix (Germany)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(2005,	gprixl,		gprix,		whitestar_mod,	whitestar_mod,	whitestar_mod,	ROT0,	"Stern",	"Grand Prix (Spain)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(2005,	gprixf,		gprix,		whitestar_mod,	whitestar_mod,	whitestar_mod,	ROT0,	"Stern",	"Grand Prix (France)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(2005,	gprixi,		gprix,		whitestar_mod,	whitestar_mod,	whitestar_mod,	ROT0,	"Stern",	"Grand Prix (Italy)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
...
GAME(2005,	nascarl,	nascar,		whitestar_mod,	whitestar_mod,	whitestar_mod,	ROT0,	"Stern",	"Nascar (Spain)",					GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
...
GAME(2004,	ripleysf,	ripleys,	whitestar_mod,	whitestar_mod,	whitestar_mod,	ROT0,	"Stern",	"Ripley's Believe It or Not! (France)",	GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(2004,	ripleysg,	ripleys,	whitestar_mod,	whitestar_mod,	whitestar_mod,	ROT0,	"Stern",	"Ripley's Believe It or Not! (Germany)",GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(2004,	ripleysi,	ripleys,	whitestar_mod,	whitestar_mod,	whitestar_mod,	ROT0,	"Stern",	"Ripley's Believe It or Not! (Italy)",	GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(2004,	ripleysl,	ripleys,	whitestar_mod,	whitestar_mod,	whitestar_mod,	ROT0,	"Stern",	"Ripley's Believe It or Not! (Spain)",	GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
...
GAME(2003,	lotr_sp,	lotr,		whitestar_mod,	whitestar_mod,	whitestar_mod,	ROT0,	"Stern",	"Lord Of The Rings, The (Spain)",		GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(2003,	lotr_gr,	lotr,		whitestar_mod,	whitestar_mod,	whitestar_mod,	ROT0,	"Stern",	"Lord Of The Rings, The (Germany)",		GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(2003,	lotr_fr,	lotr,		whitestar_mod,	whitestar_mod,	whitestar_mod,	ROT0,	"Stern",	"Lord Of The Rings, The (France)",		GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(2003,	lotr_it,	lotr,		whitestar_mod,	whitestar_mod,	whitestar_mod,	ROT0,	"Stern",	"Lord Of The Rings, The (Italy)",		GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
...
GAME(2005,	soprano3,	sopranos,	whitestar_mod,	whitestar_mod,	whitestar_mod,	ROT0,	"Stern",	"Sopranos, The (3.00)",					GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(2005,	sopranog,	sopranos,	whitestar_mod,	whitestar_mod,	whitestar_mod,	ROT0,	"Stern",	"Sopranos, The (Germany)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(2005,	sopranof,	sopranos,	whitestar_mod,	whitestar_mod,	whitestar_mod,	ROT0,	"Stern",	"Sopranos, The (France)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(2005,	sopranol,	sopranos,	whitestar_mod,	whitestar_mod,	whitestar_mod,	ROT0,	"Stern",	"Sopranos, The (Spain)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(2005,	sopranoi,	sopranos,	whitestar_mod,	whitestar_mod,	whitestar_mod,	ROT0,	"Stern",	"Sopranos, The (Italy)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
