...
static void video_start_cyberbal_common(running_machine* machine, int screens)
{
	...
	{
		/* initialize the playfield */
		atarigen_playfield2_tilemap = tilemap_create(get_playfield2_tile_info, tilemap_scan_rows, TILEMAP_TYPE_OPAQUE, 16,8, 64,64);
		...
		/* initialize the alphanumerics */
		atarigen_alpha2_tilemap = tilemap_create(get_alpha2_tile_info, tilemap_scan_rows, TILEMAP_TYPE_TRANSPARENT, 16,8, 64,32);
