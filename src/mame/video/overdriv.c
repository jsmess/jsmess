...
{
	K053251_vh_start();
	K051316_vh_start_0(machine,REGION_GFX2,4,TILEMAP_TYPE_OPAQUE,0,zoom_callback_0);
	K051316_vh_start_1(machine,REGION_GFX3,4,TILEMAP_TYPE_TRANSPARENT,0,zoom_callback_1);
