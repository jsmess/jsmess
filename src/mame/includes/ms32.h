...
extern void ms32_rearrange_sprites(running_machine *machine, int region);
extern void decrypt_ms32_tx(running_machine *machine, int addr_xor,int data_xor, int region);
extern void decrypt_ms32_bg(running_machine *machine, int addr_xor,int data_xor, int region);
