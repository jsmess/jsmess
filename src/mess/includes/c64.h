...
#define LIGHTPEN				(( readinputportbytag( "DSW0" ) & 0xe000 ) == 0xa000 )
#define MOUSE1					(( readinputportbytag( "DSW0" ) & 0xe000 ) == 0x8000 )
#define JOYSTICK1_2BUTTON		(( readinputportbytag( "DSW0" ) & 0xe000 ) == 0x6000 )
#define PADDLES12				(( readinputportbytag( "DSW0" ) & 0xe000 ) == 0x4000 )
#define JOYSTICK1				(( readinputportbytag( "DSW0" ) & 0xe000 ) == 0x2000 )
#define LIGHTPEN_POINTER		( LIGHTPEN && ( readinputportbytag( "DSW0" ) & 0x1000))
#define MOUSE2					(( readinputportbytag( "DSW0" ) & 0xe000 ) == 0x800 )
#define JOYSTICK2_2BUTTON		(( readinputportbytag( "DSW0" ) & 0xe000 ) == 0x600 )
#define PADDLES34				(( readinputportbytag( "DSW0" ) & 0xe000 ) == 0x400 )
#define JOYSTICK2				(( readinputportbytag( "DSW0" ) & 0xe000 ) == 0x200 )
#define JOYSTICK_SWAP			( readinputportbytag( "DSW0" ) & 0x100 )

#define PADDLE1_BUTTON	(( readinputportbytag( "PAD1" ) & 0x100 ))
#define PADDLE1_VALUE	( readinputportbytag( "PAD1" ) & 0xff )
#define PADDLE2_BUTTON	(( readinputportbytag( "PAD2" ) & 0x100 ))
#define PADDLE2_VALUE	( readinputportbytag( "PAD2" ) & 0xff )
#define PADDLE3_BUTTON	(( readinputportbytag( "PAD3" ) & 0x100 ))
#define PADDLE3_VALUE	( readinputportbytag( "PAD3" ) & 0xff )
#define PADDLE4_BUTTON	(( readinputportbytag( "PAD4" ) & 0x100 ))
#define PADDLE4_VALUE	( readinputportbytag( "PAD4" ) & 0xff )

#define MOUSE1_BUTTON1	( MOUSE1 && ( readinputportbytag( "TRX" ) & 0x8000 ))
#define MOUSE1_BUTTON2	( MOUSE1 && ( readinputportbytag( "TRX" ) & 0x4000 ))
#define MOUSE1_X		(( readinputportbytag( "TRX" ) & 0x3ff ))
#define MOUSE1_Y		( readinputportbytag( "TRY" ))

#define MOUSE2_BUTTON1	( MOUSE1 && ( readinputportbytag( "TRX" ) & 0x8000 ))
#define MOUSE2_BUTTON2	( MOUSE1 && ( readinputportbytag( "TRX" ) & 0x4000 ))
#define MOUSE2_X		(( readinputportbytag( "TRX" ) & 0x3ff ))
#define MOUSE2_Y		( readinputportbytag( "TRY" ))

#define LIGHTPEN_BUTTON		( LIGHTPEN && ( readinputportbytag( "TRX" ) & 0x8000 ))
#define LIGHTPEN_X_VALUE	(( readinputportbytag( "TRX" ) & 0x3ff ) & ~1)	/* effective resolution */
#define LIGHTPEN_Y_VALUE	( readinputportbytag( "TRY" ) & ~1)				/* effective resolution */

#define JOYSTICK_1_LEFT		(( readinputportbytag( "JOY" ) & 0x8000 ))
#define JOYSTICK_1_RIGHT	(( readinputportbytag( "JOY" ) & 0x4000 ))
#define JOYSTICK_1_UP		(( readinputportbytag( "JOY" ) & 0x2000 ))
#define JOYSTICK_1_DOWN		(( readinputportbytag( "JOY" ) & 0x1000 ))
#define JOYSTICK_1_BUTTON	(( readinputportbytag( "JOY" ) & 0x800 ))
#define JOYSTICK_1_BUTTON2	(( readinputportbytag( "JOY" ) & 0x400 ))
#define JOYSTICK_2_LEFT		(( readinputportbytag( "JOY" ) & 0x80 ))
#define JOYSTICK_2_RIGHT	(( readinputportbytag( "JOY" ) & 0x40 ))
#define JOYSTICK_2_UP		(( readinputportbytag( "JOY" ) & 0x20 ))
#define JOYSTICK_2_DOWN		(( readinputportbytag( "JOY" ) & 0x10 ))
#define JOYSTICK_2_BUTTON	(( readinputportbytag( "JOY" ) & 8 ))
#define JOYSTICK_2_BUTTON2	(( readinputportbytag( "JOY" ) & 4 ))

#define QUICKLOAD			( readinputportbytag( "Config" ) & 0x8000 )

/* to be cleaned up, when tape emulation uses standard MESS cassette code */
#define DATASSETTE			( readinputportbytag( "Config" ) & 0x4000 )
#define DATASSETTE_TONE		( readinputportbytag( "Config" ) & 0x2000 )
#define DATASSETTE_PLAY		( readinputportbytag( "Config" ) & 0x1000 )
#define DATASSETTE_RECORD	( readinputportbytag( "Config" ) & 0x800 )
#define DATASSETTE_STOP		( readinputportbytag( "Config" ) & 0x400 )

#define SID8580				(( readinputportbytag( "Config" ) & 0x80) ? MOS8580 : MOS6581)

#define AUTO_MODULE			(( readinputportbytag( "Config" ) & 0x1c ) == 0 )
#define ULTIMAX_MODULE		(( readinputportbytag( "Config" ) & 0x1c ) == 4 )
#define C64_MODULE			(( readinputportbytag( "Config" ) & 0x1c ) == 8 )
#define SUPERGAMES_MODULE	(( readinputportbytag( "Config" ) & 0x1c ) == 0x10 )
#define ROBOCOP2_MODULE		(( readinputportbytag( "Config" ) & 0x1c ) == 0x14 )
#define C128_MODULE			(( readinputportbytag( "Config" ) & 0x1c ) == 0x18 )

#define KEY_RESTORE			( readinputportbytag( "Special" ) & 0x80 )
