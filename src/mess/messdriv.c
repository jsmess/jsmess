...
//  DRIVER( megaopd )
    ...
    /* TEXAS INSTRUMENTS */
//0133u3    DRIVER( ti990_10 )  /* 1975 TI 990/10                                   */
//0133u3    DRIVER( ti990_4 )   /* 1976 TI 990/4                                    */
//0133u3    DRIVER( 990189 )    /* 1978 TM 990/189                                  */
//0133u3    DRIVER( 990189v )   /* 1980 TM 990/189 with Color Video Board           */

//0133u3    DRIVER( ti99_224 )  /* 1983 TI 99/2 (24kb ROMs)                         */
//0133u3    DRIVER( ti99_232 )  /* 1983 TI 99/2 (32kb ROMs)                         */
//0133u3    DRIVER( ti99_4 )    /* 1979 TI-99/4                                     */
//0133u3    DRIVER( ti99_4e )   /* 1980 TI-99/4 with 50Hz video                     */
//0133u3    DRIVER( ti99_4a )   /* 1981 TI-99/4A                                    */
//0133u3    DRIVER( ti99_4ae )  /* 1981 TI-99/4A with 50Hz video                    */
//0133u3    DRIVER( ti99_4ev)   /* 1994 TI-99/4A with EVPC video card               */
//0133u3    DRIVER( ti99_8 )    /* 1983 TI-99/8                                     */
//0133u3    DRIVER( ti99_8e )   /* 1983 TI-99/8 with 50Hz video                     */

    /* TI 99 clones */
//0133u3    DRIVER( tutor)      /* 1983? Tomy Tutor                                 */
//0133u3    DRIVER( geneve )    /* 1987? Myarc Geneve 9640                          */
//0133u3    DRIVER( genmod )    /* 199?? Myarc Geneve 9640                          */
//0133u3    DRIVER( ti99_4p )   /* 1996 SNUG 99/4P (a.k.a. SGCPU)                   */

//0133u3    DRIVER( avigo )     /*                                                  */

    /* TEXAS INSTRUMENTS CALCULATORS */
//0133u3    DRIVER( ti73 )      /* 1990 TI-73                                       */
//0133u3    DRIVER( ti81 )      /* 1990 TI-81 (Z80 2 MHz)                           */
//0133u3    DRIVER( ti85 )      /* 1992 TI-85 (Z80 6 MHz)                           */
//0133u3    DRIVER( ti82 )      /* 1993 TI-82 (Z80 6 MHz)                           */
//0133u3    DRIVER( ti83 )      /* 1996 TI-83 (Z80 6 MHz)                           */
//0133u3    DRIVER( ti86 )      /* 1997 TI-86 (Z80 6 MHz)                           */
//0133u3    DRIVER( ti83p )     /* 1999 TI-83 Plus (Z80 6 MHz)                      */
//0133u3    DRIVER( ti83pse )   /* 2001 TI-83 Plus Silver Edition                   */
//  DRIVER( ti84p )     /* 2004 TI-84 Plus                                  */
//0133u3    DRIVER( ti84pse )   /* 2004 TI-84 Plus Silver Edition                   */
//0133u3    DRIVER( ti89 )      /* 1998 TI-89                                       */
//0133u3    DRIVER( ti92 )      /* 1995 TI-92                                       */
//0133u3    DRIVER( ti92p )     /* 1999 TI-92 Plus                                  */
