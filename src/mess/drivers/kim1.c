...
static INPUT_PORTS_START( kim1 )
	PORT_START_TAG("LINE0")			/* IN0 keys row 0 */
	...
	PORT_START_TAG("LINE1")			/* IN1 keys row 1 */
	PORT_BIT( 0x80, 0x00, IPT_UNUSED )
	...
	PORT_START_TAG("LINE2")			/* IN2 keys row 2 */
	PORT_BIT( 0x80, 0x00, IPT_UNUSED )
	...
	PORT_START_TAG("LINE3")			/* IN3 STEP and RESET keys, MODE switch */
	PORT_BIT( 0x80, 0x00, IPT_UNUSED )
