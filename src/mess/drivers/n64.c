...
static ADDRESS_MAP_START( n64_map, AS_PROGRAM, 32, n64_state )
	AM_RANGE(0x00000000, 0x007fffff) AM_RAM	AM_BASE_LEGACY(&rdram)				// RDRAM
	...
	AM_RANGE(0x08000000, 0x0801ffff) AM_RAM AM_BASE_LEGACY(&n64_sram)										// Cartridge SRAM
...
CONS(1996, n64, 	0,		0,		n64,	n64, n64_state,	0,	"Nintendo", "Nintendo 64", GAME_NOT_WORKING | GAME_IMPERFECT_GRAPHICS )
CONS(1996, n64dd,	n64,	0,		n64dd,	n64, n64_state,	0,	"Nintendo", "Nintendo 64DD", GAME_NOT_WORKING | GAME_IMPERFECT_GRAPHICS )
