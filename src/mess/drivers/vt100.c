...
ROM_START( vt100 )
	...
	ROM_LOAD( "23-061e2.bin", 0x0000, 0x0800, CRC(3dae97ff) SHA1(e3437850c33565751b86af6c2fe270a491246d15)) // bug fixed version
	ROM_LOAD( "23-032e2.bin", 0x0800, 0x0800, CRC(3d86db99) SHA1(cdd8bdecdc643442f6e7d2c83cf002baf8101867))
	ROM_LOAD( "23-033e2.bin", 0x1000, 0x0800, CRC(384dac0a) SHA1(22aaf5ab5f9555a61ec43f91d4dea3029f613e64))
	ROM_LOAD( "23-034e2.bin", 0x1800, 0x0800, CRC(4643184d) SHA1(27e6c19d9932bf13fdb70305ef4d806e90d60833))
	ROM_REGION(0x0800, "gfx1",0)
	ROM_LOAD ("23-018e2.bin", 0x0000, 0x0800, CRC(0e41f551) SHA1(d6762aaa2c8090ac4c0726ef8aeaea1afdc66281)) // needs redump
ROM_END
