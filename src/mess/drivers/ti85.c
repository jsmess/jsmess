...
static ADDRESS_MAP_START( ti81_io, AS_IO, 8, ti85_state )
	...
	AM_RANGE(0x0000, 0x0000) AM_READWRITE_LEGACY( ti85_port_0000_r, ti85_port_0000_w )
	AM_RANGE(0x0001, 0x0001) AM_READWRITE_LEGACY( ti8x_keypad_r, ti8x_keypad_w )
	AM_RANGE(0x0002, 0x0002) AM_READWRITE_LEGACY( ti85_port_0002_r, ti85_port_0002_w )
	AM_RANGE(0x0003, 0x0003) AM_READWRITE_LEGACY( ti85_port_0003_r, ti85_port_0003_w )
	AM_RANGE(0x0004, 0x0004) AM_READWRITE_LEGACY( ti85_port_0004_r, ti85_port_0004_w )
	AM_RANGE(0x0005, 0x0005) AM_READWRITE_LEGACY( ti85_port_0005_r, ti85_port_0005_w )
	AM_RANGE(0x0007, 0x0007) AM_WRITE_LEGACY( ti81_port_0007_w)
ADDRESS_MAP_END
...
static ADDRESS_MAP_START( ti85_io, AS_IO, 8, ti85_state )
	...
	AM_RANGE(0x0004, 0x0004) AM_READWRITE_LEGACY( ti85_port_0004_r, ti85_port_0004_w )
	AM_RANGE(0x0005, 0x0005) AM_READWRITE_LEGACY( ti85_port_0005_r, ti85_port_0005_w )
	AM_RANGE(0x0006, 0x0006) AM_READWRITE_LEGACY( ti85_port_0006_r, ti85_port_0006_w )
	AM_RANGE(0x0007, 0x0007) AM_READWRITE_LEGACY( ti8x_serial_r, ti8x_serial_w )
ADDRESS_MAP_END

static ADDRESS_MAP_START( ti82_io, AS_IO, 8, ti85_state )
	ADDRESS_MAP_GLOBAL_MASK(0xff)
	AM_RANGE(0x0000, 0x0000) AM_READWRITE_LEGACY( ti8x_serial_r, ti8x_serial_w )
	AM_RANGE(0x0001, 0x0001) AM_READWRITE_LEGACY( ti8x_keypad_r, ti8x_keypad_w )
	AM_RANGE(0x0002, 0x0002) AM_READWRITE_LEGACY( ti82_port_0002_r, ti82_port_0002_w )
	AM_RANGE(0x0003, 0x0003) AM_READWRITE_LEGACY( ti85_port_0003_r, ti85_port_0003_w )
	AM_RANGE(0x0004, 0x0004) AM_READWRITE_LEGACY( ti85_port_0004_r, ti85_port_0004_w )
...
static ADDRESS_MAP_START( ti83_io, AS_IO, 8, ti85_state )
	ADDRESS_MAP_GLOBAL_MASK(0xff)
	AM_RANGE(0x0000, 0x0000) AM_READWRITE_LEGACY( ti83_port_0000_r, ti83_port_0000_w )	//TODO
	AM_RANGE(0x0001, 0x0001) AM_READWRITE_LEGACY( ti8x_keypad_r, ti8x_keypad_w )
	AM_RANGE(0x0002, 0x0002) AM_READWRITE_LEGACY( ti83_port_0002_r, ti83_port_0002_w )
	AM_RANGE(0x0003, 0x0003) AM_READWRITE_LEGACY( ti83_port_0003_r, ti83_port_0003_w )
	AM_RANGE(0x0004, 0x0004) AM_READWRITE_LEGACY( ti85_port_0004_r, ti85_port_0004_w )
	AM_RANGE(0x0010, 0x0010) AM_DEVREADWRITE("t6a04", t6a04_device, control_read, control_write)
	AM_RANGE(0x0011, 0x0011) AM_DEVREADWRITE("t6a04", t6a04_device, data_read, data_write)
...
static ADDRESS_MAP_START( ti83p_io, AS_IO, 8, ti85_state )
	ADDRESS_MAP_GLOBAL_MASK(0xff)
	AM_RANGE(0x0000, 0x0000) AM_READWRITE_LEGACY( ti8x_plus_serial_r, ti8x_plus_serial_w)
	AM_RANGE(0x0001, 0x0001) AM_READWRITE_LEGACY( ti8x_keypad_r, ti8x_keypad_w )
	AM_RANGE(0x0002, 0x0002) AM_READWRITE_LEGACY( ti83p_port_0002_r, ti83p_port_0002_w )
	AM_RANGE(0x0003, 0x0003) AM_READWRITE_LEGACY( ti83_port_0003_r, ti83p_port_0003_w )
	AM_RANGE(0x0004, 0x0004) AM_READWRITE_LEGACY( ti83_port_0003_r, ti83p_port_0004_w )
	AM_RANGE(0x0006, 0x0006) AM_READWRITE_LEGACY( ti86_port_0005_r, ti83p_port_0006_w )
	AM_RANGE(0x0007, 0x0007) AM_READWRITE_LEGACY( ti86_port_0006_r, ti83p_port_0007_w )
	AM_RANGE(0x0010, 0x0010) AM_DEVREADWRITE("t6a04", t6a04_device, control_read, control_write)
	AM_RANGE(0x0011, 0x0011) AM_DEVREADWRITE("t6a04", t6a04_device, data_read, data_write)
ADDRESS_MAP_END
...
static ADDRESS_MAP_START( ti86_io, AS_IO, 8, ti85_state )
	...
	AM_RANGE(0x0002, 0x0002) AM_READWRITE_LEGACY( ti85_port_0002_r, ti85_port_0002_w )
	AM_RANGE(0x0003, 0x0003) AM_READWRITE_LEGACY( ti85_port_0003_r, ti85_port_0003_w )
	AM_RANGE(0x0004, 0x0004) AM_READWRITE_LEGACY( ti85_port_0006_r, ti85_port_0006_w )
	AM_RANGE(0x0005, 0x0005) AM_READWRITE_LEGACY( ti86_port_0005_r, ti86_port_0005_w )
	AM_RANGE(0x0006, 0x0006) AM_READWRITE_LEGACY( ti86_port_0006_r, ti86_port_0006_w )
	AM_RANGE(0x0007, 0x0007) AM_READWRITE_LEGACY( ti8x_serial_r, ti8x_serial_w )
ADDRESS_MAP_END
...
COMP( 1998, ti73,       0,      0,      ti73,   ti82,   0,     "Texas Instruments",    "TI-73",                        GAME_NO_SOUND )
