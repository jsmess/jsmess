...
static ADDRESS_MAP_START( ti82_io, AS_IO, 8)
	ADDRESS_MAP_GLOBAL_MASK(0xff)
	AM_RANGE(0x0000, 0x0000) AM_READWRITE( ti82_port_0000_r, ti82_port_0000_w )
	AM_RANGE(0x0001, 0x0001) AM_READWRITE( ti8x_keypad_r, ti8x_keypad_w )
...
static MACHINE_CONFIG_DERIVED( ti82, ti81 )
	...
	MCFG_TI82SERIAL_ADD( "ti82serial" )
MACHINE_CONFIG_END
...
ROM_START (ti81)
	...
	ROMX_LOAD( "ti81v11k.bin", 0x10000, 0x8000, CRC(0b860a63) SHA1(84a71cfc8818ca4b7d0caa76ffbf6d0463eaf7c6), ROM_BIOS(1) )
	ROM_SYSTEM_BIOS( 1, "v16", "V 1.6K" )
	ROMX_LOAD( "ti81v16k.bin", 0x10000, 0x8000, CRC(452ca838) SHA1(92649f0f3bce7d8829d950cecd6532d7f7db1297), ROM_BIOS(2) )
	ROM_SYSTEM_BIOS( 2, "v18", "V 1.8K" )
	ROMX_LOAD( "ti81v18k.bin", 0x10000, 0x8000, CRC(94ac58e2) SHA1(ba915cfe2fe50a452ef8287db8f2244e29056d54), ROM_BIOS(3) )
...
ROM_START (ti83)
    ...
    ROMX_LOAD( "ti83v110-2.bin", 0x10000, 0x40000, CRC(56182912) SHA1(4c77fb77f023502b685a49a8013568b494384b25), ROM_BIOS(8) )
...
ROM_START (ti83p)
	...
	ROMX_LOAD( "ti83pv112.bin", 0x10000, 0x80000, CRC(ddca5026) SHA1(6615df5554076b6b81bd128bf847d2ff046e556b), ROM_BIOS(5) )
	ROM_SYSTEM_BIOS( 5, "v110-2", "V 1.10-2" )
    ROMX_LOAD( "ti83pv110-2.bin", 0x10000, 0x80000, CRC(504b9879) SHA1(8841d501870e8fc7173642d8a438205a040640fc), ROM_BIOS(6) )
    ROM_SYSTEM_BIOS( 6, "v112-2", "V 1.12-2" )
    ROMX_LOAD( "ti83pv112-2.bin", 0x10000, 0x80000, CRC(2126de12) SHA1(cbedc3a8cf8335eebf2b279d58720d8e7f86c569), ROM_BIOS(7) )
    ROM_SYSTEM_BIOS( 7, "v113", "V 1.13" )
    ROMX_LOAD( "ti83pv113.bin", 0x10000, 0x80000, CRC(30a243aa) SHA1(9b79e994ea1ce7af05b68f8ecee8b1b1fc3f0810), ROM_BIOS(8) )
    ROM_SYSTEM_BIOS( 8, "v114", "V 1.14" )
    ROMX_LOAD( "ti83pv114.bin", 0x10000, 0x80000, CRC(b32059c7) SHA1(46c66ba0421c03fc42f5afb06c7d3af812786140), ROM_BIOS(9) )
    ROM_SYSTEM_BIOS( 9, "v115", "V 1.15" )
    ROMX_LOAD( "ti83pv115.bin", 0x10000, 0x80000, CRC(9288029b) SHA1(8bd05fd47cab4028f275d1cc5383fd4f0e193474), ROM_BIOS(10) )
    ROM_SYSTEM_BIOS( 10, "v116", "V 1.16" )
    ROMX_LOAD( "ti83pv116.bin", 0x10000, 0x80000, CRC(0b7cd006) SHA1(290bc81159ea061d8ccb56a6f63e042f150afb32), ROM_BIOS(11) )
ROM_END
...
ROM_START (ti83pse)
	...
	ROMX_LOAD( "ti83psev116.bin", 0x10000, 0x200000, CRC(d2570863) SHA1(d4214b3c0ebb26e10fe95294ac72a90d2ba99537), ROM_BIOS(1) )
ROM_END
