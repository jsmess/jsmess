...
COMP(1979, interact, 0, 		0,	interact,	interact, interact_state, 0,	 "Interact",   "Interact Family Computer", GAME_IMPERFECT_SOUND)
COMP(1983, hector1,  interact,	0,	 hector1,	interact, interact_state, 0,	 "Micronique", "Hector 1",	GAME_IMPERFECT_SOUND)
