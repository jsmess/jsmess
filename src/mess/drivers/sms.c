...
static MACHINE_DRIVER_START(sms1ntsc)
	...
	MDRV_SOUND_ADD_TAG("smsiii", SMSIII, XTAL_53_693175MHz/15)
...
static MACHINE_DRIVER_START(sms1pal)
	...
	/* sound hardware */
	MDRV_SPEAKER_STANDARD_MONO("mono")
	MDRV_SOUND_ADD_TAG("smsiii", SMSIII, MASTER_CLOCK_PAL/15)
	MDRV_SOUND_ROUTE(ALL_OUTPUTS, "mono", 1.00)
MACHINE_DRIVER_END
...
static MACHINE_DRIVER_START(smsfm)
	...
	MDRV_SOUND_ADD_TAG("ym2413", YM2413, XTAL_53_693175MHz/15)
	MDRV_SOUND_ROUTE(ALL_OUTPUTS, "mono", 1.00)
MACHINE_DRIVER_END
...
static MACHINE_DRIVER_START(gamegear)
	...
	/* sound hardware */
	MDRV_SPEAKER_STANDARD_MONO("mono")
	MDRV_SOUND_ADD_TAG("gamegear", GAMEGEAR, XTAL_53_693175MHz/15)
	MDRV_SOUND_ROUTE(ALL_OUTPUTS, "mono", 1.00)
MACHINE_DRIVER_END
