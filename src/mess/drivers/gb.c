...
CONS( 1990, gameboy,  0,       0,		gameboy,  gameboy, gb_state, 0,    "Nintendo", "Game Boy", 0)
CONS( 1994, supergb,  gameboy, 0,		supergb,  gameboy, gb_state, 0,    "Nintendo", "Super Game Boy", 0)
CONS( 1996, gbpocket, gameboy, 0,		gbpocket, gameboy, gb_state, 0,    "Nintendo", "Game Boy Pocket", 0)
CONS( 1997, gblight,  gameboy, 0,		gbpocket, gameboy, gb_state, 0,    "Nintendo", "Game Boy Light", 0)
CONS( 1998, gbcolor,  gameboy, 0,		gbcolor,  gameboy, gb_state, 0,    "Nintendo", "Game Boy Color", GAME_IMPERFECT_GRAPHICS)
...
CONS( 1993, megaduck, 0,       0,       megaduck, gameboy, gb_state, 0,    "Creatronic/Videojet/Timlex/Cougar",  "MegaDuck/Cougar Boy" , 0)
