...
COMP( 1985, swyft,0,       0,      swyft,    swyft, cat_state,    0,   "Information Applicance Inc", "Swyft", GAME_NOT_WORKING | GAME_NO_SOUND)
COMP( 1987, cat,  swyft,   0,      cat,      cat, cat_state,      0,   "Canon",   "Cat", GAME_NOT_WORKING | GAME_NO_SOUND)
