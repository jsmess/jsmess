...
COMP( 1977, apple2,   0,        0,        apple2,      apple2,   0,        0,        "Apple Computer",    "Apple ][", GAME_SUPPORTS_SAVE )
COMP( 1979, apple2p,  apple2,   0,        apple2p,	   apple2p,  0,        0,        "Apple Computer",    "Apple ][+", GAME_SUPPORTS_SAVE )
COMP( 1982, prav82,   apple2,   0,        apple2p,	   apple2p,  0,        0,        "Pravetz",           "Pravetz 82", GAME_SUPPORTS_SAVE )
COMP( 1985, prav8m,   apple2,   0,        apple2p,	   apple2p,  0,        0,        "Pravetz",           "Pravetz 8M", GAME_SUPPORTS_SAVE )
COMP( 1980, apple2jp, apple2,   0,        apple2p,	   apple2p,  0,        0,        "Apple Computer",    "Apple ][j+", GAME_SUPPORTS_SAVE )
COMP( 1982, ace100,   apple2,   0,        apple2,	   apple2e,  0,        0,        "Franklin Computer", "Franklin Ace 100", GAME_SUPPORTS_SAVE )
COMP( 1983, apple2e,  0,        apple2,	  apple2e,	   apple2e,  0,        0,	     "Apple Computer",    "Apple //e", GAME_SUPPORTS_SAVE )
COMP( 1983, mprof3,   apple2e,  0,        mprof3,	   apple2e,  0,        0,	     "Multitech",         "Microprofessor III", GAME_SUPPORTS_SAVE )
COMP( 1985, apple2ee, apple2e,  0,        apple2ee,	   apple2e,  0,        0,	     "Apple Computer",    "Apple //e (enhanced)", GAME_SUPPORTS_SAVE )
COMP( 1987, apple2ep, apple2e,  0,        apple2ee,	   apple2ep, 0,        0,	     "Apple Computer",    "Apple //e (Platinum)", GAME_SUPPORTS_SAVE )
COMP( 1984, apple2c,  0,        apple2,	  apple2c,	   apple2e,  0,        0,	     "Apple Computer",    "Apple //c" , GAME_SUPPORTS_SAVE )
COMP( 1989, prav8c,   apple2c,  0,        apple2c,	   apple2e,  0,        0,	     "Pravetz",           "Pravetz 8C", GAME_SUPPORTS_SAVE )
...
COMP( 1985, apple2c0, apple2c,  0,        apple2c_iwm, apple2e,  0,        0,	     "Apple Computer",    "Apple //c (UniDisk 3.5)", GAME_SUPPORTS_SAVE )
COMP( 1986, apple2c3, apple2c,  0,        apple2c_iwm, apple2e,  0,        0,	     "Apple Computer",    "Apple //c (Original Memory Expansion)", GAME_SUPPORTS_SAVE )
COMP( 1986, apple2c4, apple2c,  0,        apple2c_iwm, apple2e,  0,        0,	     "Apple Computer",    "Apple //c (rev 4)", GAME_NOT_WORKING )
COMP( 1988, apple2cp, apple2c,  0,        apple2c_iwm, apple2e,  0,        0,	     "Apple Computer",    "Apple //c Plus", GAME_SUPPORTS_SAVE )
COMP( 1984, ivelultr, apple2,   0,        apple2p,     apple2p,  0,        0,	     "Ivasim",            "Ivel Ultra", GAME_SUPPORTS_SAVE )
