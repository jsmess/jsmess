...
static INPUT_PORTS_START(tm990_189)
	...
	PORT_START_TAG("JOY1_Y")	/* joystick 1, Y axis */
	...
	PORT_START_TAG("JOY2_X")	/* joystick 2, X axis */
	...
	PORT_START_TAG("JOY2_Y")	/* joystick 2, Y axis */
