...
static INPUT_PORTS_START (lviv)
	PORT_START_TAG("KEY0") /* 2nd PPI port A bit 0 low */
	...
	PORT_START_TAG("KEY1") /* 2nd PPI port A bit 1 low */
	...
	PORT_START_TAG("KEY2") /* 2nd PPI port A bit 2 low */
	...
	PORT_START_TAG("KEY3") /* 2nd PPI port A bit 3 low */
	...
	PORT_START_TAG("KEY4") /* 2nd PPI port A bit 4 low */
	...
	PORT_START_TAG("KEY5") /* 2nd PPI port A bit 5 low */
	...
	PORT_START_TAG("KEY6") /* 2nd PPI port A bit 6 low */
	...
	PORT_START_TAG("KEY7") /* 2nd PPI port A bit 7 low */
	...
	PORT_START_TAG("KEY8") /* 2nd PPI port C bit 0 low */
	...
	PORT_START_TAG("KEY9") /* 2nd PPI port C bit 1 low */
	...
	PORT_START_TAG("KEY10") /* 2nd PPI port C bit 2 low */
	...
	PORT_START_TAG("KEY11") /* 2nd PPI port C bit 3 low */
