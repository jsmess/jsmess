...
static ADDRESS_MAP_START(mbc55x_io, AS_IO, 8, mbc55x_state)
	...
	AM_RANGE( 0X0000, 0X0003) AM_READWRITE_LEGACY( pic8259_r, pic8259_w)
	AM_RANGE( 0x0008, 0x000F) AM_READWRITE_LEGACY( mbc55x_disk_r, mbc55x_disk_w)
...
//	MCFG_SCREEN_VISIBLE_AREA(0, 639, 0, 249)
	...
	/* Devices */
	MCFG_I8251_ADD(MSM8251A_KB_TAG,mbc55x_msm8251a_interface)
...
COMP( 1983, mbc55x,     0,      0,      mbc55x, mbc55x, 0,   "Sanyo",  "MBC-55x",  0 /*GAME_NO_SOUND*/)
