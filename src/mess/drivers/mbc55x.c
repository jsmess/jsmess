...
static ADDRESS_MAP_START(mbc55x_mem, ADDRESS_SPACE_PROGRAM, 8)
...
//	MCFG_SCREEN_VISIBLE_AREA(0, 639, 0, 249)
	...
	MCFG_VIDEO_UPDATE(mbc55x)
	MCFG_VIDEO_EOF(mbc55x)
	MCFG_VIDEO_RESET(mbc55x)

	/* Backing storage */
	MCFG_WD1793_ADD(FDC_TAG, mbc55x_wd17xx_interface )
	MCFG_FLOPPY_4_DRIVES_ADD(mbc55x_floppy_config)	
	...
	MCFG_MSM8251_ADD(MSM8251A_TAG,mbc55x_msm8251a_interface);
...
ROM_START( mbc55x )
	...
	ROMX_LOAD("mbc55x-v120.rom", 0x2000, 0x2000, CRC(b439b4b8) SHA1(6e8df0f3868e3fd0229a5c2720d6c01e46815cab), ROM_BIOS(1)  )
ROM_END
