...
static ADDRESS_MAP_START(bmjr_mem, ADDRESS_SPACE_PROGRAM, 8)
	...
	AM_RANGE(0x0000, 0xAFFF) AM_RAM	// screen = 0x100 to 0x3FF
	AM_RANGE(0xB000, 0xE7FF) AM_ROM
	AM_RANGE(0xE800, 0xEFFF) AM_RAM	// devices?
...
ROM_START( bmjr )
	...
	ROM_LOAD( "bas.rom", 0xB000, 0x3000, CRC(2318e04e) SHA1(cdb3535663090f5bcaba20b1dbf1f34724ef6a5f))
