...
static ADDRESS_MAP_START(maclc_map, ADDRESS_SPACE_PROGRAM, 32, mac_state )
	...
	AM_RANGE(0xf14000, 0xf15fff) AM_DEVREADWRITE8("asc", asc_device, read, write, 0xffffffff) AM_MIRROR(0x00f00000) 
...
static MACHINE_CONFIG_START( macii, mac_state )
	...
	/* basic machine hardware */
	MDRV_CPU_ADD("maincpu", M68020HMMU, 7833600*2)
...
static MACHINE_CONFIG_DERIVED( maclc, macii )
	...
	MDRV_CPU_REPLACE("maincpu", M68020HMMU, 7833600*2)
