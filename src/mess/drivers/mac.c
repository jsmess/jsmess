...
static MACHINE_CONFIG_DERIVED( maclc, macii )
	...
	MCFG_EGRET_ADD(EGRET_TYPE_101_EARLY)
...
static MACHINE_CONFIG_DERIVED( maclc3, maclc )
	...
	MCFG_EGRET_REPLACE(EGRET_TYPE_101)
MACHINE_CONFIG_END
...
COMP( 1989, maciicx,  mac2fdhd, 0,	maciicx,  macadb,   maciicx,	  "Apple Computer", "Macintosh IIcx",  0 )
