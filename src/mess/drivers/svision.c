...
static ADDRESS_MAP_START( svision_mem , AS_PROGRAM, 8, svision_state )
	...
	AM_RANGE( 0x2000, 0x3fff) AM_READWRITE_LEGACY(svision_r, svision_w) AM_BASE( m_reg)
	AM_RANGE( 0x4000, 0x5fff) AM_RAM AM_BASE( m_videoram)
...
static ADDRESS_MAP_START( tvlink_mem , AS_PROGRAM, 8, svision_state )
	AM_RANGE( 0x0000, 0x1fff) AM_RAM
	AM_RANGE( 0x2000, 0x3fff) AM_READWRITE_LEGACY(tvlink_r, tvlink_w) AM_BASE( m_reg)
	AM_RANGE( 0x4000, 0x5fff) AM_RAM AM_BASE( m_videoram)
	AM_RANGE( 0x6000, 0x7fff) AM_NOP
	AM_RANGE( 0x8000, 0xbfff) AM_ROMBANK("bank1")
	AM_RANGE( 0xc000, 0xffff) AM_ROMBANK("bank2")
