...
static ADDRESS_MAP_START( sym1_map, AS_PROGRAM, 8, sym1_state )
	...
	AM_RANGE(0x0400, 0x07ff) AM_RAMBANK("bank2") AM_BASE(m_ram_1k)
	AM_RANGE(0x0800, 0x0bff) AM_RAMBANK("bank3") AM_BASE(m_ram_2k)
	AM_RANGE(0x0c00, 0x0fff) AM_RAMBANK("bank4") AM_BASE(m_ram_3k)
	AM_RANGE(0x8000, 0x8fff) AM_ROM AM_BASE(m_monitor)       /* U20 Monitor ROM */
	...
	AM_RANGE(0xa600, 0xa67f) AM_RAMBANK("bank5") AM_BASE(m_riot_ram)  /* U27 RIOT RAM */
