...
static const UINT16 fm7_key_list[0x60][6] =  
{ // norm  shift ctrl  graph kana  sh.kana
	{0x00, 0x00, 0x00, 0x00, 0x00, 0x00},
	{0x1b, 0x1b, 0x1b, 0x1b, 0x1b, 0x1b},  // ESC
	{0x31, 0x21, 0xf9, 0xf9, 0xc7, 0x00},  // 1
	{0x32, 0x22, 0xfa, 0xfa, 0xcc, 0x00},  // 2
	{0x33, 0x23, 0xfb, 0xfb, 0xb1, 0xa7},
	{0x34, 0x24, 0xfc, 0xfc, 0xb3, 0xa9},
	{0x35, 0x25, 0xf2, 0xf2, 0xb4, 0xaa},
	{0x36, 0x26, 0xf3, 0xf3, 0xb5, 0xab},
	{0x37, 0x27, 0xf4, 0xf4, 0xd4, 0xac},
	{0x38, 0x28, 0xf5, 0xf5, 0xd5, 0xad},
	{0x39, 0x29, 0xf6, 0xf6, 0xd6, 0xae},  // 9
	{0x30, 0x00, 0xf7, 0xf7, 0xdc, 0xa6},  // 0
	{0x2d, 0x3d, 0x1e, 0x8c, 0xce, 0x00},  // -
	{0x5e, 0x7e, 0x1c, 0x8b, 0xcd, 0x00},  // ^
	{0x5c, 0x7c, 0xf1, 0xf1, 0xb0, 0x00},  // Yen
	{0x08, 0x08, 0x08, 0x08, 0x08, 0x08},  // Backspace
	{0x09, 0x09, 0x09, 0x09, 0x09, 0x09},  // Tab
	{0x71, 0x51, 0x11, 0xfd, 0xc0, 0x00},  // Q
	{0x77, 0x57, 0x17, 0xf8, 0xc3, 0x00},  // W
	{0x65, 0x45, 0x05, 0xe4, 0xb2, 0xa8},  // E
	{0x72, 0x52, 0x12, 0xe5, 0xbd, 0x00},
	{0x74, 0x54, 0x14, 0x9c, 0xb6, 0x00},
	{0x79, 0x59, 0x19, 0x9d, 0xdd, 0x00},
	{0x75, 0x55, 0x15, 0xf0, 0xc5, 0x00},
	{0x69, 0x49, 0x09, 0xe8, 0xc6, 0x00},
	{0x6f, 0x4f, 0x0f, 0xe9, 0xd7, 0x00},
	{0x70, 0x50, 0x10, 0x8d, 0xbe, 0x00},  // P
	{0x40, 0x60, 0x00, 0x8a, 0xde, 0x00},  // @
	{0x5b, 0x7b, 0x1b, 0xed, 0xdf, 0xa2},  // [
	{0x0d, 0x0d, 0x00, 0x0d, 0x0d, 0x0d},  // Return 
	{0x61, 0x41, 0x01, 0x95, 0xc1, 0x00},  // A
	{0x73, 0x53, 0x13, 0x96, 0xc4, 0x00},  // S

	{0x64, 0x44, 0x04, 0xe6, 0xbc, 0x00},  // D
	{0x66, 0x46, 0x06, 0xe7, 0xca, 0x00},
	{0x67, 0x47, 0x07, 0x9e, 0xb7, 0x00},
	{0x68, 0x48, 0x08, 0x9f, 0xb8, 0x00},
	{0x6a, 0x4a, 0x0a, 0xea, 0xcf, 0x00},
	{0x6b, 0x4b, 0x0b, 0xeb, 0xc9, 0x00},
	{0x6c, 0x4c, 0x0c, 0x8e, 0xd8, 0x00},  // L
	{0x3b, 0x2b, 0x00, 0x99, 0xda, 0x00},  // ;
	{0x3a, 0x2a, 0x00, 0x94, 0xb9, 0x00},  // :
	{0x5d, 0x7d, 0x1d, 0xec, 0xd1, 0xa3},  // ]
	{0x7a, 0x5a, 0x1a, 0x80, 0xc2, 0xaf},  // Z
	{0x78, 0x58, 0x18, 0x81, 0xbb, 0x00},  // X
	{0x63, 0x43, 0x03, 0x82, 0xbf, 0x00},  // C
	{0x76, 0x56, 0x16, 0x83, 0xcb, 0x00},
	{0x62, 0x42, 0x02, 0x84, 0xba, 0x00},
	{0x6e, 0x4e, 0x0e, 0x85, 0xd0, 0x00},
	{0x6d, 0x4d, 0x0d, 0x86, 0xd3, 0x00},  // M
	{0x2c, 0x3c, 0x00, 0x87, 0xc8, 0xa4},  // <
	{0x2e, 0x3e, 0x00, 0x88, 0xd9, 0xa1},  // >
	{0x2f, 0x3f, 0x00, 0x97, 0xd2, 0xa5},  // /  
	{0x22, 0x5f, 0x1f, 0xe0, 0xdb, 0x00},  // "
	{0x20, 0x20, 0x20, 0x20, 0x20, 0x20},  // Space
	{0x2a, 0x2a, 0x00, 0x98, 0x2a, 0x2a},  // Tenkey
	{0x2f, 0x2f, 0x00, 0x91, 0x2f, 0x2f},
	{0x2b, 0x2b, 0x00, 0x99, 0x2b, 0x2b},
	{0x2d, 0x2d, 0x00, 0xee, 0x2d, 0x2d},
	{0x37, 0x37, 0x00, 0xe1, 0x37, 0x37},  
	{0x38, 0x38, 0x00, 0xe2, 0x38, 0x38},
	{0x39, 0x39, 0x00, 0xe3, 0x39, 0x39},
	{0x3d, 0x3d, 0x00, 0xef, 0x3d, 0x3d},  // Tenkey =
	{0x34, 0x34, 0x00, 0x93, 0x34, 0x34},
	{0x35, 0x35, 0x00, 0x8f, 0x35, 0x35},

	{0x36, 0x36, 0x00, 0x92, 0x36, 0x36},
	{0x2c, 0x2c, 0x00, 0x00, 0x2c, 0x2c},
	{0x31, 0x31, 0x00, 0x9a, 0x31, 0x31},
	{0x32, 0x32, 0x00, 0x90, 0x32, 0x32},
	{0x33, 0x33, 0x00, 0x9b, 0x33, 0x33},
	{0x0d, 0x0d, 0x00, 0x0d, 0x0d, 0x0d},
	{0x30, 0x30, 0x00, 0x00, 0x30, 0x30},
	{0x2e, 0x2e, 0x00, 0x2e, 0x2e, 0x2e},
	{0x12, 0x12, 0x00, 0x12, 0x12, 0x12}, // INS
	{0x05, 0x05, 0x00, 0x05, 0x05, 0x05},  // EL
	{0x0c, 0x0c, 0x00, 0x0c, 0x0c, 0x0c},  // CLS
	{0x7f, 0x7f, 0x00, 0x7f, 0x7f, 0x7f},  // DEL
	{0x11, 0x11, 0x00, 0x11, 0x11, 0x11},  // DUP
	{0x1e, 0x19, 0x00, 0x1e, 0x1e, 0x19},  // Cursor Up
	{0x0b, 0x0b, 0x00, 0x0b, 0x0b, 0x0b},  // HOME
	{0x1d, 0x02, 0x00, 0x1d, 0x1d, 0x02},  // Cursor Left
	{0x1f, 0x1a, 0x00, 0x1f, 0x1f, 0x1a},  // Cursor Down
	{0x1c, 0x06, 0x00, 0x1c, 0x1c, 0x16},  // Cursor Right
	{0x00, 0x00, 0x00, 0x00, 0x00, 0x00},  // BREAK (doesn't give a scancode)
	{0x101, 0x00, 0x101, 0x101, 0x101, 0x00},  // PF1
	{0x102, 0x00, 0x102, 0x102, 0x102, 0x00},
	{0x103, 0x00, 0x103, 0x103, 0x103, 0x00},
	{0x104, 0x00, 0x104, 0x104, 0x104, 0x00},
	{0x105, 0x00, 0x105, 0x105, 0x105, 0x00},
	{0x106, 0x00, 0x106, 0x106, 0x106, 0x00},
	{0x107, 0x00, 0x107, 0x107, 0x107, 0x00},
	{0x108, 0x00, 0x108, 0x108, 0x108, 0x00},
	{0x109, 0x00, 0x109, 0x109, 0x109, 0x00},
	{0x10a, 0x00, 0x10a, 0x10a, 0x10a, 0x00},  // PF10
	{0x00, 0x00, 0x00, 0x00, 0x00, 0x00},
	{0x00, 0x00, 0x00, 0x00, 0x00, 0x00},
	{0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
};
