...
static MACHINE_DRIVER_START( jr200 )
    ...
    MDRV_CPU_PROGRAM_MAP(jr200_mem, 0)
    MDRV_CPU_IO_MAP(jr200_io, 0)
...
ROM_START( jr200 )
  ...
  ROM_LOAD( "jr200u.bin", 0x0000, 0x2000, CRC(37ca3080) SHA1(17d3fdedb4de521da7b10417407fa2b61f01a77a))
