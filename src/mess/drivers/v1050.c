...
static MACHINE_DRIVER_START( v1050 )
    ...
    MDRV_CPU_PROGRAM_MAP(v1050_mem, 0)
    MDRV_CPU_IO_MAP(v1050_io, 0)
...
ROM_START( v1050 )
  ...
  ROM_LOAD( "visual_u77.bin", 0x0000, 0x2000, CRC(c0502b66) SHA1(bc0015f5b14f98110e652eef9f7c57c614683be5))
