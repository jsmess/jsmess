...
COMP( 2008, test410,   0,        0,      test_t410,   0, 0,      "T400 uController project",   "T410 test suite", GAME_NO_SOUND_HW )
COMP( 2008, test420,   test410,  0,      test_t420,   0, 0,      "T400 uController project",   "T420 test suite", GAME_NO_SOUND_HW )
