...
static INPUT_PORTS_START( vboy )
	PORT_START("INPUT")
		PORT_BIT( 0x8000, IP_ACTIVE_HIGH, IPT_JOYSTICKRIGHT_DOWN ) PORT_CATEGORY(1) PORT_PLAYER(1)
		PORT_BIT( 0x4000, IP_ACTIVE_HIGH, IPT_JOYSTICKRIGHT_LEFT ) PORT_CATEGORY(1) PORT_PLAYER(1)	
		PORT_BIT( 0x2000, IP_ACTIVE_HIGH, IPT_SELECT )			   PORT_CATEGORY(1) PORT_PLAYER(1)
		PORT_BIT( 0x1000, IP_ACTIVE_HIGH, IPT_START ) 			   PORT_CATEGORY(1) PORT_PLAYER(1)
		PORT_BIT( 0x0800, IP_ACTIVE_HIGH, IPT_JOYSTICKLEFT_UP )    PORT_CATEGORY(1) PORT_PLAYER(1)
		PORT_BIT( 0x0400, IP_ACTIVE_HIGH, IPT_JOYSTICKLEFT_DOWN )  PORT_CATEGORY(1) PORT_PLAYER(1)
		PORT_BIT( 0x0200, IP_ACTIVE_HIGH, IPT_JOYSTICKLEFT_LEFT )  PORT_CATEGORY(1) PORT_PLAYER(1)
		PORT_BIT( 0x0100, IP_ACTIVE_HIGH, IPT_JOYSTICKLEFT_RIGHT ) PORT_CATEGORY(1) PORT_PLAYER(1)
		PORT_BIT( 0x0080, IP_ACTIVE_HIGH, IPT_JOYSTICKRIGHT_RIGHT )PORT_CATEGORY(1) PORT_PLAYER(1)		
		PORT_BIT( 0x0040, IP_ACTIVE_HIGH, IPT_JOYSTICKRIGHT_UP )   PORT_CATEGORY(1) PORT_PLAYER(1)
		PORT_BIT( 0x0020, IP_ACTIVE_HIGH, IPT_BUTTON3 )   		   PORT_CATEGORY(1) PORT_PLAYER(1) // Left button on back
		PORT_BIT( 0x0010, IP_ACTIVE_HIGH, IPT_BUTTON4 )   		   PORT_CATEGORY(1) PORT_PLAYER(1) // Right button on back
		PORT_BIT( 0x0008, IP_ACTIVE_HIGH, IPT_BUTTON2 )   		   PORT_CATEGORY(1) PORT_PLAYER(1) // A button
		PORT_BIT( 0x0004, IP_ACTIVE_HIGH, IPT_BUTTON1 )   		   PORT_CATEGORY(1) PORT_PLAYER(1) // B button
