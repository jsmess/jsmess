...
static MACHINE_DRIVER_START( odyssey2 )
	...
	MDRV_SCREEN_RAW_PARAMS( XTAL_7_15909MHz/2, 227, 0, 160, 263, 0, 240 )
...
static MACHINE_DRIVER_START( videopac )
	...
	MDRV_SCREEN_ADD("main", RASTER)
	MDRV_SCREEN_FORMAT(BITMAP_FORMAT_INDEXED16)
	MDRV_SCREEN_RAW_PARAMS( XTAL_17_73447MHz/5, 227, 0, 160, 313, 0, 240 )
...
static MACHINE_DRIVER_START( g7400 )
	...
	MDRV_SCREEN_ADD("main", RASTER)
	MDRV_SCREEN_FORMAT(BITMAP_FORMAT_INDEXED16)
	MDRV_SCREEN_RAW_PARAMS( 3547000*2, 448, 96, 416, 312, 39, 289 )	/* EF9340 operates doubles the input clock into dot clocks internally */
