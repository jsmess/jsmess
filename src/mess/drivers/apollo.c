...
static ADDRESS_MAP_START(dn3500_map, AS_PROGRAM, 32)
		...
		AM_RANGE(0x010400, 0x0104ff) AM_DEVREADWRITE8( APOLLO_SIO_TAG, apollo_sio_r, apollo_sio_w, 0xffffffff )
		AM_RANGE(0x010500, 0x0105ff) AM_DEVREADWRITE8( APOLLO_SIO2_TAG, apollo_sio2_r, apollo_sio2_w, 0xffffffff )
		AM_RANGE(0x010800, 0x0108ff) AM_DEVREADWRITE8( APOLLO_PTM_TAG, apollo_ptm_r, apollo_ptm_w, 0xffffffff )
		...
		AM_RANGE(0x011000, 0x0110ff) AM_DEVREADWRITE8( APOLLO_PIC1_TAG, apollo_pic8259_master_r, apollo_pic8259_master_w, 0xffffffff)
		AM_RANGE(0x011100, 0x0111ff) AM_DEVREADWRITE8( APOLLO_PIC2_TAG, apollo_pic8259_slave_r, apollo_pic8259_slave_w, 0xffffffff)
		...
		AM_RANGE(0x04D000, 0x04D007) AM_DEVREADWRITE16( APOLLO_WDC_TAG, omti8621_r, omti8621_w, 0xffffffff)
		AM_RANGE(0x050000, 0x050007) AM_DEVREADWRITE8( APOLLO_CTAPE_TAG, sc499_r, sc499_w, 0xffffffff)
		AM_RANGE(0x058000, 0x058007) AM_DEVREADWRITE8( APOLLO_ETH_TAG, threecom3c505_r, threecom3c505_w, 0xffffffff)
		AM_RANGE(0x05f800, 0x05f807) AM_READWRITE8( apollo_fdc_r, apollo_fdc_w, 0xffffffff)

		AM_RANGE(0x05d800, 0x05dc07) AM_DEVREADWRITE16( APOLLO_SCREEN_TAG, apollo_mcr_r, apollo_mcr_w, 0xffffffff)
		AM_RANGE(0xfa0000, 0xfdffff) AM_DEVREADWRITE16( APOLLO_SCREEN_TAG, apollo_mgm_r, apollo_mgm_w, 0xffffffff)
		...
		// AM_RANGE(DN3500_RAM_BASE, DN3500_RAM_END) AM_RAM  AM_BASE(&messram_ptr.u32) AM_SIZE(&messram_size) /* 8MB RAM */
		AM_RANGE(DN3500_RAM_BASE, DN3500_RAM_END) AM_RAM_WRITE(ram_with_parity_w) AM_BASE(&messram_ptr.u32) AM_SIZE(&messram_size)
...
static ADDRESS_MAP_START(dn3000_map, AS_PROGRAM, 32)
		...
		AM_RANGE(0x008400, 0x0087ff) AM_DEVREADWRITE8( APOLLO_SIO_TAG, apollo_sio_r, apollo_sio_w, 0xffffffff )
		AM_RANGE(0x008800, 0x0088ff) AM_DEVREADWRITE8( APOLLO_PTM_TAG, apollo_ptm_r, apollo_ptm_w, 0xffffffff )
		...
		AM_RANGE(0x009400, 0x0094ff) AM_DEVREADWRITE8( APOLLO_PIC1_TAG, apollo_pic8259_master_r, apollo_pic8259_master_w, 0xffffffff)
		AM_RANGE(0x009500, 0x0095ff) AM_DEVREADWRITE8( APOLLO_PIC2_TAG, apollo_pic8259_slave_r, apollo_pic8259_slave_w, 0xffffffff)
		...
		// FIXME: must match with RAM size in driver/apollo_sio.c
		// AM_RANGE(DN3000_RAM_BASE, DN3000_RAM_END) AM_RAM  AM_BASE(&messram_ptr.u32) AM_SIZE(&messram_size) /* 8MB RAM */
		AM_RANGE(DN3000_RAM_BASE, DN3000_RAM_END) AM_RAM_WRITE(ram_with_parity_w) AM_BASE(&messram_ptr.u32) AM_SIZE(&messram_size)
...
static ADDRESS_MAP_START(dn5500_map, AS_PROGRAM, 32)
		...
		// FIXME: must match with RAM size in driver/apollo_sio.c
		// AM_RANGE(DN3500_RAM_BASE, DN3500_RAM_END) AM_RAM  AM_BASE(&messram_ptr.u32) AM_SIZE(&messram_size) /* 8MB RAM */
		AM_RANGE(DN5500_RAM_BASE, DN5500_RAM_END) AM_RAM_WRITE(ram_with_parity_w) AM_BASE(&messram_ptr.u32) AM_SIZE(&messram_size)
...
ROM_START( dn3500 )
	...
	ROMX_LOAD( "3500_boot_12191_7.bin", 0x00000, 0x10000, SHA1(36f3c83d9f2df42f2537b09ca2f051a8c9dfbfc2) , ROM_BIOS(1) )

	ROM_LOAD_OPTIONAL( "3000_3c505_010728-00.bin", 0x80000, 0x02000, SHA1(7ac36cc6fc90b90ddfc56c45303b514cbe18ae58) )
ROM_END
...
ROM_START( dn5500 )
	...
	ROM_SYSTEM_BIOS( 0, "md7c-rev-8.00", "MD7C REV 8.00, 1989/08/16.17:23:52" )
	ROMX_LOAD( "5500_boot_a1631-80046_1-30-92.bin", 0x00000, 0x10000, SHA1(7315a884ec4551c44433c6079cc06509223cb02b) , ROM_BIOS(1) )
...
ROM_START( dn3000)
	...
	ROMX_LOAD( "3000_boot_8475_7.bin",  0x00000, 0x08000, SHA1(6c383d2266719a3d069b7bf015f6945179395e7a), ROM_BIOS(1) )
