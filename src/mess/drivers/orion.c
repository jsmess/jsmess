...
static ADDRESS_MAP_START(orion128_mem, ADDRESS_SPACE_PROGRAM, 8)
	  ...
	  AM_RANGE( 0x0000, 0xefff ) AM_READWRITE(SMH_BANK1, SMH_BANK1)	  
    ...
    AM_RANGE( 0xfb00, 0xfbff ) AM_WRITE (orion128_dispatcher_w)
ADDRESS_MAP_END
...
static ADDRESS_MAP_START( orion128_io , ADDRESS_SPACE_IO, 8)
  ADDRESS_MAP_GLOBAL_MASK(0xff)
	...
	AM_RANGE( 0xfa, 0xfa) AM_WRITE ( orion128_memory_page_w )	
	AM_RANGE( 0xfb, 0xfb) AM_WRITE ( orion128_dispatcher_w )	
ADDRESS_MAP_END
...
ROM_START( orion128 )
    ...
    ROM_SYSTEM_BIOS(0,"ver 1","Version 1")
    ROMX_LOAD( "m2rk.bin",    0xf800, 0x0800, CRC(2025C234), ROM_BIOS(1))
    ROM_SYSTEM_BIOS(1,"ver 2","Version 2")
...
COMP( 1983, orion128, 	 0,  	 0,	orion128, 	orion128, 	orion128, orion128,  "", 					 "Orion 128",	 0)
