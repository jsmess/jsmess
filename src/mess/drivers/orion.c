...
ROM_START( orion128 )
    ...
    ROM_SYSTEM_BIOS(0,"ver 3.2 rk","Version 3.2 rk")
    ROMX_LOAD( "m2rk.bin",    0xf800, 0x0800, CRC(2025C234), ROM_BIOS(1))
    ROM_SYSTEM_BIOS(1,"ver 3.2.2","Version 3.2.2 rk")
...
ROM_START( orionzms )
    ROM_REGION( 0x30000, REGION_CPU1, ROMREGION_ERASEFF )
    ROM_SYSTEM_BIOS(0,"ver 3.2 zms","Version 3.2 zms")
    ROMX_LOAD( "m32zms.bin",    0xf800, 0x0800, CRC(44CFD2AE),ROM_BIOS(1))
    ROM_SYSTEM_BIOS(1,"ver 3.4 zms","Version 3.4 zms")
    ROMX_LOAD( "m34zms.bin",    0xf800, 0x0800, CRC(0F87A80B),ROM_BIOS(2))
    ROM_SYSTEM_BIOS(2,"ver 3.5 zmsd","Version 3.5 zmsd")
