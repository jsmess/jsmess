...
/* Orion 128 */
static ADDRESS_MAP_START(orion128_mem, AS_PROGRAM, 8)
...
/* Orion Z80 Card II */
static ADDRESS_MAP_START( orion128_io , AS_IO, 8)
...
static ADDRESS_MAP_START(orionz80_mem, AS_PROGRAM, 8)
	ADDRESS_MAP_UNMAP_HIGH
...
/* Orion Pro */
static ADDRESS_MAP_START( orionz80_io , AS_IO, 8)
    AM_RANGE( 0x0000, 0xffff) AM_READWRITE ( orionz80_io_r, orionz80_io_w )
ADDRESS_MAP_END

static ADDRESS_MAP_START(orionpro_mem, AS_PROGRAM, 8)
	ADDRESS_MAP_UNMAP_HIGH
...
static ADDRESS_MAP_START( orionpro_io , AS_IO, 8)
...
COMP( 1990, orion128,	 0, 		0,		orion128,	radio86,	0,        "<unknown>",				 "Orion 128",	 0)
COMP( 1990, orionms,	 orion128,	0,		orion128ms,	ms7007, 	0,        "<unknown>",				 "Orion 128 (MS7007)",	 0)
COMP( 1990, orionz80,	 orion128,	0,		orionz80,	radio86,	0,        "<unknown>",				 "Orion 128 + Z80 Card II",	 0)
COMP( 1990, orionide,	 orion128,	0,		orionz80,	radio86,	0,        "<unknown>",				 "Orion 128 + Z80 Card II + IDE",	 0)
COMP( 1990, orionzms,	 orion128,	0,		orionz80ms,	ms7007, 	0,        "<unknown>",				 "Orion 128 + Z80 Card II (MS7007)",	 0)
COMP( 1990, orionidm,	 orion128,	0,		orionz80ms,	ms7007, 	0,        "<unknown>",				 "Orion 128 + Z80 Card II + IDE (MS7007)",	 0)
COMP( 1994, orionpro,	 orion128,	0,		orionpro,	radio86,	0,        "<unknown>",				 "Orion Pro",	 0)
