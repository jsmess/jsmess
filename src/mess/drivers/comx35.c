...
static MACHINE_DRIVER_START( comx35p )
	...
	MDRV_SOUND_ADD("cop1869", CDP1869, CDP1869_DOT_CLK_PAL)
...
static MACHINE_DRIVER_START( comx35n )
	...
	MDRV_SOUND_ADD("cop1869", CDP1869, CDP1869_DOT_CLK_NTSC)
	MDRV_SOUND_ROUTE(ALL_OUTPUTS, "mono", 0.25)
...
ROM_START( comx35p )
	...
	ROM_COPY( "U3", 0xe000, 0x1000, 0x0800 )
	...
	ROM_REGION( 0x10000, "gfx1", 0 ) // MC6845 font
