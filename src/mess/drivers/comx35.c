...
/*
	...
	MDRV_CPU_ADD(CX005, 4000000) // some kind of MC6805/MC68HC05 clone
...
ROM_START( comx35p )
	...
	ROM_REGION( 0x6000, REGION_GFX2, ROMREGION_ERASEFF ) // Plotter fonts
	ROM_LOAD( "pl80.it.em.ou.bin",		0x2000, 0x2000, CRC(1b4a3198) SHA1(138ff6666a31c2d18cd63e609dd94d9cd1529931) )
	ROM_LOAD( "pl80.tiny.bin",			0x4000, 0x0400, CRC(940ec1ed) SHA1(ad83a3b57e2f0fbaa1e40644cd999b3f239635e8) )
ROM_END
