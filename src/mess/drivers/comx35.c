...
ROM_START( comx35p )
	...
	ROM_LOAD( "f&m.joycard.bin",		0xa000, 0x0002, CRC(a681ea11) SHA1(ff4baa8b79471f31667337c30345d642810776e1) )
	...
	ROM_REGION( 0x6000, REGION_GFX2, 0 ) // Plotter fonts
	ROM_LOAD( "pl80.it.em.ou.bin",		0x0000, 0x2000, CRC(1b4a3198) SHA1(138ff6666a31c2d18cd63e609dd94d9cd1529931) )
	ROM_LOAD( "pl80.tiny.bin",			0x2000, 0x0400, CRC(940ec1ed) SHA1(ad83a3b57e2f0fbaa1e40644cd999b3f239635e8) )

	ROM_REGION( 0x1000, REGION_CPU2, 0 ) // COMX PL-80 CPU (CX005)
	ROM_LOAD( "pl80.bin",				0x0080, 0x0e00, CRC(ae059e5b) SHA1(f25812606b0082d32eb603d0a702a2187089d332) )
ROM_END
