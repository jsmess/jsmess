...
static WRITE8_HANDLER( pl80_port_a_w )
{
	...
	*/
	...
	comxpl80_state *state = machine->driver_data;
	...
	{
		// read switches
		state->plotter_data = input_port_read(machine, "SW");
	}
}
...
static MACHINE_DRIVER_START( comxpl80 )
	...
	MDRV_CPU_ADD_TAG("main", M6805, 4000000) // CX005: some kind of MC6805/MC68HC05 clone
