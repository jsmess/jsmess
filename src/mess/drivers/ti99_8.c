...
static INPUT_PORTS_START(ti99_8)
	...
	PORT_START_TAG("KEY14")    /* col 14: "wired handset 1" (= joystick 1) */
	...
	PORT_START_TAG("KEY15")    /* col 15: "wired handset 2" (= joystick 2) */
