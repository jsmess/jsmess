...
static MACHINE_DRIVER_START( palm )
    ...
    MDRV_CPU_ADD( "main", M68000, 32768*506 )        /* 16.580608 MHz */
...
#define PALM_68328_BIOS \
    ...
    ROMX_LOAD( "palmos30-en.rom", 0x000000, 0x008000, CRC(6f461f3d) SHA1(7fbf592b4dc8c222be510f6cfda21d48ebe22413), ROM_GROUPWORD | ROM_BIOS(5) ) \
    ...
    ROMX_LOAD( "palmos30-en-dbg.rom", 0x000000, 0x008000, CRC(4deda226) SHA1(1c67d6fee2b6a4acd51cda6ef3490305730357ad), ROM_GROUPWORD | ROM_BIOS(6) ) \
    ...
    ROMX_LOAD( "palmos30-de.rom", 0x000000, 0x008000, CRC(b991d6c3) SHA1(73e7539517b0d931e9fa99d6f6914ad46fb857b4), ROM_GROUPWORD | ROM_BIOS(7) ) \
    ...
    ROMX_LOAD( "palmos30-fr.rom", 0x000000, 0x008000, CRC(a2a9ff6c) SHA1(7cb119f896017e76e4680510bee96207d9d28e44), ROM_GROUPWORD | ROM_BIOS(8) ) \
    ...
    ROMX_LOAD( "palmos30-sp.rom", 0x000000, 0x008000, CRC(63a595be) SHA1(f6e03a2fedf0cbe6228613f50f8e8717e797877d), ROM_GROUPWORD | ROM_BIOS(9) ) \
    ...
    ROMX_LOAD( "palmos33-en-iii.rom", 0x000000, 0x008000, CRC(1eae0253) SHA1(e4626f1d33eca8368284d906b2152dcd28b71bbd), ROM_GROUPWORD | ROM_BIOS(10) ) \
    ...
    ROMX_LOAD( "palmos33-fr-iii.rom", 0x000000, 0x008000, CRC(d7894f5f) SHA1(c7c90df814d4f97958194e0bc28c595e967a4529), ROM_GROUPWORD | ROM_BIOS(11) ) \
    ...
    ROMX_LOAD( "palmos33-de-iii.rom", 0x000000, 0x008000, CRC(a5a99c45) SHA1(209b0154942dab80b56d5e6e68fa20b9eb75f5fe), ROM_GROUPWORD | ROM_BIOS(12) )
