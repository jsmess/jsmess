...
static ADDRESS_MAP_START( pp01_io, AS_IO, 8, pp01_state )
	...
	AM_RANGE(0xcc, 0xcf) AM_WRITE_LEGACY(pp01_video_write_mode_w)
	AM_RANGE(0xd0, 0xd3) AM_DEVREADWRITE_LEGACY("pit8253", pit8253_r, pit8253_w)
	AM_RANGE(0xe0, 0xef) AM_READWRITE_LEGACY(pp01_mem_block_r, pp01_mem_block_w)
	AM_RANGE(0xf0, 0xff) AM_READWRITE_LEGACY(pp01_mem_block_r, pp01_mem_block_w)
ADDRESS_MAP_END
