...
static READ8_HANDLER( cfx9850_battery_level_r )
{
	return 0x30;
}
...
static INPUT_PORTS_START( cfx9850 )
	...
	PORT_BIT( 0x40, IP_ACTIVE_HIGH, IPT_OTHER ) PORT_NAME( "0   Z" ) PORT_CODE(KEYCODE_0)
	PORT_BIT( 0x83, 0x83, IPT_UNUSED )

	PORT_START( "KO3" )
	PORT_BIT( 0x04, IP_ACTIVE_HIGH, IPT_OTHER ) PORT_NAME( "- ] Y" )
	PORT_BIT( 0x08, IP_ACTIVE_HIGH, IPT_OTHER ) PORT_NAME( "+ [ X" )
	PORT_BIT( 0x10, IP_ACTIVE_HIGH, IPT_OTHER ) PORT_NAME( "3   W" ) PORT_CODE(KEYCODE_3)
	PORT_BIT( 0x20, IP_ACTIVE_HIGH, IPT_OTHER ) PORT_NAME( "2   V" ) PORT_CODE(KEYCODE_2)
	PORT_BIT( 0x40, IP_ACTIVE_HIGH, IPT_OTHER ) PORT_NAME( "1   U" ) PORT_CODE(KEYCODE_1)
	PORT_BIT( 0x83, 0x83, IPT_UNUSED )
	...
	PORT_BIT( 0x40, IP_ACTIVE_HIGH, IPT_OTHER ) PORT_NAME( "F1 Trace" )	PORT_CODE(KEYCODE_F1)
	PORT_BIT( 0x81, 0x81, IPT_UNUSED )
