...
CONS( 1980,  chesstrv,  0,      0,      chesstrv,    chesstrv, chesstrv_state,    0,   "Acetronic", "Chess Traveller", GAME_NOT_WORKING | GAME_NO_SOUND_HW | GAME_SUPPORTS_SAVE )
CONS( 1979,  borisdpl,  0,      0,      borisdpl,    borisdpl, chesstrv_state,    0,   "Applied Concepts",  "Boris Diplomat",        GAME_NOT_WORKING | GAME_NO_SOUND_HW | GAME_SUPPORTS_SAVE )
