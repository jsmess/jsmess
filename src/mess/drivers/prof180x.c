...
static MACHINE_CONFIG_START( prof180x, prof180x_state )
    ...
    MDRV_CPU_ADD(HD64180_TAG, Z80, XTAL_9_216MHz) // HD64180
	...
	/* devices */
	MDRV_FLOPPY_4_DRIVES_ADD(prof180x_floppy_config)
	MDRV_UPD765A_ADD(FDC9268_TAG, fdc_intf)
	//MDRV_RTC8583_ADD(MK3835_TAG, rtc_intf)
	MDRV_CENTRONICS_ADD(CENTRONICS_TAG, standard_centronics)

	/* internal ram */
	MDRV_RAM_ADD("messram")
	MDRV_RAM_DEFAULT_SIZE("128K")
	MDRV_RAM_EXTRA_OPTIONS("256K,512K")
MACHINE_CONFIG_END
