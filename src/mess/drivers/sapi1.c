...
static ADDRESS_MAP_START(sapi1_mem, ADDRESS_SPACE_PROGRAM, 8)
	...
	AM_RANGE(0x1000, 0x23ff) AM_RAM
	AM_RANGE(0x2400, 0x24ff) AM_READWRITE(sapi1_keyboard_r, sapi1_keyboard_w) // keyboard	
...
static MACHINE_DRIVER_START( sapi1 )
    ...
    /* video hardware */
		...
		MDRV_SCREEN_SIZE(40*6, 24*12)
		MDRV_SCREEN_VISIBLE_AREA(0, 40*6-1, 0, 24*12-1)
