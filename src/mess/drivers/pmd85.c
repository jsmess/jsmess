...
static ADDRESS_MAP_START( pmd85_mem , ADDRESS_SPACE_PROGRAM, 8)
	...
	AM_RANGE(0x4000, 0x7fff) AM_READWRITE(SMH_BANK(5), SMH_BANK(5))
	AM_RANGE(0x8000, 0x8fff) AM_READWRITE(SMH_BANK(6), SMH_ROM)
	AM_RANGE(0x9000, 0x9fff) AM_READWRITE(SMH_NOP,   SMH_NOP)
	AM_RANGE(0xa000, 0xafff) AM_READWRITE(SMH_BANK(7), SMH_ROM)
	AM_RANGE(0xb000, 0xbfff) AM_READWRITE(SMH_NOP,   SMH_NOP)
	AM_RANGE(0xc000, 0xffff) AM_READWRITE(SMH_BANK(8), SMH_BANK(8))
ADDRESS_MAP_END
...
static ADDRESS_MAP_START( pmd852a_mem , ADDRESS_SPACE_PROGRAM, 8)
	...
	AM_RANGE(0x4000, 0x7fff) AM_READWRITE(SMH_BANK(5), SMH_BANK(5))
	AM_RANGE(0x8000, 0x8fff) AM_READWRITE(SMH_BANK(6), SMH_ROM)
	AM_RANGE(0x9000, 0x9fff) AM_READWRITE(SMH_BANK(7), SMH_BANK(7))
	AM_RANGE(0xa000, 0xafff) AM_READWRITE(SMH_BANK(8), SMH_ROM)
	AM_RANGE(0xb000, 0xbfff) AM_READWRITE(SMH_BANK(9), SMH_BANK(9))
	AM_RANGE(0xc000, 0xffff) AM_READWRITE(SMH_BANK(10), SMH_BANK(10))
ADDRESS_MAP_END
...
static ADDRESS_MAP_START( alfa_mem , ADDRESS_SPACE_PROGRAM, 8)
	AM_RANGE(0x0000, 0x0fff) AM_READWRITE(SMH_BANK(1), SMH_BANK(1))
	AM_RANGE(0x1000, 0x33ff) AM_READWRITE(SMH_BANK(2), SMH_BANK(2))
	AM_RANGE(0x3400, 0x3fff) AM_READWRITE(SMH_BANK(3), SMH_BANK(3))
	AM_RANGE(0x4000, 0x7fff) AM_READWRITE(SMH_BANK(4), SMH_BANK(4))
	AM_RANGE(0x8000, 0x8fff) AM_READWRITE(SMH_BANK(5), SMH_ROM)
	AM_RANGE(0x9000, 0xb3ff) AM_READWRITE(SMH_BANK(6), SMH_ROM)
	AM_RANGE(0xb400, 0xbfff) AM_READWRITE(SMH_NOP,   SMH_NOP)
	AM_RANGE(0xc000, 0xffff) AM_READWRITE(SMH_BANK(7), SMH_BANK(7))
ADDRESS_MAP_END
