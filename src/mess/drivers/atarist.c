...
COMP( 1985,	st,			0,			0,		st,			st, st_state,			0,		"Atari",	"ST (USA)",				GAME_NOT_WORKING | GAME_SUPPORTS_SAVE )
COMP( 1985,	st_uk,		st,			0,		st,			st, st_state,			0,		"Atari",	"ST (UK)",				GAME_NOT_WORKING | GAME_SUPPORTS_SAVE )
COMP( 1985, st_de,		st,			0,		st,			st, st_state,			0,		"Atari",	"ST (Germany)",			GAME_NOT_WORKING | GAME_SUPPORTS_SAVE )
COMP( 1985, st_es,		st,			0,		st,			st, st_state,			0,		"Atari",	"ST (Spain)",			GAME_NOT_WORKING | GAME_SUPPORTS_SAVE )
COMP( 1985, st_fr,		st,			0,		st,			st, st_state,			0,		"Atari",	"ST (France)",			GAME_NOT_WORKING | GAME_SUPPORTS_SAVE )
COMP( 1985, st_nl,		st,			0,		st,			st, st_state,			0,		"Atari",	"ST (Netherlands)",		GAME_NOT_WORKING | GAME_SUPPORTS_SAVE )
COMP( 1985, st_se,		st,			0,		st,			st, st_state,			0,		"Atari",	"ST (Sweden)",			GAME_NOT_WORKING | GAME_SUPPORTS_SAVE )
COMP( 1985, st_sg,		st,			0,		st,			st, st_state,			0,		"Atari",	"ST (Switzerland)",		GAME_NOT_WORKING | GAME_SUPPORTS_SAVE )
COMP( 1987, megast,		st,			0,		megast,		st, megast_state,			0,		"Atari",	"MEGA ST (USA)",		GAME_NOT_WORKING | GAME_SUPPORTS_SAVE )
COMP( 1987, megast_uk,	st,			0,		megast,		st, megast_state,			0,		"Atari",	"MEGA ST (UK)",			GAME_NOT_WORKING | GAME_SUPPORTS_SAVE )
COMP( 1987, megast_de,	st,			0,		megast,		st, megast_state,			0,		"Atari",	"MEGA ST (Germany)",	GAME_NOT_WORKING | GAME_SUPPORTS_SAVE )
COMP( 1987, megast_fr,	st,			0,		megast,		st, megast_state,			0,		"Atari",	"MEGA ST (France)",		GAME_NOT_WORKING | GAME_SUPPORTS_SAVE )
COMP( 1987, megast_se,	st,			0,		megast,		st, megast_state,			0,		"Atari",	"MEGA ST (Sweden)",		GAME_NOT_WORKING | GAME_SUPPORTS_SAVE )
COMP( 1987, megast_sg,	st,			0,		megast,		st, megast_state,			0,		"Atari",	"MEGA ST (Switzerland)",GAME_NOT_WORKING | GAME_SUPPORTS_SAVE )
COMP( 1989, ste,		0,			0,		ste,		ste, ste_state,		0,		"Atari",	"STE (USA)",			GAME_NOT_WORKING | GAME_SUPPORTS_SAVE )
COMP( 1989, ste_uk,		ste,		0,		ste,		ste, ste_state,		0,		"Atari",	"STE (UK)",				GAME_NOT_WORKING | GAME_SUPPORTS_SAVE )
COMP( 1989, ste_de,		ste,		0,		ste,		ste, ste_state,		0,		"Atari",	"STE (Germany)",		GAME_NOT_WORKING | GAME_SUPPORTS_SAVE )
COMP( 1989, ste_es,		ste,		0,		ste,		ste, ste_state,		0,		"Atari",	"STE (Spain)",			GAME_NOT_WORKING | GAME_SUPPORTS_SAVE )
COMP( 1989, ste_fr,		ste,		0,		ste,		ste, ste_state,		0,		"Atari",	"STE (France)",			GAME_NOT_WORKING | GAME_SUPPORTS_SAVE )
COMP( 1989, ste_it,		ste,		0,		ste,		ste, ste_state,		0,		"Atari",	"STE (Italy)",			GAME_NOT_WORKING | GAME_SUPPORTS_SAVE )
COMP( 1989, ste_se,		ste,		0,		ste,		ste, ste_state,		0,		"Atari",	"STE (Sweden)",			GAME_NOT_WORKING | GAME_SUPPORTS_SAVE )
COMP( 1989, ste_sg,		ste,		0,		ste,		ste, ste_state,		0,		"Atari",	"STE (Switzerland)",	GAME_NOT_WORKING | GAME_SUPPORTS_SAVE )
//COMP( 1990, stbook,       ste,        0,      stbook,     stbook, stbook_state,     0,      "Atari",    "STBook",               GAME_NOT_WORKING )
COMP( 1990,	tt030,		0,			0,		tt030,		tt030, st_state,		0,		"Atari",	"TT030 (USA)",			GAME_NOT_WORKING )
COMP( 1990,	tt030_uk,	tt030,		0,		tt030,		tt030, st_state,		0,		"Atari",	"TT030 (UK)",			GAME_NOT_WORKING )
COMP( 1990,	tt030_de,	tt030,		0,		tt030,		tt030, st_state,		0,		"Atari",	"TT030 (Germany)",		GAME_NOT_WORKING )
COMP( 1990,	tt030_fr,	tt030,		0,		tt030,		tt030, st_state,		0,		"Atari",	"TT030 (France)",		GAME_NOT_WORKING )
COMP( 1990,	tt030_pl,	tt030,		0,		tt030,		tt030, st_state,		0,		"Atari",	"TT030 (Poland)",		GAME_NOT_WORKING )
COMP( 1991, megaste,	ste,		0,		megaste,	st, ste_state,			0,		"Atari",	"MEGA STE (USA)",		GAME_NOT_WORKING | GAME_SUPPORTS_SAVE )
COMP( 1991, megaste_uk,	ste,		0,		megaste,	st, ste_state,			0,		"Atari",	"MEGA STE (UK)",		GAME_NOT_WORKING | GAME_SUPPORTS_SAVE )
COMP( 1991, megaste_de,	ste,		0,		megaste,	st, ste_state,			0,		"Atari",	"MEGA STE (Germany)",	GAME_NOT_WORKING | GAME_SUPPORTS_SAVE )
COMP( 1991, megaste_es,	ste,		0,		megaste,	st, ste_state,			0,		"Atari",	"MEGA STE (Spain)",		GAME_NOT_WORKING | GAME_SUPPORTS_SAVE )
COMP( 1991, megaste_fr,	ste,		0,		megaste,	st, ste_state,			0,		"Atari",	"MEGA STE (France)",	GAME_NOT_WORKING | GAME_SUPPORTS_SAVE )
COMP( 1991, megaste_it,	ste,		0,		megaste,	st, ste_state,			0,		"Atari",	"MEGA STE (Italy)",		GAME_NOT_WORKING | GAME_SUPPORTS_SAVE )
COMP( 1991, megaste_se,	ste,		0,		megaste,	st, ste_state,			0,		"Atari",	"MEGA STE (Sweden)",	GAME_NOT_WORKING | GAME_SUPPORTS_SAVE )
COMP( 1992, falcon30,	0,			0,		falcon,		falcon, st_state,		0,		"Atari",	"Falcon030",			GAME_NOT_WORKING )
COMP( 1992, falcon40,	falcon30,	0,		falcon40,	falcon, st_state,		0,		"Atari",	"Falcon040 (prototype)",GAME_NOT_WORKING )
//COMP( 1989, stacy,    st,  0,      stacy,    stacy, XXX_CLASS,    0,     "Atari", "Stacy", GAME_NOT_WORKING )
//COMP( 1991, stpad,    ste, 0,      stpad,    stpad, XXX_CLASS,    0,     "Atari", "STPad (prototype)", GAME_NOT_WORKING )
//COMP( 1992, fx1,      0,        0,      falcon,   falcon, st_state,   0,     "Atari", "FX-1 (prototype)", GAME_NOT_WORKING )
