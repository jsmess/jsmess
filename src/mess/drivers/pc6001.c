...
ROM_START( pc6001m2 )
  ...
  ROM_LOAD( "cgrom60m.62", 0x0000, 0x2000, CRC(3ce48c33) SHA1(f3b6c63e83a17d80dde63c6e4d86adbc26f84f79))
...
ROM_START( pc6001sr )
  ...
  ROM_LOAD( "systemrom2.64", 0x0000, 0x10000, CRC(55a62a1d) SHA1(3a19855d290fd4ac04e6066fe4a80ecd81dc8dd7))
ROM_END
...
ROM_START( pc6600 )
  ...
  ROM_LOAD( "cgrom66.66", 0x0000, 0x2000, CRC(3ce48c33) SHA1(f3b6c63e83a17d80dde63c6e4d86adbc26f84f79))
...
ROM_START( pc6600sr )
  ...
  ROM_LOAD( "systemrom2.68", 0x0000, 0x10000, CRC(55a62a1d) SHA1(3a19855d290fd4ac04e6066fe4a80ecd81dc8dd7))
ROM_END
/* Driver */

/*    YEAR  NAME    PARENT  COMPAT   MACHINE    INPUT    INIT    CONFIG COMPANY   FULLNAME       FLAGS */
COMP( ????, pc6001,  0,       0, 	pc6001, 	pc6001, 	 0,  	  pc6001,  	 "NEC",   "PC-6001",		GAME_NOT_WORKING)
COMP( ????, pc6001a, pc6001,  0, 	pc6001, 	pc6001, 	 0,  	  pc6001,  	 "NEC",   "PC-6001A",		GAME_NOT_WORKING)
COMP( ????, pc6001m2,pc6001,  0, 	pc6001, 	pc6001, 	 0,  	  pc6001,  	 "NEC",   "PC-6001mkII",	GAME_NOT_WORKING)
COMP( ????, pc6001sr,pc6001,  0, 	pc6001, 	pc6001, 	 0,  	  pc6001,  	 "NEC",   "PC-6001mkIISR",	GAME_NOT_WORKING)
COMP( ????, pc6600,  pc6001,  0, 	pc6001, 	pc6001, 	 0,  	  pc6001,  	 "NEC",   "PC-6600",		GAME_NOT_WORKING)
COMP( ????, pc6600sr,pc6001,  0, 	pc6001, 	pc6001, 	 0,  	  pc6001,  	 "NEC",   "PC-6600SR",		GAME_NOT_WORKING)
