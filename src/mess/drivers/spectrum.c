...
ROM_START(spectrum)
	...
	ROM_SYSTEM_BIOS(7, "qu4i1993", "Quorum 64")
	ROMX_LOAD("qu4i1993.rom",0x0000,0x4000, CRC(48085B0E), ROM_BIOS(8))
	ROM_SYSTEM_BIOS(8, "magic6_5", "Magic-06")
	ROMX_LOAD("magic6_5.rom",0x0000,0x4000, CRC(CB63AE06), ROM_BIOS(9))	
