...
ROM_START( pecom64 )
	  ...
	  ROMX_LOAD( "170887-rom1.bin", 0x8000, 0x4000, CRC(43710fb4) SHA1(4f1ab468dd9f7a3bb1c5617525673475beb40a27), ROM_BIOS(2) )
	  ROMX_LOAD( "170887-rom2.bin", 0xc000, 0x4000, CRC(d0d34f08) SHA1(bcb53f1187f3823b7ad131fde3e22f92d61e46a7), ROM_BIOS(2) )
ROM_END
