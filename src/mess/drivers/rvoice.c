...
static ADDRESS_MAP_START(hd63701_main_mem, AS_PROGRAM, 8)
	...
	AM_RANGE(0x0060, 0x007f) AM_DEVREADWRITE_MODERN("acia65c51", acia6551_device, data_r, data_w) // ACIA 65C51
	AM_RANGE(0x2000, 0x7fff) AM_RAM // EXTERNAL SRAM
	AM_RANGE(0x8000, 0xffff) AM_ROM // 27512 EPROM
ADDRESS_MAP_END

static ADDRESS_MAP_START(hd63701_main_io, AS_IO, 8)
	ADDRESS_MAP_UNMAP_HIGH
ADDRESS_MAP_END
