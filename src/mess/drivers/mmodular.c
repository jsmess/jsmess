...
static ADDRESS_MAP_START(gen32_mem, AS_PROGRAM, 32)
	...
	AM_RANGE( 0xe8000000, 0xe8007fff )  AM_RAM AM_BASE(&save_ram32) AM_SHARE("nvram")
...
static ADDRESS_MAP_START(bpl32_mem, AS_PROGRAM, 32)
	...
	AM_RANGE( 0xd00000 , 0xd07fff )  AM_RAM AM_BASE(&save_ram32) AM_SHARE("nvram")
...
static ADDRESS_MAP_START(van32_mem, AS_PROGRAM, 32)
	...
	AM_RANGE( 0xa8000000, 0xa8007fff )  AM_RAM AM_BASE(&save_ram32) AM_SHARE("nvram")
...
static ADDRESS_MAP_START(van16_mem, AS_PROGRAM, 16)
	...
	AM_RANGE( 0x800000, 0x803fff )  AM_RAM AM_BASE(&save_ram) AM_SHARE("nvram")
