...
static ADDRESS_MAP_START( mbc200_io , AS_IO, 8, mbc200_state)
	...
	//AM_RANGE(0x, 0x) AM_DEVREADWRITE("ppi8255_2", i8255_device, read, write)
	...
	//AM_RANGE(0x0, 0x3) AM_DEVREADWRITE_LEGACY("fdc", wd17xx_r, wd17xx_w)
	//AM_RANGE(0x, 0x) AM_DEVREADWRITE("i8251_1", i8251_device, data_r, data_w)
	//AM_RANGE(0x, 0x) AM_DEVREADWRITE("i8251_1", i8251_device, status_r, control_w)
	//AM_RANGE(0x, 0x) AM_DEVREADWRITE("i8251_2", i8251_device, data_r, data_w)
	//AM_RANGE(0x, 0x) AM_DEVREADWRITE("i8251_2", i8251_device, status_r, control_w)
ADDRESS_MAP_END
/*
