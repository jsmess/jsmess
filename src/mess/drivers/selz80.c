...
static MACHINE_DRIVER_START( selz80 )
...
ROM_START( selz80 )
	...
	ROM_LOAD( "term80-a000.bin", 0xa000, 0x2000, CRC(a58c0a7) SHA1(d1b4b3b2ad0d084175b1ff6966653d8b20025252))
