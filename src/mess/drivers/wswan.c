...
CONS( 1999, wswan,   0,      0,      wswan,   wswan, wswan_state, 0,    "Bandai", "WonderSwan",       GAME_IMPERFECT_SOUND )
CONS( 2000, wscolor, wswan,  0,      wscolor, wswan, wswan_state, 0,    "Bandai", "WonderSwan Color", GAME_IMPERFECT_SOUND )
