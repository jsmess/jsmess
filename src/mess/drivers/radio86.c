...
ROM_START( radio86 )
	...
	ROM_LOAD( "bios.rom", 0xf000, 0x0800, CRC(BF1CEEA5))
	ROM_LOAD( "bios.rom", 0xf800, 0x0800, CRC(BF1CEEA5))
	ROM_REGION(0x0800, REGION_GFX1,0)
	ROM_LOAD ("radio86.fnt", 0x0000, 0x0400, CRC(21E9ED84) )
ROM_END

ROM_START( radio4k )
	ROM_REGION( 0x10000, REGION_CPU1, ROMREGION_ERASEFF )
	ROM_LOAD( "bios4k.rom", 0xf000, 0x1000, CRC(2AC9D864))
	ROM_REGION(0x0800, REGION_GFX1,0)
	ROM_LOAD ("radio86.fnt", 0x0000, 0x0400, CRC(21E9ED84) )
ROM_END
