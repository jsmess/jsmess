...
ROM_START( mc8030 )
	...
	ROM_LOAD( "spe_1.rom", 0x2000, 0x0800, CRC(37c71c68) SHA1(951650698b00f65facf5ccfbd8dd13628a93425d))
	ROM_LOAD( "spe_2.rom", 0x2800, 0x0400, CRC(9ec8f287) SHA1(cdf5a9583d898814ba480ffbc8d906a642c6dc81))
ROM_END
