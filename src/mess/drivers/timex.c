...
static ADDRESS_MAP_START (ts2068_io, ADDRESS_SPACE_IO, 8)	
	...
	AM_RANGE(0xf5, 0xf5) AM_DEVWRITE( SOUND, "ay8912", ay8910_address_w ) AM_MIRROR(0xff00)
	AM_RANGE(0xf6, 0xf6) AM_DEVREADWRITE( SOUND, "ay8912", ay8910_r, ay8910_data_w ) AM_MIRROR(0xff00)
