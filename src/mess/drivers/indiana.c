...
static ADDRESS_MAP_START(indiana_mem, ADDRESS_SPACE_PROGRAM, 32)
	...
	AM_RANGE(0x00000000, 0x0000ffff) AM_MIRROR(0x7f800000) AM_ROM AM_REGION("user1",0)
	AM_RANGE(0x00100000, 0x001fffff) AM_MIRROR(0x7f800000) AM_RAM // SRAM
	...
	AM_RANGE(0x80000000, 0x803fffff) AM_RAM
	AM_RANGE(0xfffe0000, 0xfffeffff) AM_RAM
ADDRESS_MAP_END
...
COMP( 1993, indiana,  0,       0, 	indiana, 	indiana, 	 0,  0,  	 "Indiana University",   "Indiana University 68030 board",		GAME_NOT_WORKING)
