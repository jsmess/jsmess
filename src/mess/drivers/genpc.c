...
static MACHINE_CONFIG_START( pcmda, genpc_state )
	...
	MCFG_ISA8_SLOT_ADD("mb:isa", 1, "isa1", pc_isa8_cards, "mda", NULL)
	MCFG_ISA8_SLOT_ADD("mb:isa", 2, "isa2", pc_isa8_cards, "com", NULL)
	MCFG_ISA8_SLOT_ADD("mb:isa", 3, "isa3", pc_isa8_cards, "fdc", NULL)
	MCFG_ISA8_SLOT_ADD("mb:isa", 4, "isa4", pc_isa8_cards, "hdc", NULL)
	MCFG_ISA8_SLOT_ADD("mb:isa", 5, "isa5", pc_isa8_cards, "adlib", NULL)
	MCFG_ISA8_SLOT_ADD("mb:isa", 6, "isa6", pc_isa8_cards, NULL, NULL)
...
static MACHINE_CONFIG_START( pcherc, genpc_state )
	...
	MCFG_ISA8_SLOT_ADD("mb:isa", 1, "isa1", pc_isa8_cards, "hercules", NULL)
	MCFG_ISA8_SLOT_ADD("mb:isa", 2, "isa2", pc_isa8_cards, "com", NULL)
	MCFG_ISA8_SLOT_ADD("mb:isa", 3, "isa3", pc_isa8_cards, "fdc", NULL)
	MCFG_ISA8_SLOT_ADD("mb:isa", 4, "isa4", pc_isa8_cards, "hdc", NULL)
	MCFG_ISA8_SLOT_ADD("mb:isa", 5, "isa5", pc_isa8_cards, "adlib", NULL)
...
static MACHINE_CONFIG_START( pccga, genpc_state )
	...
	MCFG_ISA8_SLOT_ADD("mb:isa", 1, "isa1", pc_isa8_cards, "com", NULL)
	MCFG_ISA8_SLOT_ADD("mb:isa", 2, "isa2", pc_isa8_cards, "fdc", NULL)
	MCFG_ISA8_SLOT_ADD("mb:isa", 3, "isa3", pc_isa8_cards, "hdc", NULL)
	MCFG_ISA8_SLOT_ADD("mb:isa", 4, "isa4", pc_isa8_cards, "sblaster", NULL)
	MCFG_ISA8_SLOT_ADD("mb:isa", 5, "isa5", pc_isa8_cards, NULL, NULL)
	MCFG_ISA8_SLOT_ADD("mb:isa", 6, "isa6", pc_isa8_cards, NULL, NULL)
