/***************************************************************************
    ...
    25/04/2011 Added partial keyboard. Need to find Shift key etc.
...
static INPUT_PORTS_START( beehive )
	...
	PORT_START("X3")
		...
		PORT_BIT(0x04, IP_ACTIVE_LOW, IPT_KEYBOARD) PORT_NAME("`")	PORT_CODE(KEYCODE_TILDE)	PORT_CHAR('`')
		...
		PORT_BIT(0x40, IP_ACTIVE_LOW, IPT_KEYBOARD) PORT_NAME("'")	PORT_CODE(KEYCODE_QUOTE)	PORT_CHAR('\'')
		PORT_BIT(0x80, IP_ACTIVE_LOW, IPT_KEYBOARD) PORT_NAME("{")	PORT_CODE(KEYCODE_END)	PORT_CHAR('{')

	PORT_START("X4")
		PORT_BIT(0x01, IP_ACTIVE_LOW, IPT_KEYBOARD) PORT_NAME("<")	PORT_CODE(KEYCODE_PGDN)	PORT_CHAR('<')
		...
		PORT_BIT(0x08, IP_ACTIVE_LOW, IPT_KEYBOARD) PORT_NAME("/")	PORT_CODE(KEYCODE_SLASH)	PORT_CHAR('/')
		PORT_BIT(0x10, IP_ACTIVE_LOW, IPT_KEYBOARD) PORT_NAME("1")	PORT_CODE(KEYCODE_1)	PORT_CHAR('1')
	...
	PORT_START("X5")
		...
		PORT_BIT(0x10, IP_ACTIVE_LOW, IPT_KEYBOARD) PORT_NAME("9")	PORT_CODE(KEYCODE_9)	PORT_CHAR('9')
