...
CONS( 1989, lynx,   0,      0,      lynx,   lynx, lynx_state,   0,       "Atari",  "Lynx",	0)
// CONS( 1991, lynx2,  lynx,   0,      lynx2,  lynx, lynx_state,   0,       "Atari",  "Lynx II",    GAME_NOT_WORKING | GAME_IMPERFECT_SOUND )
