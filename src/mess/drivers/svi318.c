...
static INPUT_PORTS_START( svi318 )
 ...
 PORT_START_TAG("LINE9") /* 9 */
  PORT_BIT (0xff, IP_ACTIVE_LOW, IPT_UNUSED)

 PORT_START_TAG("LINE10") /* 10 */
  PORT_BIT (0xff, IP_ACTIVE_LOW, IPT_UNUSED)

 PORT_START_TAG("JOYSTICKS") /* 11 */
 ...
 PORT_START_TAG("BUTTONS") /* 12 */
  PORT_BIT (0x10, IP_ACTIVE_LOW, IPT_BUTTON1)
  PORT_BIT (0x20, IP_ACTIVE_LOW, IPT_BUTTON1) PORT_PLAYER(2)

 PORT_START_TAG("CONFIG") /* 13 */
...
static INPUT_PORTS_START ( svi328 )
 ...
 PORT_START_TAG("LINE10") /* 10 */
  ...
  PORT_BIT (0x40, IP_ACTIVE_LOW, IPT_KEYBOARD) PORT_NAME("NUM .") PORT_CODE(KEYCODE_ENTER_PAD)
