...
static ADDRESS_MAP_START( svi318_io, ADDRESS_SPACE_IO, 8 )
	...
	AM_RANGE( 0x88, 0x88) AM_DEVWRITE( SOUND, "ay8910", ay8910_address_w )
	AM_RANGE( 0x8c, 0x8c) AM_DEVWRITE( SOUND, "ay8910", ay8910_data_w )
	AM_RANGE( 0x90, 0x90) AM_DEVREAD( SOUND, "ay8910", ay8910_r )
