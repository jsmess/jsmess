...
INPUT_PORTS_START( vic20_joystick )
...
INPUT_PORTS_START( vic20_lightpen_6560 )
...
INPUT_PORTS_START( vic20_lightpen_6561 )
	PORT_START_TAG( TAG_LIGHTPENX )
...
INPUT_PORTS_START( vic20_keyboard )
...
INPUT_PORTS_START( vic20_expansion )
...
INPUT_PORTS_START( vic20_devices )
