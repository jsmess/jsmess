...
{
public:
	c68ksbc_state(running_machine &machine, const driver_device_config_base &config)
	...
	DECLARE_WRITE8_MEMBER( c68ksbc_kbd_put );
	UINT8 m_term_data;
};
...
WRITE8_MEMBER( c68ksbc_state::c68ksbc_kbd_put )
{
	m_term_data = data;
}

static GENERIC_TERMINAL_INTERFACE( c68ksbc_terminal_intf )
{
	DEVCB_DRIVER_MEMBER(c68ksbc_state, c68ksbc_kbd_put)
};
...
static MACHINE_CONFIG_START( c68ksbc, c68ksbc_state )
	...
	MCFG_GENERIC_TERMINAL_ADD(TERMINAL_TAG, c68ksbc_terminal_intf)
MACHINE_CONFIG_END
