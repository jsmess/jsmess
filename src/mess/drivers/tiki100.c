...
ROM_START( tiki100 )
  ...
  ROM_LOAD( "tikirom-1.35", 0x0000, 0x2000, CRC(7dac5ee7) SHA1(14d622fd843833faec346bf5357d7576061f5a3d))
  ROM_LOAD( "tikirom-2.03w", 0x0000, 0x2000, CRC(79662476) SHA1(96336633ecaf1b2190c36c43295ac9f785d1f83a))
