...
ROM_START( special )
    ...
    ROMX_LOAD( "special1.rom", 0xc000, 0x1000, CRC(217414BD) SHA1(345cd1410fbca8f75421d12d1419f27f81cd35d6), ROM_BIOS(1))
    ROM_SYSTEM_BIOS(1, "2nd", "2nd rev.")
    ROMX_LOAD( "special2.rom", 0xc000, 0x1000, CRC(FEDFBC37) SHA1(b79474833bbf558c39493dec3e8eabf9885c7c7c), ROM_BIOS(2))
...
ROM_START( specimx )
    ROM_REGION( 0x1b800, REGION_CPU1, ROMREGION_ERASEFF )
    ROM_LOAD( "specimx.rom", 0x10000, 0xb800, CRC(DB68F9B1) SHA1(c79888449f8a605267ec3e10dcc8e6e6f43b3a95))
ROM_END
