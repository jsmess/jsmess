...
void SetSelectedSoftware(int driver_index, const device_config *device, const char *software);
const char *GetSelectedSoftware(int driver_index, const device_config *device);
