...
typedef int (*snapquick_loadproc)(running_machine *machine, const device_config *image, const char *file_type, int file_size);

#define SNAPSHOT_LOAD(name)		int snapshot_load_##name(running_machine *machine, const device_config *image, const char *file_type, int snapshot_size)
#define QUICKLOAD_LOAD(name)	int quickload_load_##name(running_machine *machine, const device_config *image, const char *file_type, int quickload_size)
