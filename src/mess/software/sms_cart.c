...
SOFTWARE_LIST_START( sms_cart )
	...
	SOFTWARE( castlills, castlill, 19??, "Sega License", "Castle of Illusion - Starring Mickey Mouse (Unknown) (Sample)", NULL, 0, 0 )
	...
	SOFTWARE( colors, 0       , 19??, "Sega License", "Color & Switch Test (Unknown) (v1.3)", NULL, 0, 0 )
	...
	SOFTWARE( sonicedu, 0       , 19??, "Sega License", "Sonic's Edusoft (Unknown) (Prototype)", NULL, 0, 0 )
