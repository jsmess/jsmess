...
S32X_ROM_LOAD( 36greatp,   "36 great holes starring fred couples (32x rev1.x) (prototype - jul 06, 1994).bin", 0x000000, 0x102162,   CRC(6726c100) SHA1(6a066c44d71199d62dbc368efbc371dd01cc95e1) )
S32X_ROM_LOAD( 36greatp1,  "36 great holes starring fred couples(prototype - dec 02, 1994).bin",               0x000000, 0x300000,   CRC(323c2935) SHA1(5b1140e33357a3d0fdc056ab5a350d588b5e5af9) )
S32X_ROM_LOAD( 36greatp2,  "36 great holes starring fred couples(prototype - dec 03, 1994).bin",               0x000000, 0x300000,   CRC(3f30c0d2) SHA1(7ca51ad03ebb95f017a1b900a4a1592876d0d5c2) )
S32X_ROM_LOAD( 36greatp3,  "36 great holes starring fred couples(prototype - dec 06, 1994).bin",               0x000000, 0x300000,   CRC(ecfe5a0f) SHA1(af8eadcf49d0700c7479648865cc08cd40bc2808) )
...
S32X_ROM_LOAD( 36greatp5,  "36 great holes starring fred couples(prototype - dec 14, 1994).bin",               0x000000, 0x300000,   CRC(a63b0636) SHA1(f78481e57111295c2f5aeb64cd306c3c5fbf6d97) )
S32X_ROM_LOAD( 36greatp6,  "36 great holes starring fred couples(prototype - dec 19, 1994).bin",               0x000000, 0x300000,   CRC(c073149f) SHA1(e28ab68e8aed7aa8e9f33a6e9c68678272df4d95) )
S32X_ROM_LOAD( 36greatp7,  "36 great holes starring fred couples(prototype - dec 21, 1994 - b).bin",           0x000000, 0x300000,   CRC(cc0334bb) SHA1(6a1801ef96cc8c4a6896ab55e105f7fa8d707f51) )
S32X_ROM_LOAD( 36greatp8,  "36 great holes starring fred couples(prototype - dec 21, 1994).bin",               0x000000, 0x300000,   CRC(3893dcfe) SHA1(23e84ec4d8cec09992fcff323f32f49f44d23cd2) )
S32X_ROM_LOAD( 36greatp9,  "36 great holes starring fred couples(prototype - nov 01, 1994).bin",               0x000000, 0x2fdda0,   CRC(91106a69) SHA1(f6b944876b40b5a52bf1293b71373cb3f5c71a14) )
...
S32X_ROM_LOAD( shadsqp1,   "shadow squadron(prototype - feb 06, 1995).bin",                                    0x000000, 0x200000,   CRC(24057310) SHA1(6ff8cd79cfa073697dd13cd1c4dc767b4e0c558e) )
S32X_ROM_LOAD( shadsqp2,   "shadow squadron(prototype - feb 13, 1995).bin",                                    0x000000, 0x200000,   CRC(ca0de10e) SHA1(71061c0a02b4cc3c3e39d872bf86b190421cb594) )
S32X_ROM_LOAD( shadsqp3,   "shadow squadron(prototype - feb 22, 1995).bin",                                    0x000000, 0x200000,   CRC(48ef9ee9) SHA1(9d72335cb0468a9699f7e92927043387091bc0c9) )
S32X_ROM_LOAD( shadsqp4,   "shadow squadron(prototype - mar 02, 1995).bin",                                    0x000000, 0x200000,   CRC(25bdde61) SHA1(5a83e4ebffe8ac7108b45697be7468bd7f111642) )
S32X_ROM_LOAD( shadsqp5,   "shadow squadron(prototype - mar 06, 1995).bin",                                    0x000000, 0x200000,   CRC(7eec3665) SHA1(31a0a0a34719b1259de98458c24cf5eb78f7109c) )
S32X_ROM_LOAD( shadsqp6,   "shadow squadron(prototype - mar 13, 1995 - b).bin",                                0x000000, 0x200000,   CRC(fd7fedb2) SHA1(9875b357fd2d651892054d233c608b6f3bbb40e7) )
S32X_ROM_LOAD( shadsqp7,   "shadow squadron(prototype - mar 13, 1995).bin",                                    0x000000, 0x200000,   CRC(58962105) SHA1(9bae40d4d07a096545b11f6b0434db778c238af5) )
...
S32X_ROM_LOAD( vrdxp,      "virtua racing deluxe(prototype - aug 22, 1994).bin",                               0x000000, 0x300000,   CRC(6ebb3eda) SHA1(d4e996fd7fb26919017d1056d0de608a34f05184) )
...
S32X_ROM_LOAD( vrdxp2,     "virtua racing deluxe(prototype - sep 05, 1994).bin",                               0x000000, 0x300000,   CRC(99f38344) SHA1(88b3ef2bb0ccba25f3f83f218ca090e1a89512fe) )
...
S32X_ROM_LOAD( zaxxon2kp,  "zaxxon's motherbase 2000(prototype - feb 10, 1995).bin",                           0x000000, 0x200000,   CRC(c65693af) SHA1(9db5a93ae5fc4045df342a9f53b904ef130debbf) )
S32X_ROM_LOAD( zaxxon2kp1, "zaxxon's motherbase 2000(prototype - feb 21, 1995).bin",                           0x000000, 0x200000,   CRC(061c0cf2) SHA1(3a8c794139fe7255e7107877b2d0018a6eaa0300) )
S32X_ROM_LOAD( zaxxon2kp2, "zaxxon's motherbase 2000(prototype - feb 23, 1995).bin",                           0x000000, 0x200000,   CRC(e92b36c5) SHA1(6c93f432610908950b594bb8d289fe81de88fbdf) )
S32X_ROM_LOAD( zaxxon2kp3, "zaxxon's motherbase 2000(prototype - feb 27, 1995).bin",                           0x000000, 0x200000,   CRC(a1ef9787) SHA1(e498f84bea01f073a430d854b47306b7d35ffe08) )
...
S32X_ROM_LOAD( zaxxon2kp5, "zaxxon's motherbase 2000(prototype - mar 06, 1995).bin",                           0x000000, 0x200000,   CRC(90692a18) SHA1(67afaca4956df2120f62259b1147feaad6098a53) )
S32X_ROM_LOAD( zaxxon2kp6, "zaxxon's motherbase 2000(prototype - mar 10, 1995).bin",                           0x000000, 0x200000,   CRC(20faf0c3) SHA1(df6898e46cba85541bc7f92090bfcf7000c0e648) )
S32X_ROM_LOAD( zaxxon2kp7, "zaxxon's motherbase 2000(prototype - mar 15, 1995).bin",                           0x000000, 0x200000,   CRC(adfd5bc6) SHA1(ed9d3414edc90b7fb6a23732038f5c57710de9d3) )
S32X_ROM_LOAD( zaxxon2kp8, "zaxxon's motherbase 2000(prototype - mar 31, 1995).bin",                           0x000000, 0x200000,   CRC(1344f08b) SHA1(ed3b31494407f324f18db4f5056ad6df75dc1a10) )
...
SOFTWARE_LIST_START( _32x_cart )
	...
	SOFTWARE( 36greatp,  36great, 1994, "Sega", "36 Great Holes starring Fred Couples (v1.x Prototype, 19940706)", 0, 0 )
	...
	SOFTWARE( 36great10, 36great, 1994, "Sega", "36 Great Holes starring Fred Couples (Prototype, 19941103)", 0, 0 )
	SOFTWARE( 36great11, 36great, 1994, "Sega", "36 Great Holes starring Fred Couples (Prototype, 19941105)", 0, 0 )
	SOFTWARE( 36great12, 36great, 1994, "Sega", "36 Great Holes starring Fred Couples (Prototype, 19941107)", 0, 0 ) // this is the earliest set that doesn't just crash it
	SOFTWARE( 36great13, 36great, 1994, "Sega", "36 Great Holes starring Fred Couples (Prototype, 19941108)", 0, 0 )
	SOFTWARE( 36great14, 36great, 1994, "Sega", "36 Great Holes starring Fred Couples (Prototype, 19941110)", 0, 0 )
	SOFTWARE( 36great15, 36great, 1994, "Sega", "36 Great Holes starring Fred Couples (Prototype, 19941116)", 0, 0 )
	SOFTWARE( 36great16, 36great, 1994, "Sega", "36 Great Holes starring Fred Couples (Prototype, 19941118)", 0, 0 )
	SOFTWARE( 36great17, 36great, 1994, "Sega", "36 Great Holes starring Fred Couples (Prototype, 19941119-B)", 0, 0 )
	SOFTWARE( 36great18, 36great, 1994, "Sega", "36 Great Holes starring Fred Couples (Prototype, 19941119)", 0, 0 )
	SOFTWARE( 36great19, 36great, 1994, "Sega", "36 Great Holes starring Fred Couples (Prototype, 19941121)", 0, 0 )
	SOFTWARE( 36great20, 36great, 1994, "Sega", "36 Great Holes starring Fred Couples (Prototype, 19941122-B)", 0, 0 )
	SOFTWARE( 36great21, 36great, 1994, "Sega", "36 Great Holes starring Fred Couples (Prototype, 19941122)", 0, 0 )
	SOFTWARE( 36great22, 36great, 1994, "Sega", "36 Great Holes starring Fred Couples (Prototype, 19941123)", 0, 0 )
	SOFTWARE( 36great23, 36great, 1994, "Sega", "36 Great Holes starring Fred Couples (Prototype, 19941126)", 0, 0 )
	SOFTWARE( 36great24, 36great, 1994, "Sega", "36 Great Holes starring Fred Couples (Prototype, 19941127)", 0, 0 )
	SOFTWARE( 36great25, 36great, 1994, "Sega", "36 Great Holes starring Fred Couples (Prototype, 19941128-B)", 0, 0 )
	SOFTWARE( 36great26, 36great, 1994, "Sega", "36 Great Holes starring Fred Couples (Prototype, 19941128)", 0, 0 )
	SOFTWARE( 36great27, 36great, 1994, "Sega", "36 Great Holes starring Fred Couples (Prototype, 19941129)", 0, 0 )
	SOFTWARE( 36great28, 36great, 1994, "Sega", "36 Great Holes starring Fred Couples (Prototype, 19941130)", 0, 0 )
	SOFTWARE( 36great29, 36great, 1994, "Sega", "36 Great Holes starring Fred Couples (Prototype, 19941011)", 0, 0 )
	SOFTWARE( 36great30, 36great, 1994, "Sega", "36 Great Holes starring Fred Couples (Prototype, 19941017)", 0, 0 )
	SOFTWARE( 36great31, 36great, 1994, "Sega", "36 Great Holes starring Fred Couples (Prototype, 19941018)", 0, 0 )
	SOFTWARE( 36great32, 36great, 1994, "Sega", "36 Great Holes starring Fred Couples (Prototype, 19941024)", 0, 0 )
	SOFTWARE( 36great33, 36great, 1994, "Sega", "36 Great Holes starring Fred Couples (Prototype, 19941026)", 0, 0 )
	...
	SOFTWARE( shadsqp1, stellar,   1995, "Sega", "Shadow Squadron (Prototype, 19950206)", 0, 0 )
	SOFTWARE( shadsqp2, stellar,   1995, "Sega", "Shadow Squadron (Prototype, 19950213)", 0, 0 )
	SOFTWARE( shadsqp3, stellar,   1995, "Sega", "Shadow Squadron (Prototype, 19950222)", 0, 0 )
	SOFTWARE( shadsqp4, stellar,   1995, "Sega", "Shadow Squadron (Prototype, 19950302)", 0, 0 )
	SOFTWARE( shadsqp5, stellar,   1995, "Sega", "Shadow Squadron (Prototype, 19950306)", 0, 0 )
	SOFTWARE( shadsqp6, stellar,   1995, "Sega", "Shadow Squadron (Prototype, 19950313-B)", 0, 0 )
	SOFTWARE( shadsqp7, stellar,   1995, "Sega", "Shadow Squadron (Prototype, 19950313)", 0, 0 )
	...
	SOFTWARE( vrdxp,   vrdx,    1994, "Sega", "Virtua Racing Deluxe (Prototype, 19940822)", 0, 0 )
	SOFTWARE( vrdxp1,  vrdx,    1994, "Sega", "Virtua Racing Deluxe (Prototype, 19940829)", 0, 0 )
	SOFTWARE( vrdxp2,  vrdx,    1994, "Sega", "Virtua Racing Deluxe (Prototype, 19940905)", 0, 0 )
	...
	SOFTWARE( zaxxon2kp,  zaxxon2k,   1995, "Sega", "Zaxxon's Motherbase 2000 (Prototype, 19950210)", 0, 0 )
	SOFTWARE( zaxxon2kp1, zaxxon2k,   1995, "Sega", "Zaxxon's Motherbase 2000 (Prototype, 19950221)", 0, 0 )
	SOFTWARE( zaxxon2kp2, zaxxon2k,   1995, "Sega", "Zaxxon's Motherbase 2000 (Prototype, 19950223)", 0, 0 )
	SOFTWARE( zaxxon2kp3, zaxxon2k,   1995, "Sega", "Zaxxon's Motherbase 2000 (Prototype, 19950227)", 0, 0 )
	SOFTWARE( zaxxon2kp4, zaxxon2k,   1995, "Sega", "Zaxxon's Motherbase 2000 (Prototype, 19950303)", 0, 0 )
	SOFTWARE( zaxxon2kp5, zaxxon2k,   1995, "Sega", "Zaxxon's Motherbase 2000 (Prototype, 19950306)", 0, 0 )
	SOFTWARE( zaxxon2kp6, zaxxon2k,   1995, "Sega", "Zaxxon's Motherbase 2000 (Prototype, 19950310)", 0, 0 )
	SOFTWARE( zaxxon2kp7, zaxxon2k,   1995, "Sega", "Zaxxon's Motherbase 2000 (Prototype, 19950315)", 0, 0 )
	SOFTWARE( zaxxon2kp8, zaxxon2k,   1995, "Sega", "Zaxxon's Motherbase 2000 (Prototype, 19950331)", 0, 0 )
