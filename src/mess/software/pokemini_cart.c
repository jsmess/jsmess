...
SOFTWARE_LIST_START( pokemini_cart )
	...
	SOFTWARE( pokeacrd,  pokezcrd, 2001, "Nintendo", "Pokémon Anime Card Daisakusen (Jpn)", 0, 0 )
	SOFTWARE( pparty,    0,        2001, "Nintendo", "Pokémon Party Mini (Euro)", 0, 0 )
	SOFTWARE( ppartyu,   pparty,   2001, "Nintendo", "Pokémon Party Mini (USA)", 0, 0 )
	SOFTWARE( pptbasej,  0,        2001, "Nintendo", "Pokémon Party Mini - Baseline Judge (Euro, GameCube)", 0, 0 )
	SOFTWARE( pptbasejj, pptbasej, 2001, "Nintendo", "Pokémon Party Mini - Baseline Judge (Jpn, GameCube)", 0, 0 )
	SOFTWARE( pptbaseju, pptbasej, 2001, "Nintendo", "Pokémon Party Mini - Baseline Judge (USA, GameCube)", 0, 0 )
	SOFTWARE( pptdribl,  0,        2001, "Nintendo", "Pokémon Party Mini - Chansey's Dribble (Euro, GameCube)", 0, 0 )
	SOFTWARE( pptrocks,  0,        2001, "Nintendo", "Pokémon Party Mini - Pikachu's Rocket Start (Euro, GameCube)", 0, 0 )
	SOFTWARE( pptdriblj, pptdribl, 2001, "Nintendo", "Pokémon Party Mini - Ricochet Dribble (Jpn, GameCube)", 0, 0 )
	SOFTWARE( pptdriblu, pptdribl, 2001, "Nintendo", "Pokémon Party Mini - Ricochet Dribble (USA, GameCube)", 0, 0 )
	SOFTWARE( pptrocksu, pptrocks, 2001, "Nintendo", "Pokémon Party Mini - Rocket Start (USA, GameCube)", 0, 0 )
	SOFTWARE( pptslowj,  0,        2001, "Nintendo", "Pokémon Party Mini - Slowking's Judge (Euro, GameCube)", 0, 0 )
	SOFTWARE( ppinbjp,   ppinb,    2001, "Nintendo", "Pokémon Pinball Mini (Jpn, Preview)", 0, 0 )
	SOFTWARE( ppinbj,    ppinb,    2001, "Nintendo", "Pokémon Pinball Mini (Jpn)", 0, 0 )
	SOFTWARE( ppinbp,    ppinb,    2001, "Nintendo", "Pokémon Pinball Mini (USA, GameCube Preview)", 0, 0 )
	SOFTWARE( ppinb,     0,        2001, "Nintendo", "Pokémon Pinball Mini (USA)", 0, 0 )
	SOFTWARE( ppuzzlcfp, ppuzzlc,  2001, "Nintendo", "Pokémon Puzzle Collection (France, GameCube Preview)", 0, 0 )
	SOFTWARE( ppuzzlcgp, ppuzzlc,  2001, "Nintendo", "Pokémon Puzzle Collection (Germany, GameCube Preview)", 0, 0 )
	SOFTWARE( ppuzzlcg,  ppuzzlc,  2001, "Nintendo", "Pokémon Puzzle Collection (Germany)", 0, 0 )
	SOFTWARE( ppuzzlcj1, ppuzzlc,  2001, "Nintendo", "Pokémon Puzzle Collection (Jpn, GameCube)", 0, 0 )
	SOFTWARE( ppuzzlcj,  ppuzzlc,  2001, "Nintendo", "Pokémon Puzzle Collection (Jpn)", 0, 0 )
	SOFTWARE( ppuzzlcp,  ppuzzlc,  2001, "Nintendo", "Pokémon Puzzle Collection (USA, GameCube Preview)", 0, 0 )
	SOFTWARE( ppuzzlc,   0,        2001, "Nintendo", "Pokémon Puzzle Collection (USA)", 0, 0 )
	SOFTWARE( ppuzzlc2,  0,        2002, "Nintendo", "Pokémon Puzzle Collection Vol. 2 (Jpn)", 0, 0 )
	SOFTWARE( pokeracep, pokerace, 2002, "Nintendo", "Pokémon Race Mini (Jpn, Preview)", 0, 0 )
	SOFTWARE( pokerace,  0,        2002, "Nintendo", "Pokémon Race Mini (Jpn)", 0, 0 )
	SOFTWARE( ptetrisj,  ptetris,  2002, "Nintendo", "Pokémon Shock Tetris (Jpn)", 0, 0 )
	SOFTWARE( pokesoda,  0,        2002, "Nintendo", "Pokémon Sodateyasan Mini (Jpn)", 0, 0 )
	SOFTWARE( ptetris,   0,        2002, "Nintendo", "Pokémon Tetris (Euro)", 0, 0 )
	SOFTWARE( pokezcrd,  0,        2001, "Nintendo", "Pokémon Zany Cards (France)", 0, 0 )
	SOFTWARE( pokezcrdg, pokezcrd, 2001, "Nintendo", "Pokémon Zany Cards (Germany)", 0, 0 )
