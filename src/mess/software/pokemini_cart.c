...
SOFTWARE_LIST_START( pokemini_cart )
	SOFTWARE( lunchtme,  0,        19??, "<unknown>", "Lunch Time (USA) (GameCube)", 0, 0 )
	SOFTWARE( pichubro,  0,        19??, "<unknown>", "Pichu Bros. Mini (Japan)", 0, 0 )
	SOFTWARE( pichuhop,  0,        19??, "<unknown>", "Pichu Bros. Mini - Hoppip's Jump Match (Japan) (Preview)", 0, 0 )
	SOFTWARE( pichunts,  0,        19??, "<unknown>", "Pichu Bros. Mini - Netsukikyuu (Japan) (Preview)", 0, 0 )
	SOFTWARE( pichuskt,  0,        19??, "<unknown>", "Pichu Bros. Mini - Skateboard (Japan) (Preview)", 0, 0 )
	SOFTWARE( pokeacrd,  pokezcrd, 19??, "<unknown>", "Pokemon Anime Card Daisakusen (Japan)", 0, 0 )
	SOFTWARE( pparty,    0,        19??, "<unknown>", "Pokemon Party Mini (Europe)", 0, 0 )
	SOFTWARE( ppartyu,   pparty,   19??, "<unknown>", "Pokemon Party Mini (USA)", 0, 0 )
	SOFTWARE( pptbasej,  0,        19??, "<unknown>", "Pokemon Party Mini - Baseline Judge (Europe) (GameCube)", 0, 0 )
	SOFTWARE( pptbasejj, pptbasej, 19??, "<unknown>", "Pokemon Party Mini - Baseline Judge (Japan) (GameCube)", 0, 0 )
	SOFTWARE( pptbaseju, pptbasej, 19??, "<unknown>", "Pokemon Party Mini - Baseline Judge (USA) (GameCube)", 0, 0 )
	SOFTWARE( pptdribl,  0,        19??, "<unknown>", "Pokemon Party Mini - Chansey's Dribble (Europe) (GameCube)", 0, 0 )
	SOFTWARE( pptrocks,  0,        19??, "<unknown>", "Pokemon Party Mini - Pikachu's Rocket Start (Europe) (GameCube)", 0, 0 )
	SOFTWARE( pptdriblj, pptdribl, 19??, "<unknown>", "Pokemon Party Mini - Ricochet Dribble (Japan) (GameCube)", 0, 0 )
	SOFTWARE( pptdriblu, pptdribl, 19??, "<unknown>", "Pokemon Party Mini - Ricochet Dribble (USA) (GameCube)", 0, 0 )
	SOFTWARE( pptrocksu, pptrocks, 19??, "<unknown>", "Pokemon Party Mini - Rocket Start (USA) (GameCube)", 0, 0 )
	SOFTWARE( pptslowj,  0,        19??, "<unknown>", "Pokemon Party Mini - Slowking's Judge (Europe) (GameCube)", 0, 0 )
	SOFTWARE( ppinbjp,   ppinb,    19??, "<unknown>", "Pokemon Pinball Mini (Japan) (Preview)", 0, 0 )
	SOFTWARE( ppinbj,    ppinb,    19??, "<unknown>", "Pokemon Pinball Mini (Japan)", 0, 0 )
	SOFTWARE( ppinbp,    ppinb,    19??, "<unknown>", "Pokemon Pinball Mini (USA) (GameCube Preview)", 0, 0 )
	SOFTWARE( ppinb,     0,        19??, "<unknown>", "Pokemon Pinball Mini (USA)", 0, 0 )
	SOFTWARE( ppuzzlcfp, ppuzzlc,  19??, "<unknown>", "Pokemon Puzzle Collection (France) (GameCube Preview)", 0, 0 )
	SOFTWARE( ppuzzlcgp, ppuzzlc,  19??, "<unknown>", "Pokemon Puzzle Collection (Germany) (GameCube Preview)", 0, 0 )
	SOFTWARE( ppuzzlcg,  ppuzzlc,  19??, "<unknown>", "Pokemon Puzzle Collection (Germany)", 0, 0 )
	SOFTWARE( ppuzzlcj1, ppuzzlc,  19??, "<unknown>", "Pokemon Puzzle Collection (Japan) (GameCube)", 0, 0 )
	SOFTWARE( ppuzzlcj,  ppuzzlc,  19??, "<unknown>", "Pokemon Puzzle Collection (Japan)", 0, 0 )
	SOFTWARE( ppuzzlcp,  ppuzzlc,  19??, "<unknown>", "Pokemon Puzzle Collection (USA) (GameCube Preview)", 0, 0 )
	SOFTWARE( ppuzzlc,   0,        19??, "<unknown>", "Pokemon Puzzle Collection (USA)", 0, 0 )
	SOFTWARE( ppuzzlc2,  0,        19??, "<unknown>", "Pokemon Puzzle Collection Vol. 2 (Japan)", 0, 0 )
	SOFTWARE( pokeracep, pokerace, 19??, "<unknown>", "Pokemon Race Mini (Japan) (Preview)", 0, 0 )
	SOFTWARE( pokerace,  0,        19??, "<unknown>", "Pokemon Race Mini (Japan)", 0, 0 )
	SOFTWARE( ptetrisj,  ptetris,  19??, "<unknown>", "Pokemon Shock Tetris (Japan)", 0, 0 )
	SOFTWARE( pokesoda,  0,        19??, "<unknown>", "Pokemon Sodateyasan Mini (Japan)", 0, 0 )
	SOFTWARE( ptetris,   0,        19??, "<unknown>", "Pokemon Tetris (Europe) (En,Ja,Fr)", 0, 0 )
	SOFTWARE( pokezcrd,  0,        19??, "<unknown>", "Pokemon Zany Cards (France)", 0, 0 )
	SOFTWARE( pokezcrdg, pokezcrd, 19??, "<unknown>", "Pokemon Zany Cards (Germany)", 0, 0 )
	SOFTWARE( snorlax,   0,        19??, "<unknown>", "Snorlax's Lunch Time (Europe) (GameCube)", 0, 0 )
	SOFTWARE( snorlaxj,  snorlax,  19??, "<unknown>", "Snorlax's Lunch Time (Japan) (GameCube)", 0, 0 )
	SOFTWARE( togepip,   togepi,   19??, "<unknown>", "Togepi no Daibouken (Japan) (Preview)", 0, 0 )
	SOFTWARE( togepi,    0,        19??, "<unknown>", "Togepi no Daibouken (Japan)", 0, 0 )
SOFTWARE_LIST_END
