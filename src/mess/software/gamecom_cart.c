...
SOFTWARE_LIST_START( gamecom_cart )
	SOFTWARE( batmanr,  0       , 1997, "Tiger Electronics", "Batman & Robin", 0, 0 )
	SOFTWARE( centiped, 0       , 1999, "Tiger Electronics", "Centipede", 0, 0 )
	SOFTWARE( dukenuke, 0       , 1997, "Tiger Electronics", "Duke Nukem 3D", 0, 0 )
	SOFTWARE( fightmix, 0       , 1998, "Tiger Electronics", "Fighters Megamix", 0, 0 )
	SOFTWARE( frogger,  0       , 1999, "Tiger Electronics", "Frogger", 0, 0 )
	SOFTWARE( henry,    0       , 1997, "Tiger Electronics", "Henry", 0, 0 )
	SOFTWARE( indy500,  0       , 1997, "Tiger Electronics", "Indy 500", 0, 0 )
	SOFTWARE( jeopardy, 0       , 1997, "Tiger Electronics", "Jeopardy!", 0, 0 )
	SOFTWARE( lightout, 0       , 1997, "Tiger Electronics", "Lights Out", 0, 0 )
	SOFTWARE( lostwrld, 0       , 1997, "Tiger Electronics", "Lost World, The - Jurassic Park", 0, 0 )
	SOFTWARE( monopoly, 0       , 1999, "Tiger Electronics", "Monopoly", 0, 0 )
	SOFTWARE( mktrilgy, 0       , 1997, "Tiger Electronics", "Mortal Kombat Trilogy", 0, 0 )
	SOFTWARE( quizwiz,  0       , 1997, "Tiger Electronics", "Quiz Wiz - Cyber Trivia", 0, 0 )
	SOFTWARE( re2,      0       , 1998, "Tiger Electronics", "Resident Evil 2", 0, 0 )
	SOFTWARE( scrabble, 0       , 1999, "Tiger Electronics", "Scrabble", 0, 0 )
	SOFTWARE( sonicjam, 0       , 1998, "Tiger Electronics", "Sonic Jam", 0, 0 )
	SOFTWARE( tcasino,  0       , 1998, "Tiger Electronics", "Tiger Casino", 0, 0 )
	SOFTWARE( wheelfor, 0       , 1997, "Tiger Electronics", "Wheel of Fortune", 0, 0 )
	SOFTWARE( wheelfo2, 0       , 1998, "Tiger Electronics", "Wheel of Fortune 2", 0, 0 )
	SOFTWARE( arcadecl, 0       , 1997, "Tiger Electronics", "Williams Arcade Classics", 0, 0 )
SOFTWARE_LIST_END
