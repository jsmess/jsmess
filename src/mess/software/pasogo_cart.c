...
SOFTWARE_LIST_START( pasogo_cart )
	SOFTWARE( imdaiikkan,   0,         1996, "Koei", "Igo Meikyokushuu - Dai Ikkan", 0, 0 )		/* KS-1004. Contains 4M SOP40 ROM only. */
	SOFTWARE( tntdikkan,   0,         1996, "Koei", "Tsuyoku Naru Tesuji - Dai Ikkan", 0, 0 )	/* KS-1009. Contains 4M SOP40 ROM only. */
