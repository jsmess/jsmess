...
CRVISION_ROM_LOAD( planetd1, "planet6k.bin",          0x000000,  0x1800,	 CRC(b8cb39f7) SHA1(a89c96ff084f2eb220fc626aaae479d4172b769b) )
CRVISION_ROM_LOAD( planetd,  "planet8k.bin",          0x000000,  0x2000,	 CRC(4457c7b3) SHA1(0be7935db55ecf3e70b96e071ecbc489bd22dc73) )
...
CRVISION_ROM_LOAD( astropi1, "astro pinball (asia, europe).rom",              0x000000,  0x2000,	 CRC(cf7bdfc2) SHA1(38bcc856d604567dc6453205a8f858bdf2000330) )
CRVISION_ROM_LOAD( chopper2, "chopper rescue (asia, europe) (alt).rom",       0x000000,  0x4800,	 CRC(48e7e8b8) SHA1(037088f15830fdd43081edddc5d683318d67ee01) )
CRVISION_ROM_LOAD( chopper1, "chopper rescue (asia, europe).rom",             0x000000,  0x4800,	 CRC(14179570) SHA1(fde339c8dbd44b3332e888cd24d3d492cf066b94) )
CRVISION_ROM_LOAD( hapmon,   "hapmon (asia, europe).rom",                     0x000000,  0x1000,	 CRC(15d07b96) SHA1(89359dca952bc90644dfd7f546c184a8165faa14) )
CRVISION_ROM_LOAD( planetd2, "planet defender (asia, europe).rom",            0x000000,  0x2000,	 CRC(4b463c18) SHA1(1fd80a3921f2487d9eee2b6d8bb3955d22857d0e) )
...
SOFTWARE_LIST_START( crvision_cart )
	...
	SOFTWARE( planetd1, planetd,  1981, "<unknown>", "Planet Defender (6k cart)", 0, 0 )	/* Id: 8005 */
	SOFTWARE( planetd,  0,        1981, "<unknown>", "Planet Defender (8k cart)", 0, 0 )	/* Id: 8005 */
	...
	SOFTWARE( astropi1, astropi,  19??, "<unknown>", "Astro Pinball (Alt)", 0, 0 )
	...
	SOFTWARE( planetd2, planetd,  19??, "<unknown>", "Planet Defender (Alt)", 0, 0 )
SOFTWARE_LIST_END
