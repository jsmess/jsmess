...
SOFTWARE_LIST_START( svision_cart )
	SOFTWARE( 2in1,     0,        19??, "<unknown>", "2 in 1 - Block Buster + Cross High (USA, Europe)", 0, 0 )
	SOFTWARE( 2in1a,    0,        19??, "<unknown>", "2 in 1 - Hash Blocks + Eagle Plan (USA, Europe)", 0, 0 )
	SOFTWARE( alien,    0,        19??, "<unknown>", "Alien (USA, Europe)", 0, 0 )
	SOFTWARE( balloonf, 0,        19??, "<unknown>", "Balloon Fight (USA, Europe)", 0, 0 )
	SOFTWARE( blockbus, 0,        19??, "<unknown>", "Block Buster (USA, Europe)", 0, 0 )
	SOFTWARE( brainpow, 0,        19??, "<unknown>", "Brain Power (USA, Europe)", 0, 0 )
	SOFTWARE( carrier1, carrier,  19??, "<unknown>", "Carrier (199x) (Travellmate) [o1].bin", 0, 0 )
	SOFTWARE( carrier,  0,        19??, "<unknown>", "Carrier (USA, Europe)", 0, 0 )
	SOFTWARE( cavewond, 0,        19??, "<unknown>", "Cave Wonders (USA, Europe)", 0, 0 )
	SOFTWARE( challtnk, 0,        19??, "<unknown>", "Challenger Tank (USA, Europe)", 0, 0 )
	SOFTWARE( chimera,  0,        19??, "<unknown>", "Chimera (USA, Europe)", 0, 0 )
	SOFTWARE( crystbal, 0,        19??, "<unknown>", "Crystball (USA, Europe)", 0, 0 )
	SOFTWARE( dhero,    0,        19??, "<unknown>", "Delta Hero (USA, Europe)", 0, 0 )
	SOFTWARE( eaglplan, 0,        19??, "<unknown>", "Eagle Plan (USA, Europe)", 0, 0 )
	SOFTWARE( earthdef, 0,        19??, "<unknown>", "Earth Defender (USA, Europe)", 0, 0 )
	SOFTWARE( fatcraft, 0,        19??, "<unknown>", "Fatal Craft (USA, Europe)", 0, 0 )
	SOFTWARE( fcombat,  0,        19??, "<unknown>", "Final Combat (USA, Europe)", 0, 0 )
	SOFTWARE( galactic, 0,        19??, "<unknown>", "Galactic Crusader (USA, Europe)", 0, 0 )
	SOFTWARE( galaxy,   0,        19??, "<unknown>", "Galaxy Fighter (USA, Europe)", 0, 0 )
	SOFTWARE( gp,       0,        19??, "<unknown>", "Grand Prix (USA, Europe)", 0, 0 )
	SOFTWARE( happyp,   0,        19??, "<unknown>", "Happy Pairs (USA, Europe)", 0, 0 )
	SOFTWARE( hashbloc, 0,        19??, "<unknown>", "Hash Blocks (USA, Europe)", 0, 0 )
	SOFTWARE( herokid,  0,        19??, "<unknown>", "Hero Kid (USA, Europe)", 0, 0 )
	SOFTWARE( honeybee, 0,        19??, "<unknown>", "Honey Bee (USA, Europe)", 0, 0 )
	SOFTWARE( jackyluc, 0,        19??, "<unknown>", "Jacky Lucky (USA, Europe)", 0, 0 )
	SOFTWARE( jagbombr, 0,        19??, "<unknown>", "Jaguar Bomber (USA, Europe)", 0, 0 )
	SOFTWARE( johnadv,  0,        19??, "<unknown>", "John Adventure (USA, Europe)", 0, 0 )
	SOFTWARE( juggler,  0,        19??, "<unknown>", "Juggler (USA, Europe)", 0, 0 )
	SOFTWARE( kabiisl,  0,        19??, "<unknown>", "Kabi Island - Gold in Island (USA, Europe)", 0, 0 )
	SOFTWARE( linear,   0,        19??, "<unknown>", "Linear Racing (USA, Europe)", 0, 0 )
	SOFTWARE( maginx,   0,        19??, "<unknown>", "Magincross (USA, Europe)", 0, 0 )
	SOFTWARE( mattablt, 0,        19??, "<unknown>", "Matta Blatta (USA, Europe)", 0, 0 )
	SOFTWARE( olympict, 0,        19??, "<unknown>", "Olympic Trials (USA, Europe)", 0, 0 )
	SOFTWARE( p52sea,   0,        19??, "<unknown>", "P-52 Sea Battle (USA, Europe)", 0, 0 )
	SOFTWARE( pacboy,   0,        19??, "<unknown>", "PacBoy & Mouse (USA, Europe)", 0, 0 )
	SOFTWARE( penguin1, penguinh, 19??, "<unknown>", "Penguin Hideout (1992) (Thin Chen Enterprise) [o1].bin", 0, 0 )
	SOFTWARE( penguinh, 0,        19??, "<unknown>", "Penguin Hideout (USA, Europe)", 0, 0 )
	SOFTWARE( policebu, 0,        19??, "<unknown>", "Police Bust (USA, Europe)", 0, 0 )
	SOFTWARE( pyramid,  0,        19??, "<unknown>", "Pyramid (USA, Europe)", 0, 0 )
	SOFTWARE( soccerch, 0,        19??, "<unknown>", "Soccer Champion (USA, Europe)", 0, 0 )
	SOFTWARE( sssnake,  0,        19??, "<unknown>", "SSSnake (USA, Europe)", 0, 0 )
	SOFTWARE( sblock1,  sblock,   19??, "<unknown>", "Super Block (1992) (Bon Treasure) [o1].bin", 0, 0 )
	SOFTWARE( sblock,   0,        19??, "<unknown>", "Super Block (USA, Europe)", 0, 0 )
	SOFTWARE( skong,    0,        19??, "<unknown>", "Super Kong (USA, Europe)", 0, 0 )
	SOFTWARE( tasac,    0,        19??, "<unknown>", "Tasac 2010 (USA, Europe)", 0, 0 )
	SOFTWARE( tennis92, 0,        19??, "<unknown>", "Tennis Pro '92 (USA, Europe)", 0, 0 )
	SOFTWARE( treasure, 0,        19??, "<unknown>", "Treasure Hunter (USA, Europe)", 0, 0 )
SOFTWARE_LIST_END
