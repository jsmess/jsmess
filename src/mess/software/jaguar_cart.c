...
JAGUAR_ROM_LOAD( troyaikm,  "troy aikman nfl football (world).j64",                                                      0x000000 , 0x200000,	 CRC(38a130ed) SHA1(4c6a6432ea0bc198f900f4ebdb8a3a7a34475d84) )
...
JAGUAR_ROM_LOAD( wolfst3d,  "wolfenstein 3d (world).j64",                                                                0x000000 , 0x200000,	 CRC(e91bd644) SHA1(ee553176f0a32683b517b84b12c6fae13c15c3d0) )
...
SOFTWARE_LIST_START( jaguar_cart )
	SOFTWARE( aircars,   0,        199?, "Atari License", "Air Cars (World)", 0, 0 )
	SOFTWARE( avsp,      0,        199?, "Atari License", "Alien vs Predator (World)", 0, 0 )
	SOFTWARE( atarikar,  0,        199?, "Atari License", "Atari Karts (World)", 0, 0 )
	SOFTWARE( mutntpng,  0,        199?, "Atari License", "Attack of the Mutant Penguins (World)", 0, 0 )
	SOFTWARE( battlesp,  0,        199?, "Atari License", "Battle Sphere Gold (World)", 0, 0 )
	SOFTWARE( brutalsp,  0,        199?, "Atari License", "Brutal Sports Football (World)", 0, 0 )
	SOFTWARE( bubsy,     0,        199?, "Atari License", "Bubsy in Fractured Furry Tales (World)", 0, 0 )
	SOFTWARE( cfodder,   0,        199?, "Atari License", "Cannon Fodder (World)", 0, 0 )
	SOFTWARE( chekflag,  0,        199?, "Atari License", "Checkered Flag (World)", 0, 0 )
	SOFTWARE( clubdriv,  0,        199?, "Atari License", "Club Drive (World)", 0, 0 )
	SOFTWARE( cybermor1, cybermor, 199?, "Atari License", "Cybermorph (World) (Rev 1)", 0, 0 )
	SOFTWARE( cybermor,  0,        199?, "Atari License", "Cybermorph (World) (Rev 2)", 0, 0 )
	SOFTWARE( defender,  0,        199?, "Atari License", "Defender 2000 (World)", 0, 0 )
	SOFTWARE( doom,      0,        199?, "Atari License", "Doom (World)", 0, 0 )
	SOFTWARE( ddragon5,  0,        199?, "Atari License", "Double Dragon V - The Shadow Falls (World)", 0, 0 )
	SOFTWARE( dragon,    0,        199?, "Atari License", "Dragon - The Bruce Lee Story (World)", 0, 0 )
	SOFTWARE( dinodude,  0,        199?, "Atari License", "Evolution - Dino Dudes (World)", 0, 0 )
	SOFTWARE( feverpit,  0,        199?, "Atari License", "Fever Pitch Soccer (World) (En,Fr,De,Es,It)", 0, 0 )
	SOFTWARE( fforlife1, fforlife, 199?, "Atari License", "Fight for Life (World) (Alt)", 0, 0 )
	SOFTWARE( fforlife,  0,        199?, "Atari License", "Fight for Life (World)", 0, 0 )
	SOFTWARE( flashbck,  0,        199?, "Atari License", "Flashback - The Quest for Identity (World) (En,Fr)", 0, 0 )
	SOFTWARE( flipout,   0,        199?, "Atari License", "Flip Out! (World)", 0, 0 )
	SOFTWARE( hstrike,   0,        199?, "Atari License", "Hover Strike (World)", 0, 0 )
	SOFTWARE( hyperfor,  0,        199?, "Atari License", "Hyper Force (World)", 0, 0 )
	SOFTWARE( iwar,      0,        199?, "Atari License", "I-War (World)", 0, 0 )
	SOFTWARE( ironsold,  0,        199?, "Atari License", "Iron Soldier (World) (v1.04)", 0, 0 )
	SOFTWARE( ironsol2,  0,        199?, "Atari License", "Iron Soldier 2 (World)", 0, 0 )
	SOFTWARE( kasumi,    0,        199?, "Atari License", "Kasumi Ninja (World)", 0, 0 )
	SOFTWARE( missilec,  0,        199?, "Atari License", "Missile Command 3D (World)", 0, 0 )
	SOFTWARE( nbajamte,  0,        199?, "Atari License", "NBA Jam T.E. (World)", 0, 0 )
	SOFTWARE( pinballf,  0,        199?, "Atari License", "Pinball Fantasies (World)", 0, 0 )
	SOFTWARE( pitfall,   0,        199?, "Atari License", "Pitfall - The Mayan Adventure (World)", 0, 0 )
	SOFTWARE( pdrive,    0,        199?, "Atari License", "Power Drive Rally (World)", 0, 0 )
	SOFTWARE( protect,   0,        199?, "Atari License", "Protector - Special Edition (World)", 0, 0 )
	SOFTWARE( raiden,    0,        199?, "Atari License", "Raiden (World)", 0, 0 )
	SOFTWARE( rayman,    0,        199?, "Atari License", "Rayman (World)", 0, 0 )
	SOFTWARE( ruinerp,   0,        199?, "Atari License", "Ruiner Pinball (World)", 0, 0 )
	SOFTWARE( sensible,  0,        199?, "Atari License", "Sensible Soccer - International Edition (World)", 0, 0 )
	SOFTWARE( skyhamm,   0,        199?, "Atari License", "Skyhammer (World)", 0, 0 )
	SOFTWARE( soccerkd,  0,        199?, "Atari License", "Soccer Kid (World)", 0, 0 )
	SOFTWARE( spacewar,  0,        199?, "Atari License", "Space War 2000 (World)", 0, 0 )
	SOFTWARE( sburnout,  0,        199?, "Atari License", "Super Burnout (World)", 0, 0 )
	SOFTWARE( superx3d,  0,        199?, "Atari License", "SuperCross 3D (World)", 0, 0 )
	SOFTWARE( syndicat,  0,        199?, "Atari License", "Syndicate (World)", 0, 0 )
	SOFTWARE( tempst2k,  0,        199?, "Atari License", "Tempest 2000 (World)", 0, 0 )
	SOFTWARE( themeprk,  0,        199?, "Atari License", "Theme Park (World)", 0, 0 )
	SOFTWARE( totalcar,  0,        199?, "Atari License", "Total Carnage (World)", 0, 0 )
	SOFTWARE( towers2,   0,        199?, "Atari License", "Towers II (World)", 0, 0 )
	SOFTWARE( trevmcfr,  0,        199?, "Atari License", "Trevor McFur in the Crescent Galaxy (World)", 0, 0 )
	SOFTWARE( troyaikm,  0,        199?, "Atari License", "Troy Aikman NFL Football (World)", 0, 0 )
	SOFTWARE( ultravor1, ultravor, 199?, "Atari License", "Ultra Vortek (World) (v0.94) (Beta)", 0, 0 )
	SOFTWARE( ultravor,  0,        199?, "Atari License", "Ultra Vortek (World)", 0, 0 )
	SOFTWARE( valdiser,  0,        199?, "Atari License", "Val d'Isere Skiing and Snowboarding (World)", 0, 0 )
	SOFTWARE( whitemen,  0,        199?, "Atari License", "White Men Can't Jump (World)", 0, 0 )
	SOFTWARE( wolfst3d,  0,        199?, "Atari License", "Wolfenstein 3D (World)", 0, 0 )
	SOFTWARE( worms,     0,        199?, "Atari License", "Worms (World)", 0, 0 )
	SOFTWARE( zero5,     0,        199?, "Atari License", "Zero 5 (World)", 0, 0 )
	SOFTWARE( zool2,     0,        199?, "Atari License", "Zool 2 (World)", 0, 0 )
	SOFTWARE( zoop,      0,        199?, "Atari License", "Zoop! (World)", 0, 0 )
SOFTWARE_LIST_END
