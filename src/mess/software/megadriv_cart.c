...
MEGADRIVE_ROM_LOAD( decapatt, "decapattack (usa, europe, korea).bin",                                                    0x000000, 0x80000,   CRC(73dc0dd8) SHA1(9665f54a6149d71ea72db9c168755e62cb61649c) )
...
MEGADRIVE_ROM_LOAD( ecco, "ecco the dolphin (usa, europe, korea).bin",                                                   0x000000, 0x100000,  CRC(45547390) SHA1(2cad130f3118c189d39fd1d46c5c31a5060ce894) )
...
MEGADRIVE_ROM_LOAD( ghouls, "ghouls 'n ghosts (usa, europe, korea) (rev a).bin",                                         0x000000, 0xa0000,   CRC(4f2561d5) SHA1(aab6d20f01db51576b1d7cafab46e613dddf7f8a) )
...
MEGADRIVE_ROM_LOAD( nbajamte, "nba jam tournament edition (world) (v1.1).bin",                                           0x000000, 0x300000,  CRC(6e25ebf0) SHA1(0f5bb5d5352fe2ebe4b4051a1dd9b9fde4b505ab) )
...
MEGADRIVE_ROM_LOAD( psampras1, "mdstee 13.bin",                             0x000000, 0x100000,  CRC(aa8b19bc) SHA1(3f73dcabcdf0d781834fcc673533301b82f0e91b) )
...
MEGADRIVE_ROM_LOAD( quacksht, "quackshot starring donald duck / quackshot - guruzia ou no hihou (world) (v1.1).bin",     0x000000, 0x140000,  CRC(1801098b) SHA1(7b1bd16fb817cc5e2af238cebe8521aaca8f6195) )
// dump without mirrored data, needs proper dump

MEGADRIVE_ROM_LOAD( quacksht1, "quackshot starring donald duck / quackshot - guruzia ou no hihou (world) (v1.1) (alt).bin", 0x000000, 0x140000,   CRC(a5c946b3) SHA1(1b1421f57669e149ccced2d751a6de83ca941932) )
// dump contains mirrored data, needs proper dump
...
MEGADRIVE_ROM_LOAD( soniccmp1, "sonic compilation (europe) (earlier) (mpr-18203 / mpr-18204).bin",                       0x000000, 0x300000,  CRC(8c70b84e) SHA1(109e6d7b31d00fbdb9d4ecb304d4ea19e96c8607) )
...
SOFTWARE_LIST_START( megadriv_cart )
	...
	SOFTWARE( bloods, 0, 199?, "Sega License", "Bloodshot (Euro)", 0, 0 )
	...
	SOFTWARE( nbajamte, 0, 199?, "Sega License", "NBA Jam Tournament Edition (World, Rev. 01)", 0, 0 )
	...
	SOFTWARE( ncircb, ncirc, 199?, "Sega License", "Nightmare Circus (Brazil, Prototype)", 0, 0 )
	...
	SOFTWARE( quacksht, 0, 199?, "Sega License", "QuackShot Starring Donald Duck / QuackShot - Guruzia Ou no Hihou (World, Rev. 01)", 0, 0 )
	SOFTWARE( quacksht1, quacksht, 199?, "Sega License", "QuackShot Starring Donald Duck / QuackShot - Guruzia Ou no Hihou (World, v1.1)", 0, 0 )
	...
	SOFTWARE( darius2a, sagaia, 199?, "Sega License", "Darius II (Jpn, Alt)", 0, 0 )
