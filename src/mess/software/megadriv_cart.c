...
SOFTWARE_LIST_START( megadriv_cart )
	...
	SOFTWARE( 12inun, 0,        199?, "Sega License", "12-in-1 (Unl) [!]", NULL, 0, 0 )
	...
	SOFTWARE( 16zhan, 0,        199?, "Sega License", "16 Zhang Ma Jiang (China) (Unl)", NULL, 0, 0 )

	SOFTWARE( 3ninja, 0,        199?, "Sega License", "3 Ninjas Kick Back", REGION_U, 0, 0 )

	SOFTWARE( 3in1fl, 0,        199?, "Sega License", "3-in-1 Flashback - World Champ. Soccer - Tecmo World Cup 92 (Pirate)", NULL, 0, 0 )

	SOFTWARE( 3in1ro, 0,        199?, "Sega License", "3-in-1 Road Rash - Ms. Pac-Man - Block Out (Pirate)", NULL, 0, 0 )

	SOFTWARE( 4in1pb, 0,        199?, "Sega License", "4-in-1 (Pirate)", NULL, 0, 0 )
	...
	SOFTWARE( advbatrp1, advbatr, 199?, "Sega License", "The Adventures of Batman & Robin (Prototype - Apr 06, 1995)", NULL, 0, 0 )
	SOFTWARE( advbatrp2, advbatr, 199?, "Sega License", "The Adventures of Batman & Robin (Prototype - Apr 10, 1995)", NULL, 0, 0 )
	SOFTWARE( advbatrp3, advbatr, 199?, "Sega License", "The Adventures of Batman & Robin (Prototype - Apr 11, 1995)", NULL, 0, 0 )
	SOFTWARE( advbatrp4, advbatr, 199?, "Sega License", "The Adventures of Batman & Robin (Prototype - Apr 18, 1995)", NULL, 0, 0 )
	SOFTWARE( advbatrp5, advbatr, 199?, "Sega License", "The Adventures of Batman & Robin (Prototype - Apr 19, 1995)", NULL, 0, 0 )
	SOFTWARE( advbatrp6, advbatr, 199?, "Sega License", "The Adventures of Batman & Robin (Prototype - Apr 21, 1995)", NULL, 0, 0 )
	SOFTWARE( advbatrp7, advbatr, 199?, "Sega License", "The Adventures of Batman & Robin (Prototype - Apr 22, 1995)", NULL, 0, 0 )
	SOFTWARE( advbatrp8, advbatr, 199?, "Sega License", "The Adventures of Batman & Robin (Prototype - Apr 24, 1995)", NULL, 0, 0 )
	SOFTWARE( advbatrp9, advbatr, 199?, "Sega License", "The Adventures of Batman & Robin (Prototype - Apr 26, 1995)", NULL, 0, 0 )
	SOFTWARE( advbatp10, advbatr, 199?, "Sega License", "The Adventures of Batman & Robin (Prototype - Apr 27, 1995)", NULL, 0, 0 )
	SOFTWARE( advbatp11, advbatr, 199?, "Sega License", "The Adventures of Batman & Robin (Prototype - Apr 28, 1995)", NULL, 0, 0 )
	SOFTWARE( advbatp12, advbatr, 199?, "Sega License", "The Adventures of Batman & Robin (Prototype - May 01, 1995)", NULL, 0, 0 )
	...
	SOFTWARE( adveboy, 0,        199?, "Sega License", "Adventurous Boy - Mao Xian Xiao Zi (China) (Unl)", NULL, 0, 0 )

	SOFTWARE( aerothb, aeroth, 199?, "Sega License", "Aero the Acro-Bat (Beta)", NULL, 0, 0 )
	...
	SOFTWARE( aladdin2 , 0,        199?, "Sega License", "Aladdin II (Unl)", NULL, 0, 0 )
	...
	SOFTWARE( ootwb , anotherw, 199?, "Sega License", "Out of this World (Beta)", NULL, 0, 0 )

	SOFTWARE( aokioo, 0,        199?, "Sega License", "Aoki Ookami to Shiroki Meshika - Genchou Hishi", REGION_J, 0, 0 )

	SOFTWARE( aqrenk, 0,        199?, "Sega License", "Aq Renkan Awa (China) (Unl)", NULL, 0, 0 )
	...
	SOFTWARE( aofp, aof, 199?, "Sega License", "Art of Fighting (Prototype - Jul 11, 1994)", NULL, 0, 0 )
	...
	SOFTWARE( atptour1, atptour, 199?, "Sega License", "ATP Tour Championship Tennis (Prototype - Aug 02, 1994)", NULL, 0, 0 )
	SOFTWARE( atptour2, atptour, 199?, "Sega License", "ATP Tour Championship Tennis (Prototype - Aug 05, 1994)", NULL, 0, 0 )
	SOFTWARE( atptour3, atptour, 199?, "Sega License", "ATP Tour Championship Tennis (Prototype - Aug 08, 1994)", NULL, 0, 0 )
	SOFTWARE( atptour4, atptour, 199?, "Sega License", "ATP Tour Championship Tennis (Prototype - Jul 19, 1994)", NULL, 0, 0 )
	SOFTWARE( atptour5, atptour, 199?, "Sega License", "ATP Tour Championship Tennis (Prototype - Jul 23, 1994)", NULL, 0, 0 )
	SOFTWARE( atptour6, atptour, 199?, "Sega License", "ATP Tour Championship Tennis (Prototype - Jul 25, 1994)", NULL, 0, 0 )
	SOFTWARE( atptour7, atptour, 199?, "Sega License", "ATP Tour Championship Tennis (Prototype - May 09, 1994)", NULL, 0, 0 )
	SOFTWARE( atptour8, atptour, 199?, "Sega License", "ATP Tour Championship Tennis (Prototype - Sep 08, 1994)", NULL, 0, 0 )
	...
	SOFTWARE( babyboom, 0,        199?, "Sega License", "Baby Boom (Prototype - Aug 11, 1994)", NULL, 0, 0 )
	SOFTWARE( babyboom1, babyboom, 199?, "Sega License", "Baby Boom (Prototype - Jun 03, 1994)", NULL, 0, 0 )
	SOFTWARE( babyboom2, babyboom, 199?, "Sega License", "Baby Boom (Prototype - Jun 06, 1994)", NULL, 0, 0 )
	...
	SOFTWARE( barver, 0,        199?, "Sega License", "Barver Battle Saga - Tai Kong Zhan Shi (China) (Unl)", NULL, 0, 0 )
	...
	SOFTWARE( beren1, berens, 199?, "Sega License", "The Berenstain Bears' Camping Adventure (Prototype - Apr 28, 1994)", NULL, 0, 0 )
	SOFTWARE( beren2, berens, 199?, "Sega License", "The Berenstain Bears' Camping Adventure (Prototype - Apr 29, 1994)", NULL, 0, 0 )
	SOFTWARE( beren3, berens, 199?, "Sega License", "The Berenstain Bears' Camping Adventure (Prototype - Aug 01, 1994)", NULL, 0, 0 )
	SOFTWARE( beren4, berens, 199?, "Sega License", "The Berenstain Bears' Camping Adventure (Prototype - Aug 02, 1994)", NULL, 0, 0 )
	SOFTWARE( beren5, berens, 199?, "Sega License", "The Berenstain Bears' Camping Adventure (Prototype - Aug 03, 1994)", NULL, 0, 0 )
	SOFTWARE( beren6, berens, 199?, "Sega License", "The Berenstain Bears' Camping Adventure (Prototype - Aug 05, 1994)", NULL, 0, 0 )
	SOFTWARE( beren7, berens, 199?, "Sega License", "The Berenstain Bears' Camping Adventure (Prototype - Aug 08, 1994)", NULL, 0, 0 )
	SOFTWARE( beren8, berens, 199?, "Sega License", "The Berenstain Bears' Camping Adventure (Prototype - Jul 09, 1994)", NULL, 0, 0 )
	SOFTWARE( beren9, berens, 199?, "Sega License", "The Berenstain Bears' Camping Adventure (Prototype - Jul 16, 1994)", NULL, 0, 0 )
	SOFTWARE( bere10, berens, 199?, "Sega License", "The Berenstain Bears' Camping Adventure (Prototype - Jul 20, 1994)", NULL, 0, 0 )
	SOFTWARE( bere11, berens, 199?, "Sega License", "The Berenstain Bears' Camping Adventure (Prototype - Jun 02, 1994)", NULL, 0, 0 )
	SOFTWARE( bere12, berens, 199?, "Sega License", "The Berenstain Bears' Camping Adventure (Prototype - Jun 10, 1994)", NULL, 0, 0 )
	SOFTWARE( bere13, berens, 199?, "Sega License", "The Berenstain Bears' Camping Adventure (Prototype - Mar 23, 1994)", NULL, 0, 0 )
	SOFTWARE( bere14, berens, 199?, "Sega License", "The Berenstain Bears' Camping Adventure (Prototype - May 06, 1994)", NULL, 0, 0 )
	SOFTWARE( bere15, berens, 199?, "Sega License", "The Berenstain Bears' Camping Adventure (Prototype - May 11, 1994)", NULL, 0, 0 )
	SOFTWARE( bere16, berens, 199?, "Sega License", "The Berenstain Bears' Camping Adventure (Prototype - May 17, 1994)", NULL, 0, 0 )
	SOFTWARE( bere17, berens, 199?, "Sega License", "The Berenstain Bears' Camping Adventure (Prototype - May 19, 1994)", NULL, 0, 0 )
	SOFTWARE( bere18, berens, 199?, "Sega License", "The Berenstain Bears' Camping Adventure (Prototype - May 23, 1994)", NULL, 0, 0 )
	SOFTWARE( bere19, berens, 199?, "Sega License", "The Berenstain Bears' Camping Adventure (Prototype - May 26, 1994)", NULL, 0, 0 )
	SOFTWARE( bere20, berens, 199?, "Sega License", "The Berenstain Bears' Camping Adventure (Prototype - May 30, 1994)", NULL, 0, 0 )
	...
	SOFTWARE( bodycop, bodyco,  199?, "Sega License", "Body Count (Prototype - Feb 08, 1994)", NULL, 0, 0 )
	SOFTWARE( bodycop1, bodyco, 199?, "Sega License", "Body Count (Prototype - Feb 28, 1994 - U)", NULL, 0, 0 )
	SOFTWARE( bodycop2, bodyco, 199?, "Sega License", "Body Count (Prototype - Jan 27, 1994)", NULL, 0, 0 )
	SOFTWARE( bodycop3, bodyco, 199?, "Sega License", "Body Count (Prototype - Mar 03, 1994)", NULL, 0, 0 )
	SOFTWARE( bodycop4, bodyco, 199?, "Sega License", "Body Count (Prototype - Mar 08, 1994 - A)", NULL, 0, 0 )
	SOFTWARE( bodycop5, bodyco, 199?, "Sega License", "Body Count (Prototype - Mar 08, 1994)", NULL, 0, 0 )
	SOFTWARE( bodycop6, bodyco, 199?, "Sega License", "Body Count (Prototype - Mar 09, 1994)", NULL, 0, 0 )
	...
	SOFTWARE( bonkersp, bonkers, 199?, "Sega License", "Bonkers (Prototype - Mar 28, 1994)", NULL, 0, 0 )
	SOFTWARE( bonkersp1, bonkers, 199?, "Sega License", "Bonkers (Prototype - May 03, 1994)", NULL, 0, 0 )
	SOFTWARE( bonkersp2, bonkers, 199?, "Sega License", "Bonkers (Prototype - Oct 04, 1994)", NULL, 0, 0 )
	SOFTWARE( bonkersp3, bonkers, 199?, "Sega License", "Bonkers (Prototype - Oct 25, 1994)", NULL, 0, 0 )
	SOFTWARE( bonkersp4, bonkers, 199?, "Sega License", "Bonkers (Prototype - Oct 29, 1994)", NULL, 0, 0 )
	...
	SOFTWARE( bugslife, 0,        199?, "Sega License", "Bug's Life, A (Unl)", NULL, 0, 0 )
	...
	SOFTWARE( chaoji, 0,        199?, "Sega License", "Chao Ji Da Fu Weng (China) (Unl)", NULL, 0, 0 )
	...
	SOFTWARE( chess, 0,        199?, "Sega License", "Chess (Unl) [!]", NULL, 0, 0 )
	...
	SOFTWARE( chinesec, 0,        199?, "Sega License", "Chinese Chess (Unl)", NULL, 0, 0 )

	SOFTWARE( chinf3 , 0,        199?, "Sega License", "Chinese Fighter III (Unl)", NULL, 0, 0 )
	SOFTWARE( chinfb, chinf3 , 199?, "Sega License", "Chinese Fighter III (Unl) (bootleg)", NULL, 0, 0 )
	...
	SOFTWARE( cliffb, cliff , 199?, "Sega License", "Cliffhanger (Beta)", NULL, 0, 0 )
	...
	SOFTWARE( collncp, collnc, 199?, "Sega License", "College Football's National Championship (Prototype - Apr 13, 1994)", NULL, 0, 0 )
	SOFTWARE( collncp1, collnc, 199?, "Sega License", "College Football's National Championship (Prototype - Apr 18, 1994)", NULL, 0, 0 )
	SOFTWARE( collncp2, collnc, 199?, "Sega License", "College Football's National Championship (Prototype - Apr 19, 1994)", NULL, 0, 0 )
	SOFTWARE( collncp3, collnc, 199?, "Sega License", "College Football's National Championship (Prototype - Apr 29, 1994)", NULL, 0, 0 )
	SOFTWARE( collncp4, collnc, 199?, "Sega License", "College Football's National Championship (Prototype - Jun 01, 1994)", NULL, 0, 0 )
	SOFTWARE( collncp5, collnc, 199?, "Sega License", "College Football's National Championship (Prototype - Jun 03, 1994)", NULL, 0, 0 )
	SOFTWARE( collncp6, collnc, 199?, "Sega License", "College Football's National Championship (Prototype - Jun 07, 1994)", NULL, 0, 0 )
	SOFTWARE( collncp7, collnc, 199?, "Sega License", "College Football's National Championship (Prototype - Jun 08, 1994)", NULL, 0, 0 )
	SOFTWARE( collncp8, collnc, 199?, "Sega License", "College Football's National Championship (Prototype - Jun 14, 1994)", NULL, 0, 0 )
	SOFTWARE( collncp9, collnc, 199?, "Sega License", "College Football's National Championship (Prototype - Jun 15, 1994)", NULL, 0, 0 )
	SOFTWARE( collnp10, collnc, 199?, "Sega License", "College Football's National Championship (Prototype - Jun 18, 1994)", NULL, 0, 0 )
	SOFTWARE( collnp11, collnc, 199?, "Sega License", "College Football's National Championship (Prototype - Jun 20, 1994)", NULL, 0, 0 )
	SOFTWARE( collnp12, collnc, 199?, "Sega License", "College Football's National Championship (Prototype - May 03, 1994)", NULL, 0, 0 )
	SOFTWARE( collnp13, collnc, 199?, "Sega License", "College Football's National Championship (Prototype - May 06, 1994)", NULL, 0, 0 )
	SOFTWARE( collnp14, collnc, 199?, "Sega License", "College Football's National Championship (Prototype - May 11, 1994 - A)", NULL, 0, 0 )
	SOFTWARE( collnp15, collnc, 199?, "Sega License", "College Football's National Championship (Prototype - May 17, 1994 - A)", NULL, 0, 0 )
	SOFTWARE( collnp16, collnc, 199?, "Sega License", "College Football's National Championship (Prototype - May 20, 1994)", NULL, 0, 0 )
	SOFTWARE( collnp17, collnc, 199?, "Sega License", "College Football's National Championship (Prototype - May 25, 1994)", NULL, 0, 0 )
	SOFTWARE( collnp18, collnc, 199?, "Sega License", "College Football's National Championship (Prototype - May 31, 1994)", NULL, 0, 0 )
	...
	SOFTWARE( combat, 0,        199?, "Sega License", "Combat Aces (Beta)", NULL, 0, 0 )
	...
	SOFTWARE( comixp1, comix , 199?, "Sega License", "Comix Zone (Prototype - Jul 12, 1995 - FULSCR)", NULL, 0, 0 )
	SOFTWARE( comixp2, comix , 199?, "Sega License", "Comix Zone (Prototype - Jul 12, 1995)", NULL, 0, 0 )
	SOFTWARE( comixp3, comix , 199?, "Sega License", "Comix Zone (Prototype - Jun 01, 1995 - B)", NULL, 0, 0 )
	SOFTWARE( comixp4, comix , 199?, "Sega License", "Comix Zone (Prototype - Jun 01, 1995 - C)", NULL, 0, 0 )
	SOFTWARE( comixp5, comix , 199?, "Sega License", "Comix Zone (Prototype - Jun 01, 1995 - D)", NULL, 0, 0 )
	SOFTWARE( comixp6, comix , 199?, "Sega License", "Comix Zone (Prototype - Jun 01, 1995)", NULL, 0, 0 )
	SOFTWARE( comixp7, comix , 199?, "Sega License", "Comix Zone (Prototype - Jun 02, 1995 - B)", NULL, 0, 0 )
	SOFTWARE( comixp8, comix , 199?, "Sega License", "Comix Zone (Prototype - Jun 02, 1995)", NULL, 0, 0 )
	SOFTWARE( comixp9, comix , 199?, "Sega License", "Comix Zone (Prototype - Jun 03, 1995)", NULL, 0, 0 )
	SOFTWARE( comip10, comix , 199?, "Sega License", "Comix Zone (Prototype - May 26, 1995)", NULL, 0, 0 )
	SOFTWARE( comip11, comix , 199?, "Sega License", "Comix Zone (Prototype - May 30, 1995)", NULL, 0, 0 )
	SOFTWARE( comixsc, comix , 199?, "Sega License", "Comix Zone (Sega Channel) (Prototype - Jun 12, 1995)", NULL, 0, 0 )
	...
	SOFTWARE( congo,  0,        199?, "Sega License", "Congo (Unknown) (Proto)", NULL, 0, 0 )
	...
	SOFTWARE( cryst1, crysta, 199?, "Sega License", "Crystal's Pony Tale (Prototype - Jul 02, 1994)", NULL, 0, 0 )
	SOFTWARE( cryst0, crysta, 199?, "Sega License", "Crystal's Pony Tale (Prototype - Jul 01, 1994)", NULL, 0, 0 )
	SOFTWARE( cryst2, crysta, 199?, "Sega License", "Crystal's Pony Tale (Prototype - Jul 03, 1994)", NULL, 0, 0 )
	SOFTWARE( cryst3, crysta, 199?, "Sega License", "Crystal's Pony Tale (Prototype - Jul 12, 1994 - B)", NULL, 0, 0 )
	SOFTWARE( cryst4, crysta, 199?, "Sega License", "Crystal's Pony Tale (Prototype - Jul 12, 1994)", NULL, 0, 0 )
	SOFTWARE( cryst5, crysta, 199?, "Sega License", "Crystal's Pony Tale (Prototype - Jul 13, 1994)", NULL, 0, 0 )
	SOFTWARE( cryst6, crysta, 199?, "Sega License", "Crystal's Pony Tale (Prototype - Jun 01, 1994)", NULL, 0, 0 )
	SOFTWARE( cryst7, crysta, 199?, "Sega License", "Crystal's Pony Tale (Prototype - Jun 06, 1994)", NULL, 0, 0 )
	SOFTWARE( cryst8, crysta, 199?, "Sega License", "Crystal's Pony Tale (Prototype - Jun 10, 1994)", NULL, 0, 0 )
	SOFTWARE( cryst9, crysta, 199?, "Sega License", "Crystal's Pony Tale (Prototype - Jun 23, 1994)", NULL, 0, 0 )
	SOFTWARE( crys10, crysta, 199?, "Sega License", "Crystal's Pony Tale (Prototype - Jun 28, 1994)", NULL, 0, 0 )
	SOFTWARE( crys11, crysta, 199?, "Sega License", "Crystal's Pony Tale (Prototype - Jun 30, 1994)", NULL, 0, 0 )
	SOFTWARE( crys12, crysta, 199?, "Sega License", "Crystal's Pony Tale (Prototype - May 11, 1994)", NULL, 0, 0 )
	SOFTWARE( crys13, crysta, 199?, "Sega License", "Crystal's Pony Tale (Prototype - May 19, 1994)", NULL, 0, 0 )
	SOFTWARE( crys14, crysta, 199?, "Sega License", "Crystal's Pony Tale (Prototype - May 26, 1994)", NULL, 0, 0 )
	...
	SOFTWARE( cyborb, cybor , 199?, "Sega License", "Cyborg Justice (Beta)", NULL, 0, 0 )
	...
	SOFTWARE( dahnamk, dahnam, 199?, "Sega License", "Dahna (Korea)", NULL, 0, 0 )
	SOFTWARE( hercul, dahnam, 199?, "Sega License", "Hercules (Unl)", NULL, 0, 0 )
	...
	SOFTWARE( dashba, dash  , 199?, "Sega License", "Dashin' Desperadoes (Beta, Alt)", NULL, 0, 0 )
	...
	SOFTWARE( dcup2 , 0,        199?, "Sega License", "Davis Cup World Tour Tennis 2 (Beta 1)", NULL, 0, 0 )
	...
	SOFTWARE( desert0, desert, 199?, "Sega License", "Desert Demolition (Prototype - Dec 06, 1994)", NULL, 0, 0 )
	SOFTWARE( desert1, desert, 199?, "Sega License", "Desert Demolition (Prototype - Dec 08, 1994)", NULL, 0, 0 )
	SOFTWARE( desert2, desert, 199?, "Sega License", "Desert Demolition (Prototype - Dec 12, 1994 - B)", NULL, 0, 0 )
	SOFTWARE( desert3, desert, 199?, "Sega License", "Desert Demolition (Prototype - Dec 12, 1994)", NULL, 0, 0 )
	SOFTWARE( desert4, desert, 199?, "Sega License", "Desert Demolition (Prototype - Dec 13, 1994)", NULL, 0, 0 )
	SOFTWARE( desert5, desert, 199?, "Sega License", "Desert Demolition (Prototype - Dec 14, 1994)", NULL, 0, 0 )
	SOFTWARE( desert6, desert, 199?, "Sega License", "Desert Demolition (Prototype - Dec 15, 1994)", NULL, 0, 0 )
	SOFTWARE( desert7, desert, 199?, "Sega License", "Desert Demolition (Prototype - Dec 16, 1994)", NULL, 0, 0 )
	SOFTWARE( desert8, desert, 199?, "Sega License", "Desert Demolition (Prototype - Dec 19, 1994)", NULL, 0, 0 )
	...
	SOFTWARE( dinohirea , dinohire  , 199?, "Sega License", "Dinosaurs for Hire (Prototype - Apr 26, 1993)", NULL, 0, 0 )
	SOFTWARE( dinohireb , dinohire  , 199?, "Sega License", "Dinosaurs for Hire (Prototype - Apr 27, 1993)", NULL, 0, 0 )
	SOFTWARE( dinohirec , dinohire  , 199?, "Sega License", "Dinosaurs for Hire (Prototype - May 02, 1993)", NULL, 0, 0 )
	...
	SOFTWARE( domino, 0,        199?, "Sega License", "Domino (Unl)", NULL, 0, 0 )
	...
	SOFTWARE( dheadp1, dhead , 199?, "Sega License", "Dynamite Headdy (Prototype - Jun 14, 1994 - CABEZA)", NULL, 0, 0 )
	SOFTWARE( dheadp2, dhead , 199?, "Sega License", "Dynamite Headdy (Prototype - Jun 15, 1994)", NULL, 0, 0 )
	SOFTWARE( dheadp3, dhead , 199?, "Sega License", "Dynamite Headdy (Prototype - Jun 16, 1994)", NULL, 0, 0 )
	SOFTWARE( dheadp4, dhead , 199?, "Sega License", "Dynamite Headdy (Prototype - Jun 22, 1994)", NULL, 0, 0 )
	...
	SOFTWARE( ecco2b, ecco2 , 199?, "Sega License", "Ecco - The Tides of Time (Beta)", NULL, 0, 0 )
	SOFTWARE( ecco2x, ecco2 , 199?, "Sega License", "Ecco - The Tides of Time (Prototype X11 - Apr 13, 1994)", NULL, 0, 0 )
	...
	SOFTWARE( elfwor, 0,        199?, "Sega License", "Elf Wor (China) (Unl)", NULL, 0, 0 )
	...
	SOFTWARE( tazema, tazem , 199?, "Sega License", "Taz in Escape from Mars (Prototype - Apr 18, 1994)", NULL, 0, 0 )
	SOFTWARE( tazemb, tazem , 199?, "Sega License", "Taz in Escape from Mars (Prototype - Jun 02, 1994)", NULL, 0, 0 )
	SOFTWARE( tazemc, tazem , 199?, "Sega License", "Taz in Escape from Mars (Prototype - Jun 07, 1994)", NULL, 0, 0 )
	SOFTWARE( tazemd, tazem , 199?, "Sega License", "Taz in Escape from Mars (Prototype - Jun 10, 1994)", NULL, 0, 0 )
	SOFTWARE( tazeme, tazem , 199?, "Sega License", "Taz in Escape from Mars (Prototype - Jun 14, 1994)", NULL, 0, 0 )
	SOFTWARE( tazemf, tazem , 199?, "Sega License", "Taz in Escape from Mars (Prototype - Jun 18, 1994 - A)", NULL, 0, 0 )
	SOFTWARE( tazemg, tazem , 199?, "Sega License", "Taz in Escape from Mars (Prototype - Jun 20, 1994)", NULL, 0, 0 )
	SOFTWARE( tazemh, tazem , 199?, "Sega License", "Taz in Escape from Mars (Prototype - Mar 09, 1994)", NULL, 0, 0 )
	SOFTWARE( tazemi, tazem , 199?, "Sega License", "Taz in Escape from Mars (Prototype - May 09, 1994)", NULL, 0, 0 )
	SOFTWARE( tazemj, tazem , 199?, "Sega License", "Taz in Escape from Mars (Prototype - May 18, 1994)", NULL, 0, 0 )
	SOFTWARE( tazemk, tazem , 199?, "Sega License", "Taz in Escape from Mars (Prototype - May 23, 1994)", NULL, 0, 0 )
	...
	SOFTWARE( fengku, 0,        199?, "Sega License", "Feng Kuang Tao Hua Yuan (China) (Unl)", NULL, 0, 0 )

	SOFTWARE( fengsh, 0,        199?, "Sega License", "Feng Shen Ying Jie Chuan (China) (Unl)", NULL, 0, 0 )
	...
	SOFTWARE( ferrb , ferr  , 199?, "Sega License", "Ferrari Grand Prix Challenge (Beta)", NULL, 0, 0 )
	...
	SOFTWARE( futbol, fifa95  , 199?, "Unlicensed", "Futbol Argentino 98 - Pasion de Multitudes (Unl)", NULL, 0, 0 )
	...
	SOFTWARE( fifa2k  , fifa97  , 199?, "unlicensed", "FIFA Soccer 2000 Gold Edition (Unl) (M6)", NULL, 0, 0 )
	...
	SOFTWARE( golden10, 0,        199?, "Sega License", "Golden 10-in-1 (Unl) [!]", NULL, 0, 0 )
	SOFTWARE( golden10b, golden10, 199?, "Sega License", "Golden 10-in-1 (bad dump)", NULL, 0, 0 )
	...
	SOFTWARE( heitao, 0,        199?, "Sega License", "Hei Tao 2 - Super Big 2 (China) (Unl)", NULL, 0, 0 )
	...
	SOFTWARE( herc2 , 0,        199?, "Sega License", "Hercules 2 (Unl)", NULL, 0, 0 )
	...
	SOFTWARE( huamul, 0,        199?, "Sega License", "Hua Mu Lan - Mulan (China) (Unl)", NULL, 0, 0 )

	SOFTWARE( huanle, 0,        199?, "Sega License", "Huan Le Tao Qi Shu - Smart Mouse (China) (Unl)", NULL, 0, 0 )
	...
	SOFTWARE( indy  , 0,        199?, "Sega License", "Indiana Jones' Greatest Adventures (Release Candidate)", NULL, 0, 0 )
	...
	SOFTWARE( iraqwar, 0,        199?, "Sega License", "Iraq War 2003 (Unl)", NULL, 0, 0 )
	...
	SOFTWARE( jiujim, 0,        199?, "Sega License", "Jiu Ji Ma Jiang II - Ye Yan Bian (China) (Unl)", NULL, 0, 0 )
	...
	SOFTWARE( jprmpa, jprmp , 199?, "Sega License", "Jurassic Park - Rampage Edition (Prototype - Jul 08, 1994)", NULL, 0, 0 )
	SOFTWARE( jprmpb, jprmp , 199?, "Sega License", "Jurassic Park - Rampage Edition (Prototype - Jul 13, 1994)", NULL, 0, 0 )
	SOFTWARE( jprmpc, jprmp , 199?, "Sega License", "Jurassic Park - Rampage Edition (Prototype - Jul 14, 1994)", NULL, 0, 0 )
	SOFTWARE( jprmpd, jprmp , 199?, "Sega License", "Jurassic Park - Rampage Edition (Prototype - Jul 15, 1994)", NULL, 0, 0 )
	SOFTWARE( jprmpe, jprmp , 199?, "Sega License", "Jurassic Park - Rampage Edition (Prototype - Jul 17, 1994)", NULL, 0, 0 )
	SOFTWARE( jprmpf, jprmp , 199?, "Sega License", "Jurassic Park - Rampage Edition (Prototype - Jul 18, 1994)", NULL, 0, 0 )
	SOFTWARE( jprmpg, jprmp , 199?, "Sega License", "Jurassic Park - Rampage Edition (Prototype - Jun 20, 1994)", NULL, 0, 0 )
	SOFTWARE( jprmph, jprmp , 199?, "Sega License", "Jurassic Park - Rampage Edition (Prototype - Jun 22, 1994)", NULL, 0, 0 )
	SOFTWARE( jprmpi, jprmp , 199?, "Sega License", "Jurassic Park - Rampage Edition (Prototype - Jun 30, 1994)", NULL, 0, 0 )
	...
	SOFTWARE( kof98 , 0,        199?, "Sega License", "The King of Fighters '98 (Unl)", NULL, 0, 0 )
	SOFTWARE( kof98a, kof98 , 199?, "Sega License", "The King of Fighters '98 (Unl) (Pirate)", NULL, 0, 0 )
	...
	SOFTWARE( lightcp, lightc, 199?, "Sega License", "Light Crusader (Prototype - Jun 08, 1995)", NULL, 0, 0 )
	SOFTWARE( lightcu, lightc, 199?, "Sega License", "Light Crusader", REGION_U, 0, 0 )

	SOFTWARE( lionkin3 , 0,        199?, "Sega License", "Lion King 3 (Unl)", NULL, 0, 0 )

	SOFTWARE( lionkin2, 0,        199?, "Sega License", "The Lion King II (Unl)", NULL, 0, 0 )
	SOFTWARE( lionkin2a, lionkin2, 199?, "Sega License", "The Lion King II (Unl) (Pirate)", NULL, 0, 0 )

	SOFTWARE( lionking, 0,        199?, "Sega License", "The Lion King", REGION_W, 0, 0 )

	SOFTWARE( lobo, 0,        199?, "Sega License", "Lobo (Proto)", REGION_U, 0, 0 )

	SOFTWARE( longch, 0,        199?, "Sega License", "Long (China) (Unl)", NULL, 0, 0 )
	...
	SOFTWARE( majian, 0,        199?, "Sega License", "Ma Jiang Qing Ren - Ji Ma Jiang Zhi (China) (Unl)", NULL, 0, 0 )

	SOFTWARE( maqiao, 0,        199?, "Sega License", "Ma Qiao E Mo Ta - Devilish Mahjong Tower (China) (Unl)", NULL, 0, 0 )
	...
	SOFTWARE( msbpa , msb   , 199?, "Sega License", "The Magic School Bus (Prototype - Apr 11, 1995)", NULL, 0, 0 )
	SOFTWARE( msbpb , msb   , 199?, "Sega License", "The Magic School Bus (Prototype - Apr 21, 1995)", NULL, 0, 0 )
	SOFTWARE( msbpc , msb   , 199?, "Sega License", "The Magic School Bus (Prototype - Apr 25, 1995)", NULL, 0, 0 )
	SOFTWARE( msbpd , msb   , 199?, "Sega License", "The Magic School Bus (Prototype - Apr 28, 1995)", NULL, 0, 0 )
	SOFTWARE( msbpe , msb   , 199?, "Sega License", "The Magic School Bus (Prototype - Feb 02, 1995)", NULL, 0, 0 )
	SOFTWARE( msbpf , msb   , 199?, "Sega License", "The Magic School Bus (Prototype - Feb 17, 1995)", NULL, 0, 0 )
	SOFTWARE( msbpg , msb   , 199?, "Sega License", "The Magic School Bus (Prototype - Jan 12, 1995)", NULL, 0, 0 )
	SOFTWARE( msbph , msb   , 199?, "Sega License", "The Magic School Bus (Prototype - Mar 07, 1995)", NULL, 0, 0 )
	SOFTWARE( msbpi , msb   , 199?, "Sega License", "The Magic School Bus (Prototype - Mar 14, 1995)", NULL, 0, 0 )
	SOFTWARE( msbpj , msb   , 199?, "Sega License", "The Magic School Bus (Prototype - Mar 27, 1995)", NULL, 0, 0 )
	SOFTWARE( msbpk , msb   , 199?, "Sega License", "The Magic School Bus (Prototype - Mar 31, 1995)", NULL, 0, 0 )
	SOFTWARE( msbpl , msb   , 199?, "Sega License", "The Magic School Bus (Prototype - May 05, 1995)", NULL, 0, 0 )
	...
	SOFTWARE( megabm8  , 0,        199?, "Sega License", "Mega Bomberman - 8 Player Demo (Unl)", NULL, 0, 0 )
	...
	SOFTWARE( menghu, 0,        199?, "Sega License", "Meng Huan Shui Guo Pan - 777 Casino (China) (Unl)", NULL, 0, 0 )
	...
	SOFTWARE( micromc , microm  , 199?, "Sega License", "Micro Machines (C)", NULL, 0, 0 )
	...
	SOFTWARE( mmprpa  , mmpr    , 199?, "Sega License", "Mighty Morphin Power Rangers (Prototype - Aug 04, 1994)", NULL, 0, 0 )
	SOFTWARE( mmprpb  , mmpr    , 199?, "Sega License", "Mighty Morphin Power Rangers (Prototype - Aug 08, 1994)", NULL, 0, 0 )
	SOFTWARE( mmprpc  , mmpr    , 199?, "Sega License", "Mighty Morphin Power Rangers (Prototype - Aug 09, 1994)", NULL, 0, 0 )
	SOFTWARE( mmprpd  , mmpr    , 199?, "Sega License", "Mighty Morphin Power Rangers (Prototype - Aug 10, 1994)", NULL, 0, 0 )
	SOFTWARE( mmprpe  , mmpr    , 199?, "Sega License", "Mighty Morphin Power Rangers (Prototype - Jul 08, 1994)", NULL, 0, 0 )
	SOFTWARE( mmprpf  , mmpr    , 199?, "Sega License", "Mighty Morphin Power Rangers (Prototype - Jul 18, 1994)", NULL, 0, 0 )
	...
	SOFTWARE( mmprtmpa, mmprtm  , 199?, "Sega License", "Mighty Morphin Power Rangers - The Movie (Prototype - Jul 13, 1995)", NULL, 0, 0 )
	SOFTWARE( mmprtmpb, mmprtm  , 199?, "Sega License", "Mighty Morphin Power Rangers - The Movie (Prototype - Jul 17, 1995)", NULL, 0, 0 )
	SOFTWARE( mmprtmpc, mmprtm  , 199?, "Sega License", "Mighty Morphin Power Rangers - The Movie (Prototype - Jul 22, 1995)", NULL, 0, 0 )
	SOFTWARE( mmprtmpd, mmprtm  , 199?, "Sega License", "Mighty Morphin Power Rangers - The Movie (Prototype - Jul 24, 1995)", NULL, 0, 0 )
	...
	SOFTWARE( mk5mor, 0,        199?, "Sega License", "MK 5 - Mortal Combat - SubZero (Unl) [!]", NULL, 0, 0 )
	SOFTWARE( mk5mor1, mk5mor, 199?, "Sega License", "MK 5 - Mortal Combat - SubZero (Unl) (Pirate)", NULL, 0, 0 )
	...
	SOFTWARE( nbaap1, nbaa  , 199?, "Sega License", "NBA Action (Prototype - Jan 04, 1994)", NULL, 0, 0 )
	SOFTWARE( nbaap2, nbaa  , 199?, "Sega License", "NBA Action (Prototype - Jan 16, 1994)", NULL, 0, 0 )
	SOFTWARE( nbaap3, nbaa  , 199?, "Sega License", "NBA Action (Prototype - Jan 27, 1994) (broken - C08 missing)", NULL, 0, 0 )

	SOFTWARE( nbaa95 , 0,        199?, "Sega License", "NBA Action '95 Starring David Robinson", REGION_EU, 0, 0 )
	SOFTWARE( nbaa95a, nbaa95 , 199?, "Sega License", "NBA Action '95 (Prototype - Dec 02, 1994 - B)", NULL, 0, 0 )
	SOFTWARE( nbaa95b, nbaa95 , 199?, "Sega License", "NBA Action '95 (Prototype - Dec 09, 1994)", NULL, 0, 0 )
	SOFTWARE( nbaa95c, nbaa95 , 199?, "Sega License", "NBA Action '95 (Prototype - Dec 15, 1994)", NULL, 0, 0 )
	SOFTWARE( nbaa95d, nbaa95 , 199?, "Sega License", "NBA Action '95 (Prototype - Dec 22, 1994 - A)", NULL, 0, 0 )
	SOFTWARE( nbaa95e, nbaa95 , 199?, "Sega License", "NBA Action '95 (Prototype - Dec 24, 1994 - A)", NULL, 0, 0 )
	SOFTWARE( nbaa95f, nbaa95 , 199?, "Sega License", "NBA Action '95 (Prototype - Dec 29, 1994)", NULL, 0, 0 )
	SOFTWARE( nbaa95g, nbaa95 , 199?, "Sega License", "NBA Action '95 (Prototype - Dec 30, 1994)", NULL, 0, 0 )
	SOFTWARE( nbaa95h, nbaa95 , 199?, "Sega License", "NBA Action '95 (Prototype - Dec 31, 1994)", NULL, 0, 0 )
	SOFTWARE( nbaa95i, nbaa95 , 199?, "Sega License", "NBA Action '95 (Prototype - Feb 01, 1995)", NULL, 0, 0 )
	SOFTWARE( nbaa95j, nbaa95 , 199?, "Sega License", "NBA Action '95 (Prototype - Feb 1, 1995)", NULL, 0, 0 )
	SOFTWARE( nbaa95k, nbaa95 , 199?, "Sega License", "NBA Action '95 (Prototype - Feb 2, 1995)", NULL, 0, 0 )
	SOFTWARE( nbaa95l, nbaa95 , 199?, "Sega License", "NBA Action '95 (Prototype - Jan 03, 1995)", NULL, 0, 0 )
	SOFTWARE( nbaa95m, nbaa95 , 199?, "Sega License", "NBA Action '95 (Prototype - Jan 08, 1995)", NULL, 0, 0 )
	SOFTWARE( nbaa95n, nbaa95 , 199?, "Sega License", "NBA Action '95 (Prototype - Jan 12, 1995)", NULL, 0, 0 )
	SOFTWARE( nbaa95o, nbaa95 , 199?, "Sega License", "NBA Action '95 (Prototype - Jan 15, 1995 - A)", NULL, 0, 0 )
	SOFTWARE( nbaa95p, nbaa95 , 199?, "Sega License", "NBA Action '95 (Prototype - Jan 21, 1995)", NULL, 0, 0 )
	SOFTWARE( nbaa95q, nbaa95 , 199?, "Sega License", "NBA Action '95 (Prototype - Jan 22, 1995 - B)", NULL, 0, 0 )
	SOFTWARE( nbaa95r, nbaa95 , 199?, "Sega License", "NBA Action '95 (Prototype - Jan 24, 1995 - B)", NULL, 0, 0 )
	SOFTWARE( nbaa95s, nbaa95 , 199?, "Sega License", "NBA Action '95 (Prototype - Jan 27, 1995 - A)", NULL, 0, 0 )
	SOFTWARE( nbaa95t, nbaa95 , 199?, "Sega License", "NBA Action '95 (Prototype - Jan 27, 1995 - B)", NULL, 0, 0 )
	SOFTWARE( nbaa95u, nbaa95 , 199?, "Sega License", "NBA Action '95 (Prototype - Jan 28, 1995 - A)", NULL, 0, 0 )
	SOFTWARE( nbaa95v, nbaa95 , 199?, "Sega License", "NBA Action '95 (Prototype - Jan 28, 1995)", NULL, 0, 0 )
	SOFTWARE( nbaa95w, nbaa95 , 199?, "Sega License", "NBA Action '95 (Prototype - Jan 30, 1995)", NULL, 0, 0 )
	SOFTWARE( nbaa95x, nbaa95 , 199?, "Sega License", "NBA Action '95 (Prototype - Nov 18, 1994)", NULL, 0, 0 )
	SOFTWARE( nbaa95y, nbaa95 , 199?, "Sega License", "NBA Action '95 (Prototype - Nov 23, 1994 - A)", NULL, 0, 0 )
	...
	SOFTWARE( nfl95a, nfl95 , 199?, "Sega License", "NFL '95 (Prototype - Aug 01, 1994)", NULL, 0, 0 )
	SOFTWARE( nfl95b, nfl95 , 199?, "Sega License", "NFL '95 (Prototype - Aug 05, 1994)", NULL, 0, 0 )
	SOFTWARE( nfl95c, nfl95 , 199?, "Sega License", "NFL '95 (Prototype - Aug 10, 1994)", NULL, 0, 0 )
	SOFTWARE( nfl95d, nfl95 , 199?, "Sega License", "NFL '95 (Prototype - Aug 12, 1994)", NULL, 0, 0 )
	SOFTWARE( nfl95e, nfl95 , 199?, "Sega License", "NFL '95 (Prototype - Aug 12, 1994)_", NULL, 0, 0 )
	SOFTWARE( nfl95f, nfl95 , 199?, "Sega License", "NFL '95 (Prototype - Aug 17, 1994 - B)", NULL, 0, 0 )
	SOFTWARE( nfl95g, nfl95 , 199?, "Sega License", "NFL '95 (Prototype - Aug 17, 1994)", NULL, 0, 0 )
	SOFTWARE( nfl95h, nfl95 , 199?, "Sega License", "NFL '95 (Prototype - Aug 22, 1994)", NULL, 0, 0 )
	SOFTWARE( nfl95i, nfl95 , 199?, "Sega License", "NFL '95 (Prototype - Aug 30, 1994)", NULL, 0, 0 )
	SOFTWARE( nfl95j, nfl95 , 199?, "Sega License", "NFL '95 (Prototype - Aug 31, 1994)", NULL, 0, 0 )
	SOFTWARE( nfl95k, nfl95 , 199?, "Sega License", "NFL '95 (Prototype - Sep 01, 1994)", NULL, 0, 0 )
	SOFTWARE( nfl95l, nfl95 , 199?, "Sega License", "NFL '95 (Prototype - Sep 02, 1994)", NULL, 0, 0 )
	SOFTWARE( nfl95m, nfl95 , 199?, "Sega License", "NFL '95 (Prototype - Sep 04, 1994)", NULL, 0, 0 )
	SOFTWARE( nfl95n, nfl95 , 199?, "Sega License", "NFL '95 (Prototype - Sep 05, 1994 - B)", NULL, 0, 0 )
	SOFTWARE( nfl95o, nfl95 , 199?, "Sega License", "NFL '95 (Prototype - Sep 05, 1994)", NULL, 0, 0 )
	SOFTWARE( nfl95p, nfl95 , 199?, "Sega License", "NFL '95 (Prototype - Sep 06, 1994)", NULL, 0, 0 )
	SOFTWARE( nfl95q, nfl95 , 199?, "Sega License", "NFL '95 (Prototype - Sep 07, 1994)", NULL, 0, 0 )
	SOFTWARE( nfl95r, nfl95 , 199?, "Sega License", "NFL '95 (Prototype - Sep 08, 1994)", NULL, 0, 0 )
	SOFTWARE( nfl95s, nfl95 , 199?, "Sega License", "NFL '95 (Prototype - Sep 09, 1994)", NULL, 0, 0 )
	SOFTWARE( nfl95t, nfl95 , 199?, "Sega License", "NFL '95 (Prototype - Sep 11, 1994 - B)", NULL, 0, 0 )
	SOFTWARE( nfl95u, nfl95 , 199?, "Sega License", "NFL '95 (Prototype - Sep 11, 1994)", NULL, 0, 0 )
	...
	SOFTWARE( nhlasa, nhlas , 199?, "Sega License", "NHL All-Star Hockey '95 (Prototype - Dec 01, 1994 - B)", NULL, 0, 0 )
	SOFTWARE( nhlasb, nhlas , 199?, "Sega License", "NHL All-Star Hockey '95 (Prototype - Dec 01, 1994)", NULL, 0, 0 )
	SOFTWARE( nhlasc, nhlas , 199?, "Sega License", "NHL All-Star Hockey '95 (Prototype - Dec 02, 1994)", NULL, 0, 0 )
	SOFTWARE( nhlasd, nhlas , 199?, "Sega License", "NHL All-Star Hockey '95 (Prototype - Nov 07, 1994)", NULL, 0, 0 )
	SOFTWARE( nhlase, nhlas , 199?, "Sega License", "NHL All-Star Hockey '95 (Prototype - Nov 09, 1994)", NULL, 0, 0 )
	SOFTWARE( nhlasf, nhlas , 199?, "Sega License", "NHL All-Star Hockey '95 (Prototype - Nov 19, 1994)", NULL, 0, 0 )
	SOFTWARE( nhlasg, nhlas , 199?, "Sega License", "NHL All-Star Hockey '95 (Prototype - Nov 21, 1994)", NULL, 0, 0 )
	SOFTWARE( nhlash, nhlas , 199?, "Sega License", "NHL All-Star Hockey '95 (Prototype - Nov 22, 1994)", NULL, 0, 0 )
	SOFTWARE( nhlasi, nhlas , 199?, "Sega License", "NHL All-Star Hockey '95 (Prototype - Nov 23, 1994)", NULL, 0, 0 )
	SOFTWARE( nhlasj, nhlas , 199?, "Sega License", "NHL All-Star Hockey '95 (Prototype - Nov 27, 1994)", NULL, 0, 0 )
	SOFTWARE( nhlask, nhlas , 199?, "Sega License", "NHL All-Star Hockey '95 (Prototype - Nov 28, 1994)", NULL, 0, 0 )
	SOFTWARE( nhlasl, nhlas , 199?, "Sega License", "NHL All-Star Hockey '95 (Prototype - Nov 29, 1994)", NULL, 0, 0 )
	SOFTWARE( nhlasm, nhlas , 199?, "Sega License", "NHL All-Star Hockey '95 (Prototype - Oct 01, 1994)", NULL, 0, 0 )
	SOFTWARE( nhlasn, nhlas , 199?, "Sega License", "NHL All-Star Hockey '95 (Prototype - Oct 21, 1994)", NULL, 0, 0 )
	SOFTWARE( nhlaso, nhlas , 199?, "Sega License", "NHL All-Star Hockey '95 (Prototype - Sep 14, 1994)", NULL, 0, 0 )
	SOFTWARE( nhlasp, nhlas , 199?, "Sega License", "NHL All-Star Hockey '95 (Prototype - Sep 29, 1994)", NULL, 0, 0 )
	...
	SOFTWARE( ncircp, ncirc , 199?, "Sega License", "Nightmare Circus (Prototype)", NULL, 0, 0 )
	...
	SOFTWARE( oozepb, ooze  , 199?, "Sega License", "The Ooze (Prototype - Jun 15, 1995)", NULL, 0, 0 )
	SOFTWARE( oozepc, ooze  , 199?, "Sega License", "The Ooze (Prototype - Jun 19, 1995)", NULL, 0, 0 )
	SOFTWARE( oozepd, ooze  , 199?, "Sega License", "The Ooze (Prototype - Jun 29, 1995 - B)", NULL, 0, 0 )
	SOFTWARE( oozepe, ooze  , 199?, "Sega License", "The Ooze (Prototype - Jun 29, 1995)", NULL, 0, 0 )
	SOFTWARE( oozetf, ooze  , 199?, "Sega License", "The Ooze (Prototype 104 - Jun 22, 1995)", NULL, 0, 0 )
	SOFTWARE( oozetg, ooze  , 199?, "Sega License", "The Ooze (Prototype 112 - Jun 26, 1995)", NULL, 0, 0 )
	...
	SOFTWARE( pstar4a, pstar4 , 199?, "Sega License", "Phantasy Star IV (Prototype - Aug 15, 1994)", NULL, 0, 0 )
	SOFTWARE( pstar4b, pstar4 , 199?, "Sega License", "Phantasy Star IV (Prototype - Jun 08, 1994)", NULL, 0, 0 )
	SOFTWARE( pstar4c, pstar4 , 199?, "Sega License", "Phantasy Star IV (Prototype - May 30, 1994)", NULL, 0, 0 )
	SOFTWARE( pstar4d, pstar4 , 199?, "Sega License", "Phantasy Star IV (Prototype - Nov 07, 1994)", NULL, 0, 0 )
	SOFTWARE( pstar4e, pstar4 , 199?, "Sega License", "Phantasy Star IV (Prototype - Oct 27, 1994)", NULL, 0, 0 )
	...
	SOFTWARE( pokemon, 0,        199?, "Sega License", "Pocket Monsters (Unl)", NULL, 0, 0 )
	SOFTWARE( pokemona, pokemon, 199?, "Sega License", "Pocket Monsters (Unl, Alt)", NULL, 0, 0 )

	SOFTWARE( pokemon2, 0,        199?, "Sega License", "Pocket Monsters 2 (Unl)", NULL, 0, 0 )

	SOFTWARE( pokecd, 0,        199?, "Sega License", "Pokemon Crazy Drummer (Unl)", NULL, 0, 0 )

	SOFTWARE( pokestad, 0,        199?, "Sega License", "Pokemon Stadium (Unl)", NULL, 0, 0 )
	...
	SOFTWARE( pretty, 0,        199?, "Sega License", "Pretty Girl Mahjongg (Ch)", NULL, 0, 0 )
	...
	SOFTWARE( puggsyb, puggsy, 199?, "Sega License", "Puggsy (Beta)", NULL, 0, 0 )
	...
	SOFTWARE( rbi4b , rbi4 ,    199?, "Sega License", "R.B.I. Baseball 4 (Beta)", NULL, 0, 0 )
	...
	SOFTWARE( rsbtpa, rsbt  , 199?, "Sega License", "Richard Scarry's Busytown (Prototype - Aug 09, 1994)", NULL, 0, 0 )
	SOFTWARE( rsbtpb, rsbt  , 199?, "Sega License", "Richard Scarry's Busytown (Prototype - Aug 15, 1994)", NULL, 0, 0 )
	SOFTWARE( rsbtpc, rsbt  , 199?, "Sega License", "Richard Scarry's Busytown (Prototype - Aug 16, 1994 - B)", NULL, 0, 0 )
	SOFTWARE( rsbtpd, rsbt  , 199?, "Sega License", "Richard Scarry's Busytown (Prototype - Aug 17, 1994)", NULL, 0, 0 )
	SOFTWARE( rsbtpe, rsbt  , 199?, "Sega License", "Richard Scarry's Busytown (Prototype - Aug 25, 1994)", NULL, 0, 0 )
	SOFTWARE( rsbtpf, rsbt  , 199?, "Sega License", "Richard Scarry's Busytown (Prototype - Aug 26, 1994)", NULL, 0, 0 )
	SOFTWARE( rsbtpg, rsbt  , 199?, "Sega License", "Richard Scarry's Busytown (Prototype - Jul 21, 1994)", NULL, 0, 0 )
	...
	SOFTWARE( ristarpa, rist  , 199?, "Sega License", "Ristar (Prototype - Aug 12, 1994)", NULL, 0, 0 )
	SOFTWARE( ristarpb, rist  , 199?, "Sega License", "Ristar (Prototype - Aug 26, 1994)", NULL, 0, 0 )
	SOFTWARE( ristarpc, rist  , 199?, "Sega License", "Ristar (Prototype - Jul 01, 1994)", NULL, 0, 0 )
	SOFTWARE( ristarpd, rist  , 199?, "Sega License", "Ristar (Prototype - Jul 18, 1994)", NULL, 0, 0 )
	...
	SOFTWARE( robotermb1, roboterm , 199?, "Sega License", "Robocop Versus The Terminator (Beta 1)", NULL, 0, 0 )
	...
	SOFTWARE( rockmnx3  , 0,        199?, "Sega License", "Rockman X3 (Unl) [!]", NULL, 0, 0 )
	...
	SOFTWARE( sanguo, 0,        199?, "Sega License", "San Guo Zhi Lie Zhuan - Luan Shi Qun Ying (China)", NULL, 0, 0 )

	SOFTWARE( sanguo5, 0,        199?, "Sega License", "San Guo Zhi V (China) (Unl)", NULL, 0, 0 )
	...
	SOFTWARE( sensibleb, sensible, 199?, "Sega License", "Sensible Soccer (Beta)", NULL, 0, 0 )
	...
	SOFTWARE( shdwruna, shdwrun , 199?, "Sega License", "Shadowrun (Prototype - Dec 28, 1993)", NULL, 0, 0 )
	SOFTWARE( shdwrunb, shdwrun , 199?, "Sega License", "Shadowrun (Prototype - Dec 31, 1993)", NULL, 0, 0 )
	SOFTWARE( shdwrunc, shdwrun , 199?, "Sega License", "Shadowrun (Prototype - Jan 25, 1994 - C)", NULL, 0, 0 )
	SOFTWARE( shdwrund, shdwrun , 199?, "Sega License", "Shadowrun (Prototype - Jan 25, 1994)", NULL, 0, 0 )
	...
	SOFTWARE( shai2b, shai2 , 199?, "Sega License", "Shanghai II - Dragon's Eye (Beta)", NULL, 0, 0 )

	SOFTWARE( shaqfu, 0,        199?, "Sega License", "Shaq Fu", REGION_EU, 0, 0 )

	SOFTWARE( shijie, 0,        199?, "Sega License", "Shi Jie Zhi Bang Zheng Ba Zhan - World Pro Baseball 94 (China) (Unl)", NULL, 0, 0 )
	...
	SOFTWARE( shinfrc2pa, shinfrc2  , 199?, "Sega License", "Shining Force II (Prototype - Apr 04, 1994)", NULL, 0, 0 )
	SOFTWARE( shinfrc2pb, shinfrc2  , 199?, "Sega License", "Shining Force II (Prototype - Jun 07, 1994)", NULL, 0, 0 )
	...
	SOFTWARE( ship, 0,        199?, "Sega License", "Ship (Unreleased)", NULL, 0, 0 )
	...
	SOFTWARE( shuihu, 0,        199?, "Sega License", "Shui Hu - Feng Yun Zhuan (China) (Unl)", NULL, 0, 0 )

	SOFTWARE( shuihu1, 0,        199?, "Sega License", "Shui Hu Zhuan (China) (Unl)", NULL, 0, 0 )
	...
	SOFTWARE( slamshaq, 0,        199?, "Sega License", "Slam - Shaq vs. the Legends (Prototype)", NULL, 0, 0 )
	...
	SOFTWARE( ska   , sk    , 199?, "Sega License", "Sonic & Knuckles (Prototype 0525 - May 25, 1994, 15.28)", NULL, 0, 0 )
	SOFTWARE( skb   , sk    , 199?, "Sega License", "Sonic & Knuckles (Prototype 0606 - Jun 06, 1994, 10.02)", NULL, 0, 0 )
	SOFTWARE( skc   , sk    , 199?, "Sega License", "Sonic & Knuckles (Prototype 0608 - Jun 08, 1994, 05.03)", NULL, 0, 0 )
	SOFTWARE( skd   , sk    , 199?, "Sega License", "Sonic & Knuckles (Prototype 0610 - Jun 10, 1994, 07.49)", NULL, 0, 0 )
	SOFTWARE( ske   , sk    , 199?, "Sega License", "Sonic & Knuckles (Prototype 0612 - Jun 12, 1994, 18.27)", NULL, 0, 0 )
	SOFTWARE( skf   , sk    , 199?, "Sega License", "Sonic & Knuckles (Prototype 0618 - Jun 18, 1994, 09.15)", NULL, 0, 0 )
	SOFTWARE( skg   , sk    , 199?, "Sega License", "Sonic & Knuckles (Prototype 0619 - Jun 19, 1994, 08.18)", NULL, 0, 0 )
	SOFTWARE( skh   , sk    , 199?, "Sega License", "Sonic & Knuckles (S2K chip) (Prototype 0606 - Jun 05, 1994, 22.25)", NULL, 0, 0 )
	SOFTWARE( ski   , sk    , 199?, "Sega License", "Sonic & Knuckles (S2K chip) (Prototype 0608 - Jun 08, 1994, 03.35)", NULL, 0, 0 )
	SOFTWARE( skj   , sk    , 199?, "Sega License", "Sonic & Knuckles (S2K chip) (Prototype 0610 - Jun 10, 1994, 03.11)", NULL, 0, 0 )
	SOFTWARE( skk   , sk    , 199?, "Sega License", "Sonic & Knuckles (S2K chip) (Prototype 0612 - Jun 12, 1994, 18.18)", NULL, 0, 0 )
	SOFTWARE( skl   , sk    , 199?, "Sega License", "Sonic & Knuckles (S2K chip) (Prototype 0618 - Jun 18, 1994, 9.07)", NULL, 0, 0 )
	...
	SOFTWARE( knuckl, sks2  , 199?, "Sega License", "Knuckles in Sonic 2 (Prototype 0524 - May 27, 1994, 10.46)", NULL, 0, 0 )

	SOFTWARE( sks3  , 0,        199?, "Sega License", "Sonic & Knuckles + Sonic the Hedgehog 3", REGION_W, 0, 0 )
	SOFTWARE( sonic3c , sks3  , 199?, "Sega License", "Sonic 3C (Prototype 0408 - Apr 08, 1994, 17.29)", NULL, 0, 0 )
	SOFTWARE( sonic3ca, sks3  , 199?, "Sega License", "Sonic 3C (Prototype 0517 - May 17, 1994, 17.08)", NULL, 0, 0 )

	SOFTWARE( s3d   , 0,        199?, "Sega License", "Sonic 3D Blast ~ Sonic 3D Flickies' Island", REGION_EU, 0, 0 )
	SOFTWARE( s3da  , s3d   , 199?, "Sega License", "Sonic 3D Blast (Prototype 73 - Jul 03, 1996, 13.58)", NULL, 0, 0 )
	SOFTWARE( s3db  , s3d   , 199?, "Sega License", "Sonic 3D Blast (Prototype 814 - Aug 15, 1996, 07.55)", NULL, 0, 0 )
	SOFTWARE( s3dc  , s3d   , 199?, "Sega License", "Sonic 3D Blast (Prototype 819 - Aug 19, 1996, 19.49)", NULL, 0, 0 )
	SOFTWARE( s3dd  , s3d   , 199?, "Sega License", "Sonic 3D Blast (Prototype 825 - Aug 26, 1996, 15.46)", NULL, 0, 0 )
	SOFTWARE( s3de  , s3d   , 199?, "Sega License", "Sonic 3D Blast (Prototype 830 - Aug 31, 1996, 08.19)", NULL, 0, 0 )
	SOFTWARE( s3df  , s3d   , 199?, "Sega License", "Sonic 3D Blast (Prototype 831 - Sep 03, 1996, 10.07)", NULL, 0, 0 )
	SOFTWARE( s3dg  , s3d   , 199?, "Sega License", "Sonic 3D Blast (Prototype 94 - Sep 04, 1996, 12.01)", NULL, 0, 0 )
	...
	SOFTWARE( sonicjam, 0,        199?, "Sega License", "Sonic Jam 6 (Unl)", NULL, 0, 0 )
	SOFTWARE( sonicjam1, sonicjam, 199?, "Sega License", "Sonic Jam 6 (Unl) (Pirate)", NULL, 0, 0 )
	...
	SOFTWARE( sonic2b, sonic2 , 199?, "Sega License", "Sonic The Hedgehog 2 (Beta 4 - Sep 18, 1992, 16.26)", NULL, 0, 0 )
	SOFTWARE( sonic2c, sonic2 , 199?, "Sega License", "Sonic The Hedgehog 2 (Beta 5 - Sep 21, 1992, 12.06)", NULL, 0, 0 )
	SOFTWARE( sonic2d, sonic2 , 199?, "Sega License", "Sonic The Hedgehog 2 (Beta 6 - Sep 22, 1992, 18.47)", NULL, 0, 0 )
	SOFTWARE( sonic2e, sonic2 , 199?, "Sega License", "Sonic The Hedgehog 2 (Beta 6 - Sep 22, 1992, 19.42)", NULL, 0, 0 )
	SOFTWARE( sonic2f, sonic2 , 199?, "Sega License", "Sonic The Hedgehog 2 (Beta 7 - Sep 24, 1992, 09.26)", NULL, 0, 0 )
	SOFTWARE( sonic2g, sonic2 , 199?, "Sega License", "Sonic The Hedgehog 2 (Beta 8 - Sep 24, 1992, 19.27)", NULL, 0, 0 )
	SOFTWARE( sonic2h, sonic2 , 199?, "Sega License", "Sonic The Hedgehog 2 (Prototype)", NULL, 0, 0 )
	...
	SOFTWARE( sonic3a, sonic3 , 199?, "Sega License", "Sonic The Hedgehog 3 (Argentinian Pirate)", NULL, 0, 0 )
	...
	SOFTWARE( soulblad, 0,        199?, "unlicensed", "Soul Blade (Unl)", NULL, 0, 0 )
	...
	SOFTWARE( squirrel, 0,        199?, "Sega License", "Squirrel King (China) (Unl)", NULL, 0, 0 )
	...
	SOFTWARE( sttngb, sttng , 199?, "Sega License", "Star Trek - The Next Generation - Echoes from the Past (Prototype - Dec 28, 1994)", NULL, 0, 0 )
	SOFTWARE( sttngc, sttng , 199?, "Sega License", "Star Trek - The Next Generation - Echoes from the Past (Prototype - Dec 29, 1994)", NULL, 0, 0 )
	SOFTWARE( sttngd, sttng , 199?, "Sega License", "Star Trek - The Next Generation - Echoes from the Past (Prototype - Jan 03, 1994)", NULL, 0, 0 )
	SOFTWARE( sttnge, sttng , 199?, "Sega License", "Star Trek - The Next Generation - Echoes from the Past (Prototype - Jan 10, 1994)", NULL, 0, 0 )
	SOFTWARE( sttngf, sttng , 199?, "Sega License", "Star Trek - The Next Generation - Echoes from the Past (Prototype - Jan 18, 1994)", NULL, 0, 0 )
	SOFTWARE( sttngg, sttng , 199?, "Sega License", "Star Trek - The Next Generation - Echoes from the Past (Prototype - Jan 25, 1994)", NULL, 0, 0 )
	...
	SOFTWARE( storytho4, storytho, 199?, "Sega License", "The Story of Thor (Prototype - Nov 01, 1994)", NULL, 0, 0 )
	SOFTWARE( storytho5, storytho, 199?, "Sega License", "The Story of Thor (Prototype - Oct 04, 1994)", NULL, 0, 0 )
	SOFTWARE( storytho6, storytho, 199?, "Sega License", "The Story of Thor (Prototype - Oct 17, 1994)", NULL, 0, 0 )
	...
	SOFTWARE( beyoasisp, storytho, 199?, "Sega License", "Beyond Oasis (Prototype - Nov 01, 1994)", NULL, 0, 0 )
	...
	SOFTWARE( sf2tb , sf2   , 199?, "Sega License", "Street Fighter II' Turbo (Beta)", NULL, 0, 0 )
	...
	SOFTWARE( sor3pf, sor3  , 199?, "Sega License", "Streets of Rage 3 (Prototype - Apr 01, 1994)", NULL, 0, 0 )
	SOFTWARE( sor3pg, sor3  , 199?, "Sega License", "Streets of Rage 3 (Prototype - Apr 04, 1994)", NULL, 0, 0 )
	SOFTWARE( sor3ph, sor3  , 199?, "Sega License", "Streets of Rage 3 (Prototype - Apr 08, 1994)", NULL, 0, 0 )
	SOFTWARE( sor3pi, sor3  , 199?, "Sega License", "Streets of Rage 3 (Prototype - Apr 11, 1994)", NULL, 0, 0 )
	SOFTWARE( sor3pj, sor3  , 199?, "Sega License", "Streets of Rage 3 (Prototype - Apr 12, 1994)", NULL, 0, 0 )
	SOFTWARE( sor3pk, sor3  , 199?, "Sega License", "Streets of Rage 3 (Prototype - Apr 13, 1994)", NULL, 0, 0 )
	SOFTWARE( sor3pl, sor3  , 199?, "Sega License", "Streets of Rage 3 (Prototype - Mar 08, 1994)", NULL, 0, 0 )
	SOFTWARE( sor3pm, sor3  , 199?, "Sega License", "Streets of Rage 3 (Prototype - Mar 17, 1994)", NULL, 0, 0 )
	SOFTWARE( sor3pn, sor3  , 199?, "Sega License", "Streets of Rage 3 (Prototype - Mar 18, 1994)", NULL, 0, 0 )
	SOFTWARE( sor3po, sor3  , 199?, "Sega License", "Streets of Rage 3 (Prototype - Mar 28, 1994)", NULL, 0, 0 )
	...
	SOFTWARE( subtp , subt  , 199?, "Sega License", "SubTerrania (Prototype - Feb 02, 1994)", NULL, 0, 0 )
	...
	SOFTWARE( s15in1, 0,        199?, "Sega License", "Super 15-in-1 (Pirate)", NULL, 0, 0 )

	SOFTWARE( s19in1, 0,        199?, "Sega License", "Super 19-in-1 (Pirate)", NULL, 0, 0 )
	...
	SOFTWARE( supbub, 0,        199?, "Sega License", "Super Bubble Bobble (China) (Unl)", NULL, 0, 0 )

	SOFTWARE( superd, 0,        199?, "Sega License", "Super Daisenryaku", REGION_J, 0, 0 )

	SOFTWARE( sdkong99 , 0,        199?, "Sega License", "Super Donkey Kong 99 (Unl) (Protected)", NULL, 0, 0 )
	SOFTWARE( sdkong99a, sdkong99 , 199?, "Sega License", "Super Donkey Kong 99 (Unl) [!]", NULL, 0, 0 )
	SOFTWARE( skkong99 , sdkong99 , 199?, "Sega License", "Super King Kong 99 (Unl) [!]", NULL, 0, 0 )
	...
	SOFTWARE( superm, 0,        199?, "Sega License", "Super Mario 2 1998 (Unl) [!]", NULL, 0, 0 )

	SOFTWARE( supe16, 0,        199?, "Sega License", "Super Mario Bros. (Unl) [!]", NULL, 0, 0 )
	SOFTWARE( supe17, supe16, 199?, "Sega License", "Super Mario World (Unl) [!]", NULL, 0, 0 )
	SOFTWARE( supe18, supe16, 199?, "Sega License", "Super Mario World (Unl) (Pirate)", NULL, 0, 0 )
	...
	SOFTWARE( taiwan, 0,        199?, "Sega License", "Taiwan Daheng (China) (Unl)", NULL, 0, 0 )
	...
	SOFTWARE( tekk3sp , 0,        199?, "Sega License", "Tekken 3 Special (Unl)", NULL, 0, 0 )
	...
	SOFTWARE( redcliff, 0,        199?, "unlicensed", "The Battle of Red Cliffs - Romance of the Three Kingdoms (Unl)", NULL, 0, 0 )

	SOFTWARE( kof99, 0,        199?, "unlicensed", "The King of Fighters 99 (Unl)", NULL, 0, 0 )
	...
	SOFTWARE( topfight, 0,        199?, "Sega License", "Top Fighter 2000 MK VIII (Unl) [!]", NULL, 0, 0 )
	...
	SOFTWARE( tunshi, 0,        199?, "Sega License", "Tun Shi Tian Di III (China) (Simple Chinese) (Unl)", NULL, 0, 0 )
	SOFTWARE( tunshi1, tunshi, 199?, "Sega License", "Tun Shi Tian Di III (China) (Unl)", NULL, 0, 0 )
	...
	SOFTWARE( vecmana , vecman  , 199?, "Sega License", "Vectorman (Beta)", NULL, 0, 0 )
	SOFTWARE( vecmanb , vecman  , 199?, "Sega License", "Vectorman (Prototype - Jul 24, 1995)", NULL, 0, 0 )
	...
	SOFTWARE( vecman2b, vecman2 , 199?, "Sega License", "Vectorman 2 (Prototype - Aug 15, 1996)", NULL, 0, 0 )
	SOFTWARE( vecman2c, vecman2 , 199?, "Sega License", "Vectorman 2 (Prototype - Aug 16, 1996)", NULL, 0, 0 )
	SOFTWARE( vecman2d, vecman2 , 199?, "Sega License", "Vectorman 2 (Prototype - Aug 19, 1996)", NULL, 0, 0 )
	SOFTWARE( vecman2e, vecman2 , 199?, "Sega License", "Vectorman 2 (Prototype - Aug 26, 1996)", NULL, 0, 0 )
	SOFTWARE( vecman2f, vecman2 , 199?, "Sega License", "Vectorman 2 (Prototype - Aug 27, 1996)", NULL, 0, 0 )
	...
	SOFTWARE( vf2b  , vf2   , 199?, "Sega License", "Virtua Fighter 2 (Prototype - Aug 19, 1996)", NULL, 0, 0 )
	SOFTWARE( vf2c  , vf2   , 199?, "Sega License", "Virtua Fighter 2 (Prototype - Aug 30, 1996)", NULL, 0, 0 )
	SOFTWARE( vf2d  , vf2   , 199?, "Sega License", "Virtua Fighter 2 (Prototype - Sep 13, 1996)", NULL, 0, 0 )
	SOFTWARE( vf2e  , vf2   , 199?, "Sega License", "Virtua Fighter 2 (Prototype - Sep 20, 1996)", NULL, 0, 0 )
	SOFTWARE( vf2f  , vf2   , 199?, "Sega License", "Virtua Fighter 2 (Prototype - Sep 27, 1996)", NULL, 0, 0 )

	SOFTWARE( vf2tek, 0,        199?, "Sega License", "Virtua Fighter 2 vs Tekken 2 (Unl)", NULL, 0, 0 )
	...
	SOFTWARE( wwa   , ww    , 199?, "Sega License", "Wacky Worlds (Prototype - Aug 08, 1994)", NULL, 0, 0 )
	SOFTWARE( wwb   , ww    , 199?, "Sega License", "Wacky Worlds (Prototype - Aug 17, 1994)", NULL, 0, 0 )
	SOFTWARE( wwc   , ww    , 199?, "Sega License", "Wacky Worlds (Prototype - Aug 19, 1994)", NULL, 0, 0 )
	...
	SOFTWARE( wintcb, wintc , 199?, "Sega License", "Winter Challenge (Beta)", NULL, 0, 0 )
	...
	SOFTWARE( wcs2a , wcs2  , 199?, "Sega License", "World Championship Soccer II (Prototype - Feb 23, 1994)", NULL, 0, 0 )
	SOFTWARE( wcs2b , wcs2  , 199?, "Sega License", "World Championship Soccer II (Prototype - Mar 09, 1994)", NULL, 0, 0 )
	SOFTWARE( wcs2c , wcs2  , 199?, "Sega License", "World Championship Soccer II (Prototype - Mar 14, 1994)", NULL, 0, 0 )
	SOFTWARE( wcs2d , wcs2  , 199?, "Sega License", "World Championship Soccer II (Prototype - Mar 23, 1994)", NULL, 0, 0 )
	SOFTWARE( wcs2e , wcs2  , 199?, "Sega License", "World Championship Soccer II (Prototype - Mar 24, 1994)", NULL, 0, 0 )
	SOFTWARE( wcs2f , wcs2  , 199?, "Sega License", "World Championship Soccer II (Prototype - Mar 25, 1994)", NULL, 0, 0 )
	SOFTWARE( wcs2g , wcs2  , 199?, "Sega License", "World Championship Soccer II (Prototype - Mar 26, 1994)", NULL, 0, 0 )
	SOFTWARE( wcs2h , wcs2  , 199?, "Sega License", "World Championship Soccer II (Prototype - Mar 27, 1994)", NULL, 0, 0 )
	SOFTWARE( wcs2i , wcs2  , 199?, "Sega License", "World Championship Soccer II (Prototype - Mar 29, 1994 - B)", NULL, 0, 0 )
	SOFTWARE( wcs2j , wcs2  , 199?, "Sega License", "World Championship Soccer II (Prototype - Mar 29, 1994)", NULL, 0, 0 )
	SOFTWARE( wcs2k , wcs2  , 199?, "Sega License", "World Championship Soccer II (Prototype - Mar 30, 1994)", NULL, 0, 0 )
	SOFTWARE( wcs2l , wcs2  , 199?, "Sega License", "World Championship Soccer II (Prototype - May 23, 1994)", NULL, 0, 0 )
	SOFTWARE( wcs2m , wcs2  , 199?, "Sega License", "World Championship Soccer II (Prototype G - Feb 22, 1994)", NULL, 0, 0 )
	SOFTWARE( wcs2n , wcs2  , 199?, "Sega License", "World Championship Soccer II (Prototype J - Feb 28, 1994)", NULL, 0, 0 )
	SOFTWARE( wcs2o , wcs2  , 199?, "Sega License", "World Championship Soccer II (Prototype N - Mar 03, 1994)", NULL, 0, 0 )
	SOFTWARE( wcs2p , wcs2  , 199?, "Sega License", "World Championship Soccer II (Prototype O - Mar 03, 1994)", NULL, 0, 0 )
	SOFTWARE( wcs2q , wcs2  , 199?, "Sega License", "World Championship Soccer II (Prototype P - Mar 04, 1994)", NULL, 0, 0 )
	SOFTWARE( wcs2r , wcs2  , 199?, "Sega License", "World Championship Soccer II (Prototype R - Mar 09, 1994)", NULL, 0, 0 )
	SOFTWARE( wcs2s , wcs2  , 199?, "Sega License", "World Championship Soccer II (Prototype U - Mar 14, 1994)", NULL, 0, 0 )
	SOFTWARE( wcs2t , wcs2  , 199?, "Sega License", "World Championship Soccer II (Prototype Y - Mar 18, 1994)", NULL, 0, 0 )
	...
	SOFTWARE( wsb95a, wsb95 , 199?, "Sega License", "World Series Baseball '95 (Prototype - Dec 08, 1994)", NULL, 0, 0 )
	SOFTWARE( wsb95b, wsb95 , 199?, "Sega License", "World Series Baseball '95 (Prototype - Dec 14, 1994)", NULL, 0, 0 )
	SOFTWARE( wsb95c, wsb95 , 199?, "Sega License", "World Series Baseball '95 (Prototype - Dec 28, 1994 - SB)", NULL, 0, 0 )
	SOFTWARE( wsb95d, wsb95 , 199?, "Sega License", "World Series Baseball '95 (Prototype - Feb 02, 1995)", NULL, 0, 0 )
	SOFTWARE( wsb95e, wsb95 , 199?, "Sega License", "World Series Baseball '95 (Prototype - Feb 03, 1995)", NULL, 0, 0 )
	SOFTWARE( wsb95f, wsb95 , 199?, "Sega License", "World Series Baseball '95 (Prototype - Feb 07, 1995)", NULL, 0, 0 )
	SOFTWARE( wsb95g, wsb95 , 199?, "Sega License", "World Series Baseball '95 (Prototype - Feb 09, 1995 - B)", NULL, 0, 0 )
	SOFTWARE( wsb95h, wsb95 , 199?, "Sega License", "World Series Baseball '95 (Prototype - Feb 09, 1995)", NULL, 0, 0 )
	SOFTWARE( wsb95i, wsb95 , 199?, "Sega License", "World Series Baseball '95 (Prototype - Feb 11, 1995)", NULL, 0, 0 )
	SOFTWARE( wsb95j, wsb95 , 199?, "Sega License", "World Series Baseball '95 (Prototype - Feb 12, 1995)", NULL, 0, 0 )
	SOFTWARE( wsb95k, wsb95 , 199?, "Sega License", "World Series Baseball '95 (Prototype - Feb 13, 1995)", NULL, 0, 0 )
	SOFTWARE( wsb95l, wsb95 , 199?, "Sega License", "World Series Baseball '95 (Prototype - Feb 14, 1995)", NULL, 0, 0 )
	SOFTWARE( wsb95m, wsb95 , 199?, "Sega License", "World Series Baseball '95 (Prototype - Jan 01, 1995 - TST)", NULL, 0, 0 )
	SOFTWARE( wsb95n, wsb95 , 199?, "Sega License", "World Series Baseball '95 (Prototype - Jan 03, 1995 - TST)", NULL, 0, 0 )
	SOFTWARE( wsb95o, wsb95 , 199?, "Sega License", "World Series Baseball '95 (Prototype - Jan 05, 1995)", NULL, 0, 0 )
	SOFTWARE( wsb95p, wsb95 , 199?, "Sega License", "World Series Baseball '95 (Prototype - Jan 09, 1995 - TST)", NULL, 0, 0 )
	SOFTWARE( wsb95q, wsb95 , 199?, "Sega License", "World Series Baseball '95 (Prototype - Jan 10, 1995)", NULL, 0, 0 )
	SOFTWARE( wsb95r, wsb95 , 199?, "Sega License", "World Series Baseball '95 (Prototype - Jan 14, 1995 - RM)", NULL, 0, 0 )
	SOFTWARE( wsb95s, wsb95 , 199?, "Sega License", "World Series Baseball '95 (Prototype - Jan 16, 1995)", NULL, 0, 0 )
	SOFTWARE( wsb95t, wsb95 , 199?, "Sega License", "World Series Baseball '95 (Prototype - Jan 18, 1995 - RM)", NULL, 0, 0 )
	SOFTWARE( wsb95u, wsb95 , 199?, "Sega License", "World Series Baseball '95 (Prototype - Jan 20, 1995)", NULL, 0, 0 )
	SOFTWARE( wsb95v, wsb95 , 199?, "Sega License", "World Series Baseball '95 (Prototype - Jan 25, 1995)", NULL, 0, 0 )
	SOFTWARE( wsb95w, wsb95 , 199?, "Sega License", "World Series Baseball '95 (Prototype - Jan 30, 1995)", NULL, 0, 0 )
	...
	SOFTWARE( wsba  , wsb   , 199?, "Sega License", "World Series Baseball (Prototype - Dec 22, 1993)", NULL, 0, 0 )
	SOFTWARE( wsbb  , wsb   , 199?, "Sega License", "World Series Baseball (Prototype - Dec 26, 1993)", NULL, 0, 0 )
	SOFTWARE( wsbc  , wsb   , 199?, "Sega License", "World Series Baseball (Prototype - Dec 29, 1993)", NULL, 0, 0 )
	SOFTWARE( wsbd  , wsb   , 199?, "Sega License", "World Series Baseball (Prototype - Feb 18, 1994)", NULL, 0, 0 )
	SOFTWARE( wsbe  , wsb   , 199?, "Sega License", "World Series Baseball (Prototype - Jan 03, 1994)", NULL, 0, 0 )
	SOFTWARE( wsbf  , wsb   , 199?, "Sega License", "World Series Baseball (Prototype - Jan 06, 1994)", NULL, 0, 0 )
	SOFTWARE( wsbg  , wsb   , 199?, "Sega License", "World Series Baseball (Prototype - Jan 16, 1994)", NULL, 0, 0 )
	SOFTWARE( wsbh  , wsb   , 199?, "Sega License", "World Series Baseball (Prototype - Mar 04, 1994)", NULL, 0, 0 )
	SOFTWARE( wsbi  , wsb   , 199?, "Sega License", "World Series Baseball (Prototype - May 27, 1994)", NULL, 0, 0 )
	SOFTWARE( wsbj  , wsb   , 199?, "Sega License", "World Series Baseball (Prototype - Oct 01, 1993)", NULL, 0, 0 )
	...
	SOFTWARE( wukong, 0,        199?, "Sega License", "Wu Kong Wai Zhuan (China) (Unl)", NULL, 0, 0 )
	...
	SOFTWARE( xmen2a, xmen2 , 199?, "Sega License", "X-Men 2 - Clone Wars (Prototype - Dec 02, 1994)", NULL, 0, 0 )
	SOFTWARE( xmen2b, xmen2 , 199?, "Sega License", "X-Men 2 - Clone Wars (Prototype - Dec 03, 1994)", NULL, 0, 0 )
	SOFTWARE( xmen2c, xmen2 , 199?, "Sega License", "X-Men 2 - Clone Wars (Prototype - Dec 06, 1994)", NULL, 0, 0 )
	SOFTWARE( xmen2d, xmen2 , 199?, "Sega License", "X-Men 2 - Clone Wars (Prototype - Dec 07, 1994)", NULL, 0, 0 )
	SOFTWARE( xmen2e, xmen2 , 199?, "Sega License", "X-Men 2 - Clone Wars (Prototype - Dec 08, 1994)", NULL, 0, 0 )
	SOFTWARE( xmen2f, xmen2 , 199?, "Sega License", "X-Men 2 - Clone Wars (Prototype - Dec 09, 1994)", NULL, 0, 0 )
	SOFTWARE( xmen2g, xmen2 , 199?, "Sega License", "X-Men 2 - Clone Wars (Prototype - Dec 10, 1994)", NULL, 0, 0 )
	SOFTWARE( xmen2h, xmen2 , 199?, "Sega License", "X-Men 2 - Clone Wars (Prototype - Dec 11, 1994 - A)", NULL, 0, 0 )
	SOFTWARE( xmen2i, xmen2 , 199?, "Sega License", "X-Men 2 - Clone Wars (Prototype - Dec 11, 1994)", NULL, 0, 0 )
	SOFTWARE( xmen2j, xmen2 , 199?, "Sega License", "X-Men 2 - Clone Wars (Prototype - Dec 14, 1994)", NULL, 0, 0 )
	SOFTWARE( xmen2k, xmen2 , 199?, "Sega License", "X-Men 2 - Clone Wars (Prototype - Dec 15, 1994)", NULL, 0, 0 )
	SOFTWARE( xmen2l, xmen2 , 199?, "Sega License", "X-Men 2 - Clone Wars (Prototype - Dec 16, 1994)", NULL, 0, 0 )
	SOFTWARE( xmen2m, xmen2 , 199?, "Sega License", "X-Men 2 - Clone Wars (Prototype - May 06, 1994)", NULL, 0, 0 )
	SOFTWARE( xmen2n, xmen2 , 199?, "Sega License", "X-Men 2 - Clone Wars (Prototype - May 10, 1994)", NULL, 0, 0 )
	SOFTWARE( xmen2o, xmen2 , 199?, "Sega License", "X-Men 2 - Clone Wars (Prototype - Nov 17, 1994)", NULL, 0, 0 )
	SOFTWARE( xmen2p, xmen2 , 199?, "Sega License", "X-Men 2 - Clone Wars (Prototype - Nov 23, 1994)", NULL, 0, 0 )
	SOFTWARE( xmen2q, xmen2 , 199?, "Sega License", "X-Men 2 - Clone Wars (Prototype - Nov 28, 1994)", NULL, 0, 0 )
	SOFTWARE( xmen2r, xmen2 , 199?, "Sega License", "X-Men 2 - Clone Wars (Prototype - Nov 30, 1994)", NULL, 0, 0 )
	SOFTWARE( xmen2s, xmen2 , 199?, "Sega License", "X-Men 2 - Clone Wars (Prototype - Oct 18, 1994)", NULL, 0, 0 )

	SOFTWARE( xpert , 0,        199?, "Sega License", "X-Perts", REGION_U, 0, 0 )
	SOFTWARE( xpertp, xpert , 199?, "Sega License", "X-perts (Prototype)", NULL, 0, 0 )
	...
	SOFTWARE( xiaomo, 0,        199?, "Sega License", "Xiao Monv - Magic Girl (China) (Unl)", NULL, 0, 0 )

	SOFTWARE( xinqig, 0,        199?, "Sega License", "Xin Qi Gai Wang Zi (China) (Alt) (Unl)", NULL, 0, 0 )
	SOFTWARE( xinqi1, xinqig, 199?, "Sega License", "Xin Qi Gai Wang Zi (China) (Unl)", NULL, 0, 0 )

	SOFTWARE( yasech, 0,        199?, "Sega License", "Ya Se Chuan Shuo (China) (Unl)", NULL, 0, 0 )

	SOFTWARE( yangji, 0,        199?, "Sega License", "Yang Jia Jiang - Yang Warrior Family (China) (Unl)", NULL, 0, 0 )
	...
	SOFTWARE( yindya, yindy , 199?, "Sega License", "Young Indiana Jones - Instrument of Chaos (Prototype - Dec 29, 1994)", NULL, 0, 0 )
	SOFTWARE( yindyb, yindy , 199?, "Sega License", "Young Indiana Jones - Instrument of Chaos (Prototype - Dec 28, 1994 - A)", NULL, 0, 0 )
	SOFTWARE( yindyc, yindy , 199?, "Sega License", "Young Indiana Jones - Instrument of Chaos (Prototype - Jan 01, 1994)", NULL, 0, 0 )
	SOFTWARE( yindyd, yindy , 199?, "Sega License", "Young Indiana Jones - Instrument of Chaos (Prototype - Jan 03, 1994)", NULL, 0, 0 )
	SOFTWARE( yindye, yindy , 199?, "Sega License", "Young Indiana Jones - Instrument of Chaos (Prototype - Jan 26, 1994)", NULL, 0, 0 )
	SOFTWARE( yindyf, yindy , 199?, "Sega License", "Young Indiana Jones - Instrument of Chaos (Prototype - Jan 27, 1994)", NULL, 0, 0 )
	SOFTWARE( yindyg, yindy , 199?, "Sega License", "Young Indiana Jones - Instrument of Chaos (Prototype - Sep 23, 1994 - A)", NULL, 0, 0 )
	SOFTWARE( yindyh, yindy , 199?, "Sega License", "Young Indiana Jones - Instrument of Chaos (Prototype - Dec 28, 1993)", NULL, 0, 0 )
	...
	SOFTWARE( zhuogu, 0,        199?, "Sega License", "Zhuo Gui Da Shi - Ghost Hunter (China) (Unl)", NULL, 0, 0 )
	...
	/* to sort */
	SOFTWARE( truc96, 0       , 1996,   "Miky", "Truco '96 (Argentina)", NULL, 0, 0 )
	SOFTWARE( tc2000, 0,        199?,   "unlicensed", "TC 2000 (Unl) (Argentina)", NULL, 0, 0 ) // based on SMGP code
	SOFTWARE( unknown, 0,        199?, "Sega License", "Unknown Chinese Game 1 (Ch)", NULL, 0, 0 )
	/* radica */
	SOFTWARE( radicav1, 0       , 2004,   "Radica Games / Sega", "Radica: Volume 1 (Sonic the Hedgehog, Altered Beast, Golden Axe, Dr. Robotnik's Mean Bean Machine, Kid Chameleon, Flicky) (US)", NULL, 0, 0 )
	SOFTWARE( radicasf, 0       , 2004,   "Radica Games / Capcom", "Radica: Street Fighter Pack (Street Fighter 2' Special Champion Edition, Ghouls and Ghosts) (EURO)", NULL, 0, 0 )
SOFTWARE_LIST_END
...
MEGADRIVE_ROM_LOAD( flavio, "debug flavio's dma test (pd).bin",                                                           0x000000 , 0x4000,	  CRC(549cebf4) SHA1(c44f0037a6856bd52a212b26ea416501e92f7645) )
	SOFTWARE( debugc, 0,        199?, "Sega License", "DEBUG - Charles Window Bug Example (PD)", NULL, 0, 0 )
	SOFTWARE( flavio, 0,        199?, "Sega License", "DEBUG Flavio's DMA Test (PD)", NULL, 0, 0 )
#endif
