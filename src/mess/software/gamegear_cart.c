...
SOFTWARE_LIST_START ( gamegear_cart )
	...
	SOFTWARE( aerialasj, aerialas, 199?, "Sega License", "Aerial Assault (v1.1) (Jpn)", 0, 0 )
	...
	SOFTWARE( aladdin, 0       , 199?, "Sega License", "Aladdin (Euro, USA)", 0, 0 )
	SOFTWARE( alien3, 0       , 199?, "Sega License", "Alien 3 (Euro, USA)", 0, 0 )
	SOFTWARE( asyndromj, asyndrom, 199?, "Sega License", "Alien Syndrome (Jpn)", 0, 0 )
	...
	SOFTWARE( arliel, 0       , 199?, "Sega License", "Arliel - Crystal Densetsu (Jpn)", 0, 0 )
	...
	SOFTWARE( axbattlrj, axbattlr, 199?, "Sega License", "Ax Battler - Golden Axe Densetsu (v1.5) (Jpn)", 0, 0 )
	SOFTWARE( ayrtonj, ayrton, 199?, "Sega License", "Ayrton Senna's Super Monaco GP II (Jpn)", 0, 0 )
	...
	SOFTWARE( bakubakuj, 0       , 199?, "Sega License", "Baku Baku Animal - Sekai Shiikugakari Senshu-ken (Jpn)", 0, 0 )
	...
	SOFTWARE( batmanfv, 0       , 199?, "Sega License", "Batman Forever (World)", 0, 0 )
	SOFTWARE( batmanrn, 0       , 199?, "Sega License", "Batman Returns (World)", 0, 0 )
	SOFTWARE( batterup, 0       , 199?, "Sega License", "Batter Up (Euro, USA)", 0, 0 )
	SOFTWARE( battlesh, 0       , 199?, "Sega License", "Battleship (Euro, USA)", 0, 0 )
	SOFTWARE( btoads, 0       , 199?, "Sega License", "Battletoads (Euro, Jpn)", 0, 0 )
	SOFTWARE( btoadsu, 0       , 199?, "Sega License", "Battletoads (USA)", 0, 0 )
	...
	SOFTWARE( berlin, 0       , 199?, "Sega License", "Berlin no Kabe (Jpn)", 0, 0 )
	SOFTWARE( bishou, 0       , 199?, "Sega License", "Bishoujo Senshi Sailor Moon S (Jpn)", 0, 0 )
	...
	SOFTWARE( busterb, 0       , 199?, "Sega License", "Buster Ball (Jpn)", 0, 0 )
	SOFTWARE( busterf, 0       , 199?, "Sega License", "Buster Fight (Jpn)", 0, 0 )
	...
	SOFTWARE( carlicen, 0       , 199?, "Sega License", "Car Licence (Jpn)", 0, 0 )
	...
	SOFTWARE( chuckrck, 0       , 199?, "Sega License", "Chuck Rock (World)", 0, 0 )
	...
	SOFTWARE( cocakid, 0       , 199?, "Sega License", "Coca Cola Kid (Jpn)", 0, 0 )
	SOFTWARE( columnsj, columns, 199?, "Sega License", "Columns (Jpn)", 0, 0 )
	...
	SOFTWARE( crayon, 0       , 199?, "Sega License", "Crayon Shin-chan - Taiketsu! Kantam Panic!! (Jpn)", 0, 0 )
	...
	SOFTWARE( devilishj, devilish, 199?, "Sega License", "Devilish (Jpn)", 0, 0 )
	SOFTWARE( devilishu, devilish, 199?, "Sega License", "Devilish (USA)", 0, 0 )
	SOFTWARE( donald42, 0       , 199?, "Sega License", "Donald Duck no 4-Tsu no Hihou (Jpn)", 0, 0 )
	SOFTWARE( donaldld, 0       , 199?, "Sega License", "Donald Duck no Lucky Dime (Jpn)", 0, 0 )
	SOFTWARE( donaldmw, 0       , 199?, "Sega License", "Donald no Magical World (En, Ja) (Jpn)", 0, 0 )
	SOFTWARE( doraemon, 0       , 199?, "Sega License", "Doraemon - Waku Waku Pocket Paradise (Jpn)", 0, 0 )
	...
	SOFTWARE( dragoncrj, dragoncr, 199?, "Sega License", "Dragon Crystal - Tsurani no Meikyuu (Jpn)", 0, 0 )
	SOFTWARE( dropzone, 0       , 199?, "Sega License", "Dropzone (Euro)", 0, 0 )
	SOFTWARE( dunkkids, 0       , 199?, "Sega License", "Dunk Kids (Jpn)", 0, 0 )
	SOFTWARE( dynaheadj, dynahead, 199?, "Sega License", "Dynamite Headdy (Jpn)", 0, 0 )
	...
	SOFTWARE( eternall, 0       , 199?, "Sega License", "Eternal Legend - Eien no Densetsu (Jpn)", 0, 0 )
	...
	SOFTWARE( faceball, 0       , 199?, "Sega License", "Faceball 2000 (Jpn)", 0, 0 )
	...
	SOFTWARE( fantzone, 0       , 199?, "Sega License", "Fantasy Zone Gear (Euro, Jpn)", 0, 0 )
	...
	SOFTWARE( fifaj, fifa, 199?, "Sega License", "FIFA International Soccer (Jpn)", 0, 0 )
	...
	SOFTWARE( fray, 0       , 199?, "Sega License", "Fray - Shugyou Hen (Jpn)", 0, 0 )
	SOFTWARE( fredcoupj, fredcoup, 199?, "Sega License", "Fred Couples' Golf (Jpn)", 0, 0 )
	SOFTWARE( fredcoup, 0       , 199?, "Sega License", "Fred Couples' Golf (USA)", 0, 0 )
	SOFTWARE( frogger, 0       , 199?, "Sega License", "Frogger (Proto) (USA)", 0, 0 )
	SOFTWARE( slamdunk, 0       , 199?, "Sega License", "From TV Animation - Slam Dunk - Shouri e no Starting 5 (Jpn)", 0, 0 )
	SOFTWARE( glocairj, glocair, 199?, "Sega License", "G-LOC Air Battle (v1.1) (Jpn)", 0, 0 )
	...
	SOFTWARE( galaga91, 0       , 199?, "Sega License", "Galaga '91 (Jpn)", 0, 0 )
	SOFTWARE( galaga2, 0       , 199?, "Sega License", "Galaga 2 (Euro)", 0, 0 )
	SOFTWARE( gamble, 0       , 199?, "Sega License", "Gamble Panic (Jpn)", 0, 0 )
	SOFTWARE( gambler, 0       , 199?, "Sega License", "Gambler Jikochuushinha (Jpn)", 0, 0 )
	SOFTWARE( ganbare, 0       , 199?, "Sega License", "Ganbare Gorby! (Jpn)", 0, 0 )
	SOFTWARE( garfield, 0       , 199?, "Sega License", "Garfield - Caught in the Act (Euro, USA)", 0, 0 )
	SOFTWARE( garou, 0       , 199?, "Sega License", "Garou Densetsu Special (Jpn)", 0, 0 )
	SOFTWARE( gearstad, 0       , 199?, "Sega License", "Gear Stadium (Jpn)", 0, 0 )
	SOFTWARE( gearstah, 0       , 199?, "Sega License", "Gear Stadium Heiseiban (Jpn)", 0, 0 )
	...
	SOFTWARE( ggaleste, 0       , 199?, "Sega License", "GG Aleste (Jpn)", 0, 0 )
	SOFTWARE( ggdora, 0       , 199?, "Sega License", "GG Doraemon - Noranosuke no Yabou (Jpn)", 0, 0 )
	SOFTWARE( ggport, 0       , 199?, "Sega License", "GG Portrait - Pai Chen (Jpn)", 0, 0 )
	SOFTWARE( ggport1, 0       , 199?, "Sega License", "GG Portrait - Yuuki Akira (Jpn)", 0, 0 )
	SOFTWARE( ggshinob, 0       , 199?, "Sega License", "The GG Shinobi (Jpn)", 0, 0 )
	SOFTWARE( godzilla, 0       , 199?, "Sega License", "Godzilla - Kaijuu Daishingeki (Jpn)", 0, 0 )
	SOFTWARE( gpriderj, gprider, 199?, "Sega License", "GP Rider (Jpn)", 0, 0 )
	...
	SOFTWARE( griffin, 0       , 199?, "Sega License", "Griffin (Jpn)", 0, 0 )
	SOFTWARE( gunstar, 0       , 199?, "Sega License", "Gunstar Heroes (Jpn)", 0, 0 )
	SOFTWARE( halleywj, halleyw, 199?, "Sega License", "Halley Wars (Jpn)", 0, 0 )
	SOFTWARE( halleyw, 0       , 199?, "Sega License", "Halley Wars (Euro, USA)", 0, 0 )
	SOFTWARE( headbust, 0       , 199?, "Sega License", "Head Buster (Jpn)", 0, 0 )
	SOFTWARE( heavywc, 0       , 199?, "Sega License", "Heavy Weight Champ (Jpn)", 0, 0 )
	SOFTWARE( homea, 0       , 199?, "Sega License", "Home Alone (Euro, USA)", 0, 0 )
	SOFTWARE( honoo, 0       , 199?, "Sega License", "Honoo no Toukyuuji - Dodge Danpei (Jpn)", 0, 0 )
	SOFTWARE( hook, 0       , 199?, "Sega License", "Hook (Euro, USA)", 0, 0 )
	SOFTWARE( hurric, 0       , 199?, "Sega License", "Hurricanes (Euro)", 0, 0 )
	SOFTWARE( hyokkori, 0       , 199?, "Sega License", "Hyokkori Hyoutan Jima - Hyoutan Jima no Daikoukai (Jpn)", 0, 0 )
	SOFTWARE( hypery92, 0       , 199?, "Sega License", "Hyper Pro Yakyuu '92 (Jpn)", 0, 0 )
	SOFTWARE( ichirgg, 0       , 199?, "Sega License", "Ichidant~R GG (Jpn)", 0, 0 )
	SOFTWARE( wakevamp, 0       , 199?, "Sega License", "In the Wake of Vampire (Jpn)", 0, 0 )
	...
	SOFTWARE( jleagu94, 0       , 199?, "Sega License", "J.League GG Pro Striker '94 (Jpn)", 0, 0 )
	SOFTWARE( jleague, 0       , 199?, "Sega License", "J.League Soccer - Dream Eleven (Jpn)", 0, 0 )
	...
	SOFTWARE( joemontj, joemont, 199?, "Sega License", "Joe Montana's Football (Jpn)", 0, 0 )
	...
	SOFTWARE( jurassicj, jurassic, 199?, "Sega License", "Jurassic Park (Jpn)", 0, 0 )
	SOFTWARE( jurassic, 0       , 199?, "Sega License", "Jurassic Park (Euro, USA)", 0, 0 )
	SOFTWARE( kaitou, 0       , 199?, "Sega License", "Kaitou Saint Tale (Jpn)", 0, 0 )
	SOFTWARE( kawasaki, 0       , 199?, "Sega License", "Kawasaki Superbike Challenge (Euro, USA)", 0, 0 )
	SOFTWARE( kenyuu, 0       , 199?, "Sega License", "Kenyuu Densetsu Yaiba (Jpn)", 0, 0 )
	SOFTWARE( kickrush, 0       , 199?, "Sega License", "Kick & Rush (Jpn)", 0, 0 )
	SOFTWARE( kineticc, 0       , 199?, "Sega License", "Kinetic Connection (Jpn)", 0, 0 )
	SOFTWARE( kishin, 0       , 199?, "Sega License", "Kishin Douji Zenki (Jpn)", 0, 0 )
	SOFTWARE( klax, 0       , 199?, "Sega License", "Klax (Euro, USA)", 0, 0 )
	SOFTWARE( krusty, 0       , 199?, "Sega License", "Krusty's Fun House (Euro, USA)", 0, 0 )
	SOFTWARE( kunichan, 0       , 199?, "Sega License", "Kuni-chan no Game Tengoku (Jpn)", 0, 0 )
	SOFTWARE( kunichn2, 0       , 199?, "Sega License", "Kuni-chan no Game Tengoku Part 2 (Jpn)", 0, 0 )
	...
	SOFTWARE( lemmings, 0       , 199?, "Sega License", "Lemmings (World)", 0, 0 )
	...
	SOFTWARE( lunar, 0       , 199?, "Sega License", "Lunar - Sanposuru Gakuen (Jpn)", 0, 0 )
	...
	SOFTWARE( madoumna, 0       , 199?, "Sega License", "Madou Monogatari A - Dokidoki Vacation (Jpn)", 0, 0 )
	SOFTWARE( madoumon, 0       , 199?, "Sega License", "Madou Monogatari I - 3-Tsu no Madoukyuu (Jpn)", 0, 0 )
	SOFTWARE( madoumn2, 0       , 199?, "Sega License", "Madou Monogatari II - Arle 16-Sai (Jpn)", 0, 0 )
	SOFTWARE( madoumn3, 0       , 199?, "Sega License", "Madou Monogatari III - Kyuukyoku Joou-sama (v1.1) (Jpn)", 0, 0 )
	SOFTWARE( madoumn3a, madoumn3, 199?, "Sega License", "Madou Monogatari III - Kyuukyoku Joou-sama (Jpn)", 0, 0 )
	SOFTWARE( magicray, 0       , 199?, "Sega License", "Magic Knight Rayearth (Jpn)", 0, 0 )
	SOFTWARE( magicry2, 0       , 199?, "Sega License", "Magic Knight Rayearth 2 - Making of Magic Knight (Jpn)", 0, 0 )
	SOFTWARE( magiclpp, 0       , 199?, "Sega License", "Magical Puzzle Popils (En, Ja) (World)", 0, 0 )
	SOFTWARE( magical, 0       , 199?, "Sega License", "Magical Taruruuto-kun (Jpn)", 0, 0 )
	SOFTWARE( majors, 0       , 199?, "Sega License", "The Majors Pro Baseball (USA)", 0, 0 )
	SOFTWARE( mappy, 0       , 199?, "Sega License", "Mappy (Jpn)", 0, 0 )
	...
	SOFTWARE( lastbibl, 0       , 199?, "Sega License", "Megami Tensei Gaiden - Last Bible (Jpn)", 0, 0 )
	SOFTWARE( lastbibs, 0       , 199?, "Sega License", "Megami Tensei Gaiden - Last Bible S (Jpn)", 0, 0 )
	SOFTWARE( mickmack, 0       , 199?, "Sega License", "Mick & Mack as the Global Gladiators (Euro, USA)", 0, 0 )
	SOFTWARE( legndillj, legndill, 199?, "Sega License", "Mickey Mouse Densetsu no Oukoku - Legend of Illusion (Jpn)", 0, 0 )
	SOFTWARE( castlillj, castlill, 199?, "Sega License", "Mickey Mouse no Castle Illusion (SMS Mode?) (Jpn)", 0, 0 )
	SOFTWARE( mickeymc, 0       , 199?, "Sega License", "Mickey Mouse no Mahou no Crystal (Jpn)", 0, 0 )
	...
	SOFTWARE( moldoran, 0       , 199?, "Sega License", "Moldorian - Hikari to Yami no Sister (Jpn)", 0, 0 )
	SOFTWARE( monstert, 0       , 199?, "Sega License", "Monster Truck Wars (Euro, USA)", 0, 0 )
	SOFTWARE( monstwld2, 0       , 199?, "Sega License", "Monster World II - Dragon no Wana (Jpn)", 0, 0 )
	SOFTWARE( mkj,   mk,    199?, "Sega License", "Mortal Kombat (v3.3) (Jpn)", 0, 0 )
	...
	SOFTWARE( nazpuyo, 0       , 199?, "Sega License", "Nazo Puyo (Jpn)", 0, 0 )
	SOFTWARE( nazpuyo2, 0       , 199?, "Sega License", "Nazo Puyo 2 (Jpn)", 0, 0 )
	SOFTWARE( nazpyoar1, nazpyoar, 199?, "Sega License", "Nazo Puyo Arle no Roux (Development Edition) (Jpn)", 0, 0 )
	SOFTWARE( nazpyoar, 0       , 199?, "Sega License", "Nazo Puyo Arle no Roux (Jpn)", 0, 0 )
	...
	SOFTWARE( nekodais, 0       , 199?, "Sega License", "Neko Daisuki! (Jpn)", 0, 0 )
	...
	SOFTWARE( nflquart, 0       , 199?, "Sega License", "NFL Quarterback Club (World)", 0, 0 )
	...
	SOFTWARE( ninjagj, ninjag, 199?, "Sega License", "Ninja Gaiden (Jpn)", 0, 0 )
	SOFTWARE( ninjag, 0       , 199?, "Sega License", "Ninja Gaiden (Euro, USA)", 0, 0 )
	SOFTWARE( ninku, 0       , 199?, "Sega License", "Ninku (Jpn)", 0, 0 )
	SOFTWARE( ninku2, 0       , 199?, "Sega License", "Ninku 2 - Tenkuuryuu e no Michi (Jpn)", 0, 0 )
	SOFTWARE( ninkug, 0       , 199?, "Sega License", "Ninku Gaiden - Hiroyuki Daikatsugeki (Jpn)", 0, 0 )
	SOFTWARE( nomohide, 0       , 199?, "Sega License", "Nomo Hideo no World Series Baseball (Jpn)", 0, 0 )
	SOFTWARE( olympi, 0       , 199?, "Sega License", "Olympic Gold (En, Fr, De, Es, It, Nl, Pt, Sv) (v1.1) (SMS Mode?) (Euro)", 0, 0 )
	SOFTWARE( olympiju, olympi, 199?, "Sega License", "Olympic Gold (En, Fr, De, Es, It, Nl, Pt, Sv) (SMS Mode?) (Jpn, USA)", 0, 0 )
	SOFTWARE( ottifant, 0       , 199?, "Sega License", "The Ottifants (En, Fr, De, Es, It) (Euro)", 0, 0 )
	SOFTWARE( outrunj, outrun, 199?, "Sega License", "Out Run (Jpn)", 0, 0 )
	SOFTWARE( outruneu, 0       , 199?, "Sega License", "Out Run Europa (SMS Mode?) (Euro, USA)", 0, 0 )
	SOFTWARE( outrun, 0       , 199?, "Sega License", "OutRun (Alt) (Jpn, USA)", 0, 0 )
	...
	SOFTWARE( pacman, 0       , 199?, "Sega License", "Pac-Man (Jpn)", 0, 0 )
	SOFTWARE( panzer, 0       , 199?, "Sega License", "Panzer Dragoon Mini (Jpn)", 0, 0 )
	SOFTWARE( paperboy, 0       , 199?, "Sega License", "Paperboy (Euro, USA)", 0, 0 )
	SOFTWARE( paperby2, 0       , 199?, "Sega License", "Paperboy II (Euro, USA)", 0, 0 )
	SOFTWARE( pengoj, 0       , 199?, "Sega License", "Pengo (Jpn)", 0, 0 )
	SOFTWARE( pengo, pengo, 199?, "Sega License", "Pengo (Euro, USA)", 0, 0 )
	SOFTWARE( petclub, 0       , 199?, "Sega License", "Pet Club Inu Daisuki! (Jpn)", 0, 0 )
	...
	SOFTWARE( pstaradv, 0       , 199?, "Sega License", "Phantasy Star Adventure (Jpn)", 0, 0 )
	SOFTWARE( pstargai, 0       , 199?, "Sega License", "Phantasy Star Gaiden (Jpn)", 0, 0 )
	SOFTWARE( phantom, 0       , 199?, "Sega License", "Phantom 2040 (Euro, USA)", 0, 0 )
	SOFTWARE( pinballd, 0       , 199?, "Sega License", "Pinball Dreams (USA)", 0, 0 )
	SOFTWARE( pocketj, 0       , 199?, "Sega License", "Pocket Jansou (Jpn)", 0, 0 )
	...
	SOFTWARE( popbreak, 0       , 199?, "Sega License", "Pop Breaker (Jpn)", 0, 0 )
	SOFTWARE( popeye, 0       , 199?, "Sega License", "Popeye no Beach Volleyball (Jpn)", 0, 0 )
	SOFTWARE( pstrike2, 0       , 199?, "Sega License", "Power Strike II (Euro, Jpn)", 0, 0 )
	...
	SOFTWARE( proyak91, 0       , 199?, "Sega License", "The Pro Yakyuu '91 (Jpn)", 0, 0 )
	SOFTWARE( proyak94, 0       , 199?, "Sega License", "Pro Yakyuu GG League '94 (Jpn)", 0, 0 )
	SOFTWARE( proyakgg, 0       , 199?, "Sega License", "Pro Yakyuu GG League (Jpn)", 0, 0 )
	SOFTWARE( psychicwj, psychicw, 199?, "Sega License", "Psychic World (Jpn)", 0, 0 )
	SOFTWARE( psychicw, 0       , 199?, "Sega License", "Psychic World (v1.1) (Euro, USA)", 0, 0 )
	SOFTWARE( puttputtj, puttputt, 199?, "Sega License", "Putt & Putter (Jpn)", 0, 0 )
	SOFTWARE( puttputt, 0       , 199?, "Sega License", "Putt & Putter (Euro, USA)", 0, 0 )
	SOFTWARE ( puyopuyo, 0       , 199?, "Sega License", "Puyo Puyo (Jpn)", 0, 0 )
	SOFTWARE( puyopyo2, 0       , 199?, "Sega License", "Puyo Puyo 2 (Jpn)", 0, 0 )
	SOFTWARE( tantor, 0       , 199?, "Sega License", "Puzzle and Action Tanto-R (Jpn)", 0, 0 )
	SOFTWARE( pbobble, 0       , 199?, "Sega License", "Puzzle Bobble (Jpn)", 0, 0 )
	SOFTWARE( questf, 0       , 199?, "Sega License", "Quest for the Shaven Yak Starring Ren Hoek & Stimpy (Euro, USA)", 0, 0 )
	SOFTWARE( quizgear, 0       , 199?, "Sega License", "The Quiz Gear Fight!! (Jpn)", 0, 0 )
	...
	SOFTWARE( rastansg, 0       , 199?, "Sega License", "Rastan Saga (SMS Mode?) (Jpn)", 0, 0 )
	SOFTWARE( revenged, 0       , 199?, "Sega License", "Revenge of Drancon (USA)", 0, 0 )
	SOFTWARE( riddickj, riddick, 199?, "Sega License", "Riddick Bowe Boxing (Jpn)", 0, 0 )
	...
	SOFTWARE( ristar, 0       , 199?, "Sega License", "Ristar - The Shooting Star (World)", 0, 0 )
	...
	SOFTWARE( royalstn, 0       , 199?, "Sega License", "Royal Stone - Hirakareshi Toki no Tobira (Jpn)", 0, 0 )
	SOFTWARE( ryuukyuu, 0       , 199?, "Sega License", "Ryuukyuu (Jpn)", 0, 0 )
	...
	SOFTWARE( samspi, 0       , 199?, "Sega License", "Samurai Spirits (Jpn)", 0, 0 )
	SOFTWARE( scratchg, 0       , 199?, "Sega License", "Scratch Golf (Jpn)", 0, 0 )
	SOFTWARE( sdgundam, 0       , 199?, "Sega License", "SD Gundam - Winner's History (Jpn)", 0, 0 )
	...
	SOFTWARE( shadam, 0       , 199?, "Sega License", "Shadam Crusader - Harukanaru Oukoku (Jpn)", 0, 0 )
	SOFTWARE( shangh2, 0       , 199?, "Sega License", "Shanghai II (Jpn)", 0, 0 )
	SOFTWARE( shaqfu, 0       , 199?, "Sega License", "Shaq Fu (Euro, USA)", 0, 0 )
	SOFTWARE( shikinjo, 0       , 199?, "Sega License", "Shikinjou (Jpn)", 0, 0 )
	SOFTWARE( shinfrcg, 0       , 199?, "Sega License", "Shining Force Gaiden - Ensei, Jashin no Kuni e (Jpn)", 0, 0 )
	SOFTWARE( shinfrgf, 0       , 199?, "Sega License", "Shining Force Gaiden - Final Conflict (Jpn)", 0, 0 )
	SOFTWARE( shinfrg2, 0       , 199?, "Sega License", "Shining Force Gaiden II - Jashin no Kakusei (Jpn)", 0, 0 )
	...
	SOFTWARE( skweek, 0       , 199?, "Sega License", "Skweek (Jpn)", 0, 0 )
	...
	SOFTWARE( sonictls, 0       , 199?, "Sega License", "Sonic & Tails (Jpn)", 0, 0 )
	SOFTWARE( sonictl2, 0       , 199?, "Sega License", "Sonic & Tails 2 (Jpn)", 0, 0 )
	...
	SOFTWARE( sonicbls, 0       , 199?, "Sega License", "Sonic Blast (World)", 0, 0 )
	SOFTWARE( sonicc, 0       , 199?, "Sega License", "Sonic Chaos (Euro, USA)", 0, 0 )
	SOFTWARE( sonicdrs, sonicdr, 199?, "Sega License", "Sonic Drift (Sample) (Jpn)", 0, 0 )
	SOFTWARE( sonicdr, 0       , 199?, "Sega License", "Sonic Drift (Jpn)", 0, 0 )
	SOFTWARE( sonicdr2, 0       , 199?, "Sega License", "Sonic Drift 2 (Jpn, USA)", 0, 0 )
	SOFTWARE( soniclab, 0       , 199?, "Sega License", "Sonic Labyrinth (World)", 0, 0 )
	...
	SOFTWARE( sonicj, sonic, 199?, "Sega License", "Sonic The Hedgehog (Jpn)", 0, 0 )
	...
	SOFTWARE( sonic2, 0       , 199?, "Sega License", "Sonic The Hedgehog 2 (World)", 0, 0 )
	SOFTWARE( soukoban, 0       , 199?, "Sega License", "Soukoban (Jpn)", 0, 0 )
	SOFTWARE( sharr, 0       , 199?, "Sega License", "Space Harrier (World)", 0, 0 )
	...
	SOFTWARE( stargate, 0       , 199?, "Sega License", "Stargate (World)", 0, 0 )
	SOFTWARE( sor, 0       , 199?, "Sega License", "Streets of Rage (World)", 0, 0 )
	SOFTWARE( sor2, 0       , 199?, "Sega License", "Streets of Rage II (World)", 0, 0 )
	...
	SOFTWARE( supercolj, supercol, 199?, "Sega License", "Super Columns (Jpn)", 0, 0 )
	...
	SOFTWARE( superglf, 0       , 199?, "Sega License", "Super Golf (Jpn)", 0, 0 )
	SOFTWARE( suprkick, 0       , 199?, "Sega License", "Super Kick Off (SMS Mode?) (Jpn)", 0, 0 )
	SOFTWARE( supermd2, 0       , 199?, "Sega License", "Super Momotarou Dentetsu III (Jpn)", 0, 0 )
	SOFTWARE( smgpj, 0       , 199?, "Sega License", "Super Monaco GP (Jpn)", 0, 0 )
	...
	SOFTWARE( sylvan, 0       , 199?, "Sega License", "Sylvan Tale (Jpn)", 0, 0 )
	SOFTWARE( t2ag, 0       , 199?, "Sega License", "T2 - The Arcade Game (Euro, USA)", 0, 0 )
	SOFTWARE( tailsadv, 0       , 199?, "Sega License", "Tails Adventures (En, Ja) (World)", 0, 0 )
	SOFTWARE( tailskyp, 0       , 199?, "Sega License", "Tails no Skypatrol (Jpn)", 0, 0 )
	SOFTWARE( taisnmj, 0       , 199?, "Sega License", "Taisen Mahjong HaoPai (Jpn)", 0, 0 )
	SOFTWARE( taisnmj2, 0       , 199?, "Sega License", "Taisen Mahjong HaoPai 2 (Jpn)", 0, 0 )
	SOFTWARE( taisendg, 0       , 199?, "Sega License", "Taisen-gata Daisenryaku G (Jpn)", 0, 0 )
	SOFTWARE( chasehq, 0       , 199?, "Sega License", "Taito Chase H.Q. (SMS Mode) (Jpn)", 0, 0 )
	...
	SOFTWARE( tamalymp, 0       , 199?, "Sega License", "Tama & Friends Sanchoume Kouen - Tamalympic (Jpn)", 0, 0 )
	SOFTWARE( tarot, 0       , 199?, "Sega License", "Tarot no Yakata (Jpn)", 0, 0 )
	SOFTWARE( tarzan, 0       , 199?, "Sega License", "Tarzan - Lord of the Jungle (Euro)", 0, 0 )
	SOFTWARE( tatakae, 0       , 199?, "Sega License", "Tatakae! Pro Yakyuu Twin League (Jpn)", 0, 0 )
	...
	SOFTWARE( tempojr, 0       , 199?, "Sega License", "Tempo Jr. (World)", 0, 0 )
	...
	SOFTWARE( torarete, 0       , 199?, "Sega License", "Torarete Tamaruka (Jpn)", 0, 0 )
	SOFTWARE( truelies, 0       , 199?, "Sega License", "True Lies (World)", 0, 0 )
	SOFTWARE( ultimate, 0       , 199?, "Sega License", "Ultimate Soccer (En, Fr, De, Es, It) (Euro, Jpn)", 0, 0 )
	...
	SOFTWARE( vfmini, 0       , 199?, "Sega License", "Virtua Fighter Mini (Jpn)", 0, 0 )
	SOFTWARE( vrtroop, 0       , 199?, "Sega License", "VR Troopers (Euro, USA)", 0, 0 )
	SOFTWARE( waganlnd, 0       , 199?, "Sega License", "Wagan Land (Jpn)", 0, 0 )
	...
	SOFTWARE( wimbledn, 0       , 199?, "Sega License", "Wimbledon (World)", 0, 0 )
	SOFTWARE( winterolj, winterol, 199?, "Sega License", "Winter Olympics - Lillehammer '94 (En, Fr, De, Es, It, Pt, Sv, No) (Jpn)", 0, 0 )
	...
	SOFTWARE( wboyj, wboy, 199?, "Sega License", "Wonder Boy (Jpn)", 0, 0 )
	...
	SOFTWARE( wderby, 0       , 199?, "Sega License", "World Derby (Jpn)", 0, 0 )
	...
	SOFTWARE( yuyuhaku, 0       , 199?, "Sega License", "Yu Yu Hakusho - Horobishimono no Gyakushuu (Jpn)", 0, 0 )
	SOFTWARE( yuyuhak2, 0       , 199?, "Sega License", "Yu Yu Hakusho 2 - Gekitou! Nanakyou no Tatakai (Jpn)", 0, 0 )
	SOFTWARE( zangear, 0       , 199?, "Sega License", "Zan Gear (Jpn)", 0, 0 )
	SOFTWARE( zool, 0       , 199?, "Sega License", "Zool (USA)", 0, 0 )
	SOFTWARE( zoolj, zool, 199?, "Sega License", "Zool no Yume Bouken (Jpn)", 0, 0 )
