...
WRITE8_HANDLER( adamnet_w )
{
	...
	*/
	UINT8 *BankBase;
	BankBase = &memory_region(machine, "|")[0x00000];
...
{
    /*logerror("Offset %04Xh = %02Xh\n",offset ,memory_region(machine, "|")[offset]);*/
    return memory_region(machine, "|")[offset+0x4000];
}
