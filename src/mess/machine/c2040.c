...
{
	DEVCB_MEMBER(base_c2040_device, dio_r),
	DEVCB_NULL,
	DEVCB_NULL,
	DEVCB_MEMBER(base_c2040_device, dio_w),
	DEVCB_NULL
};
...
{
	DEVCB_MEMBER(base_c2040_device, riot1_pa_r),
	DEVCB_MEMBER(base_c2040_device, riot1_pb_r),
	DEVCB_MEMBER(base_c2040_device, riot1_pa_w),
	DEVCB_MEMBER(base_c2040_device, riot1_pb_w),
...
{
	DEVCB_MEMBER(base_c2040_device, via_pa_r),
	DEVCB_NULL,
	DEVCB_LINE_MEMBER(base_c2040_device, ready_r),
	DEVCB_LINE_MEMBER(base_c2040_device, err_r),
	DEVCB_NULL,
	DEVCB_NULL,

	DEVCB_NULL,
	DEVCB_MEMBER(base_c2040_device, via_pb_w),
	DEVCB_NULL,
	DEVCB_NULL,
	DEVCB_LINE_MEMBER(base_c2040_device, mode_sel_w),
	DEVCB_LINE_MEMBER(base_c2040_device, rw_sel_w),
...
{
	DEVCB_MEMBER(base_c2040_device, via_pa_r),
	DEVCB_MEMBER(base_c2040_device, c8050_via_pb_r),
	DEVCB_LINE_MEMBER(base_c2040_device, ready_r),
	DEVCB_LINE_MEMBER(base_c2040_device, err_r),
	DEVCB_NULL,
	DEVCB_NULL,
	...
	DEVCB_NULL,
	DEVCB_MEMBER(base_c2040_device, c8050_via_pb_w),
	DEVCB_NULL,
	DEVCB_NULL,
	DEVCB_LINE_MEMBER(base_c2040_device, mode_sel_w),
	DEVCB_LINE_MEMBER(base_c2040_device, rw_sel_w),
...
{
	DEVCB_MEMBER(base_c2040_device, pi_r),
	DEVCB_MEMBER(base_c2040_device, pi_w),
	DEVCB_MEMBER(base_c2040_device, miot_pb_r),
	DEVCB_MEMBER(base_c2040_device, miot_pb_w)
};
...
static MOS6530_INTERFACE( c8050_miot_intf )
{
	DEVCB_MEMBER(base_c2040_device, pi_r),
	DEVCB_MEMBER(base_c2040_device, pi_w),
	DEVCB_MEMBER(base_c2040_device, c8050_miot_pb_r),
	DEVCB_MEMBER(base_c2040_device, c8050_miot_pb_w)
};
