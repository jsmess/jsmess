...
{
	DEVCB_DEVICE_LINE_MEMBER(DEVICE_SELF, kc_d002_device, out_irq_w),
	DEVCB_DEVICE_LINE_MEMBER(DEVICE_SELF, kc_d002_device, out_nmi_w),
	DEVCB_DEVICE_LINE_MEMBER(DEVICE_SELF, kc_d002_device, out_halt_w)
};
