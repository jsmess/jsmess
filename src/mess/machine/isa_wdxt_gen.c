...
{
	DEVCB_LINE_MEMBER(wdxt_gen_device, irq5_w),
	DEVCB_LINE_MEMBER(wdxt_gen_device, drq3_w),
	DEVCB_LINE_MEMBER(wdxt_gen_device, mr_w),
	DEVCB_NULL,
	DEVCB_NULL,
	DEVCB_CPU_INPUT_LINE(WD1015_TAG, MCS48_INPUT_IRQ),
	DEVCB_MEMBER(wdxt_gen_device, rd322_r),
	DEVCB_MEMBER(wdxt_gen_device, ram_r),
	DEVCB_MEMBER(wdxt_gen_device, ram_w),
