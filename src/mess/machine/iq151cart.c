...
const char * iq151cart_slot_device::get_default_card(const device_list &devlist, emu_options &options) const
{
	return software_get_default_slot(devlist, options, this, m_default_card, NULL);
}
