...
{
	DEVCB_DEVICE_LINE_MEMBER(DEVICE_SELF, ibm5160_mb_device, pc_dma_hrq_changed),
	DEVCB_DEVICE_LINE_MEMBER(DEVICE_SELF, ibm5160_mb_device, pc_dma8237_out_eop),
	DEVCB_DEVICE_MEMBER(DEVICE_SELF, ibm5160_mb_device, pc_dma_read_byte),
	DEVCB_DEVICE_MEMBER(DEVICE_SELF, ibm5160_mb_device, pc_dma_write_byte),

	{ DEVCB_NULL,
	  DEVCB_DEVICE_MEMBER(DEVICE_SELF, ibm5160_mb_device, pc_dma8237_1_dack_r),
	  DEVCB_DEVICE_MEMBER(DEVICE_SELF, ibm5160_mb_device, pc_dma8237_2_dack_r),
	  DEVCB_DEVICE_MEMBER(DEVICE_SELF, ibm5160_mb_device, pc_dma8237_3_dack_r) },


	{ DEVCB_DEVICE_MEMBER(DEVICE_SELF, ibm5160_mb_device, pc_dma8237_0_dack_w),
	  DEVCB_DEVICE_MEMBER(DEVICE_SELF, ibm5160_mb_device, pc_dma8237_1_dack_w),
	  DEVCB_DEVICE_MEMBER(DEVICE_SELF, ibm5160_mb_device, pc_dma8237_2_dack_w),
	  DEVCB_DEVICE_MEMBER(DEVICE_SELF, ibm5160_mb_device, pc_dma8237_3_dack_w) },

	// DACK's
	{ DEVCB_DEVICE_LINE_MEMBER(DEVICE_SELF, ibm5160_mb_device, pc_dack0_w),
	  DEVCB_DEVICE_LINE_MEMBER(DEVICE_SELF, ibm5160_mb_device, pc_dack1_w),
	  DEVCB_DEVICE_LINE_MEMBER(DEVICE_SELF, ibm5160_mb_device, pc_dack2_w),
	  DEVCB_DEVICE_LINE_MEMBER(DEVICE_SELF, ibm5160_mb_device, pc_dack3_w) }
};
...
{
	DEVCB_DEVICE_LINE_MEMBER(DEVICE_SELF, ibm5160_mb_device, pc_cpu_line),
	DEVCB_LINE_VCC,
	DEVCB_NULL
};
	...
	{
		{
			...
			DEVCB_NULL,
			DEVCB_DEVICE_LINE_MEMBER(DEVICE_SELF, ibm5160_mb_device, pc_pit8253_out1_changed)
		}, {
			XTAL_14_31818MHz/12,				/* pio port c pin 4, and speaker polling enough */
			DEVCB_NULL,
			DEVCB_DEVICE_LINE_MEMBER(DEVICE_SELF, ibm5160_mb_device, pc_pit8253_out2_changed)
		}
	}
};
...
{
	DEVCB_DEVICE_MEMBER(DEVICE_SELF, ibm5160_mb_device, pc_ppi_porta_r),
	DEVCB_NULL,
	DEVCB_NULL,
	DEVCB_DEVICE_MEMBER(DEVICE_SELF, ibm5160_mb_device, pc_ppi_portb_w),
	DEVCB_DEVICE_MEMBER(DEVICE_SELF, ibm5160_mb_device, pc_ppi_portc_r),
	DEVCB_NULL
};
