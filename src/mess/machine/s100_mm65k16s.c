...
static INPUT_PORTS_START( mm65k16s )
	...
	// ...
	PORT_DIPSETTING(    0xff, "FF0000H" ) PORT_CONDITION("s100_1:mm65k16s:J3", 0x01, PORTCOND_EQUALS, 0x01)
	PORT_DIPNAME( 0xff, 0x40, "Bank Select Port" ) PORT_CONDITION("s100_1:mm65k16s:J3", 0x01, PORTCOND_EQUALS, 0x00)
	PORT_DIPSETTING(    0x00, "00H" ) PORT_CONDITION("s100_1:mm65k16s:J3", 0x01, PORTCOND_EQUALS, 0x00)
	// ...
	...
	PORT_DIPSETTING(    0x01, "1" ) PORT_CONDITION("s100_1:mm65k16s:J3", 0x01, PORTCOND_EQUALS, 0x00)
	PORT_DIPNAME( 0x02, 0x00, "Bank Select Data Bit A1" ) PORT_CONDITION("s100_1:mm65k16s:J3", 0x01, PORTCOND_EQUALS, 0x00)
	PORT_DIPSETTING(    0x00, "0" ) PORT_CONDITION("s100_1:mm65k16s:J3", 0x01, PORTCOND_EQUALS, 0x00)
	PORT_DIPSETTING(    0x02, "1" ) PORT_CONDITION("s100_1:mm65k16s:J3", 0x01, PORTCOND_EQUALS, 0x00)
	PORT_DIPNAME( 0x04, 0x00, "Bank Select Data Bit A2" ) PORT_CONDITION("s100_1:mm65k16s:J3", 0x01, PORTCOND_EQUALS, 0x00)
	PORT_DIPSETTING(    0x00, "0" ) PORT_CONDITION("s100_1:mm65k16s:J3", 0x01, PORTCOND_EQUALS, 0x00)
	PORT_DIPSETTING(    0x04, "1" ) PORT_CONDITION("s100_1:mm65k16s:J3", 0x01, PORTCOND_EQUALS, 0x00)
	PORT_DIPNAME( 0x08, 0x00, "Bank Select Data Bit A3" ) PORT_CONDITION("s100_1:mm65k16s:J3", 0x01, PORTCOND_EQUALS, 0x00)
	PORT_DIPSETTING(    0x00, "0" ) PORT_CONDITION("s100_1:mm65k16s:J3", 0x01, PORTCOND_EQUALS, 0x00)
	PORT_DIPSETTING(    0x08, "1" ) PORT_CONDITION("s100_1:mm65k16s:J3", 0x01, PORTCOND_EQUALS, 0x00)
	PORT_DIPNAME( 0x10, 0x00, "Bank Select Data Bit A4" ) PORT_CONDITION("s100_1:mm65k16s:J3", 0x01, PORTCOND_EQUALS, 0x00)
	PORT_DIPSETTING(    0x00, "0" ) PORT_CONDITION("s100_1:mm65k16s:J3", 0x01, PORTCOND_EQUALS, 0x00)
	PORT_DIPSETTING(    0x10, "1" ) PORT_CONDITION("s100_1:mm65k16s:J3", 0x01, PORTCOND_EQUALS, 0x00)
	PORT_DIPNAME( 0x20, 0x00, "Bank Select Data Bit A5" ) PORT_CONDITION("s100_1:mm65k16s:J3", 0x01, PORTCOND_EQUALS, 0x00)
	PORT_DIPSETTING(    0x00, "0" ) PORT_CONDITION("s100_1:mm65k16s:J3", 0x01, PORTCOND_EQUALS, 0x00)
	PORT_DIPSETTING(    0x20, "1" ) PORT_CONDITION("s100_1:mm65k16s:J3", 0x01, PORTCOND_EQUALS, 0x00)
	PORT_DIPNAME( 0x40, 0x00, "Bank Select Data Bit A6" ) PORT_CONDITION("s100_1:mm65k16s:J3", 0x01, PORTCOND_EQUALS, 0x00)
	PORT_DIPSETTING(    0x00, "0" ) PORT_CONDITION("s100_1:mm65k16s:J3", 0x01, PORTCOND_EQUALS, 0x00)
	PORT_DIPSETTING(    0x40, "1" ) PORT_CONDITION("s100_1:mm65k16s:J3", 0x01, PORTCOND_EQUALS, 0x00)
	...
	PORT_DIPSETTING(    0x00, "0" ) PORT_CONDITION("s100_1:mm65k16s:J3", 0x01, PORTCOND_EQUALS, 0x00)
	PORT_DIPSETTING(    0x01, "1" ) PORT_CONDITION("s100_1:mm65k16s:J3", 0x01, PORTCOND_EQUALS, 0x00)
	PORT_DIPNAME( 0x02, 0x00, "Bank Select Data Bit 1B" ) PORT_CONDITION("s100_1:mm65k16s:J3", 0x01, PORTCOND_EQUALS, 0x00)
	PORT_DIPSETTING(    0x00, "0" ) PORT_CONDITION("s100_1:mm65k16s:J3", 0x01, PORTCOND_EQUALS, 0x00)
	PORT_DIPSETTING(    0x02, "1" ) PORT_CONDITION("s100_1:mm65k16s:J3", 0x01, PORTCOND_EQUALS, 0x00)
	PORT_DIPNAME( 0x04, 0x00, "Bank Select Data Bit 2B" ) PORT_CONDITION("s100_1:mm65k16s:J3", 0x01, PORTCOND_EQUALS, 0x00)
	PORT_DIPSETTING(    0x00, "0" ) PORT_CONDITION("s100_1:mm65k16s:J3", 0x01, PORTCOND_EQUALS, 0x00)
	PORT_DIPSETTING(    0x04, "1" ) PORT_CONDITION("s100_1:mm65k16s:J3", 0x01, PORTCOND_EQUALS, 0x00)
	PORT_DIPNAME( 0x08, 0x00, "Bank Select Data Bit 3B" ) PORT_CONDITION("s100_1:mm65k16s:J3", 0x01, PORTCOND_EQUALS, 0x00)
	PORT_DIPSETTING(    0x00, "0" ) PORT_CONDITION("s100_1:mm65k16s:J3", 0x01, PORTCOND_EQUALS, 0x00)
	PORT_DIPSETTING(    0x08, "1" ) PORT_CONDITION("s100_1:mm65k16s:J3", 0x01, PORTCOND_EQUALS, 0x00)
	PORT_DIPNAME( 0x10, 0x00, "Bank Select Data Bit 4B" ) PORT_CONDITION("s100_1:mm65k16s:J3", 0x01, PORTCOND_EQUALS, 0x00)
	PORT_DIPSETTING(    0x00, "0" ) PORT_CONDITION("s100_1:mm65k16s:J3", 0x01, PORTCOND_EQUALS, 0x00)
	PORT_DIPSETTING(    0x10, "1" ) PORT_CONDITION("s100_1:mm65k16s:J3", 0x01, PORTCOND_EQUALS, 0x00)
	PORT_DIPNAME( 0x20, 0x00, "Bank Select Data Bit 5B" ) PORT_CONDITION("s100_1:mm65k16s:J3", 0x01, PORTCOND_EQUALS, 0x00)
	PORT_DIPSETTING(    0x00, "0" ) PORT_CONDITION("s100_1:mm65k16s:J3", 0x01, PORTCOND_EQUALS, 0x00)
	PORT_DIPSETTING(    0x20, "1" ) PORT_CONDITION("s100_1:mm65k16s:J3", 0x01, PORTCOND_EQUALS, 0x00)
	PORT_DIPNAME( 0x40, 0x00, "Bank Select Data Bit 6B" ) PORT_CONDITION("s100_1:mm65k16s:J3", 0x01, PORTCOND_EQUALS, 0x00)
	PORT_DIPSETTING(    0x00, "0" ) PORT_CONDITION("s100_1:mm65k16s:J3", 0x01, PORTCOND_EQUALS, 0x00)
	PORT_DIPSETTING(    0x40, "1" ) PORT_CONDITION("s100_1:mm65k16s:J3", 0x01, PORTCOND_EQUALS, 0x00)
	PORT_DIPNAME( 0x80, 0x00, "Bank Select Data Bit 7B" ) PORT_CONDITION("s100_1:mm65k16s:J3", 0x01, PORTCOND_EQUALS, 0x00)
	PORT_DIPSETTING(    0x00, "0" ) PORT_CONDITION("s100_1:mm65k16s:J3", 0x01, PORTCOND_EQUALS, 0x00)
	PORT_DIPSETTING(    0x80, "1" ) PORT_CONDITION("s100_1:mm65k16s:J3", 0x01, PORTCOND_EQUALS, 0x00)
INPUT_PORTS_END
