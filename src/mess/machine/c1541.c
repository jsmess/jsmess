...
ROM_START( c1541 )
	...
	ROMX_LOAD( "jiffydos 1541.uab5", 0x4000, 0x2000, CRC(bc7e4aeb) SHA1(db6cfaa6d9b78d58746c811de29f3b1f44d99ddf), ROM_BIOS(7) )
    ROM_SYSTEM_BIOS(7, "speeddos", "SpeedDOS-Plus+" )
    ROMX_LOAD( "speed-dosplus.uab5", 0x4000, 0x4000, CRC(f9db1eac) SHA1(95407e59a9c1d26a0e4bcf2c244cfe8942576e2c), ROM_BIOS(8) )
ROM_END
...
ROM_START( c1541ii )
	...
	ROMX_LOAD( "jiffydos 1541-ii.u4", 0x4000, 0x4000, CRC(dd409902) SHA1(b1a5b826304d3df2a27d7163c6a81a532e040d32), ROM_BIOS(2) )
ROM_END
...
ROM_START( sx1541 )
    ...
    ROM_SYSTEM_BIOS(1, "jiffydos", "JiffyDOS v6.01" )
	ROMX_LOAD( "jiffydos sx1541",   0x4000, 0x4000, CRC(783575f6) SHA1(36ccb9ff60328c4460b68522443ecdb7f002a234), ROM_BIOS(2) )
    ROM_SYSTEM_BIOS(2, "flash", "1541 FLASH!" )
	ROMX_LOAD( "1541 flash.uab5",   0x8000, 0x2000, CRC(22f7757e) SHA1(86a1e43d3d22b35677064cca400a6bd06767a3dc), ROM_BIOS(3) )
ROM_END
...
ROM_START( oc118 )
	ROM_REGION( 0x4000, M6502_TAG, 0 )
    ROM_DEFAULT_BIOS("oceanic")
    ROM_SYSTEM_BIOS(0, "oceanic", "Oceanic" )
    ROMX_LOAD( "oc118a.u3", 0x0000, 0x4000, CRC(edf18265) SHA1(47a7c4bdcc20ecc5e59d694b151f493229becaea), ROM_BIOS(1) ) // scrambled address/data lines?
	ROMX_LOAD( "oc118b.u3", 0x0000, 0x4000, CRC(b39e4600) SHA1(991132fcc6e70e9a428062ae76055a150f2f7ac6), ROM_BIOS(1) ) // scrambled address/data lines?
    ROM_SYSTEM_BIOS(1, "jiffydos", "JiffyDOS v5.0" )
