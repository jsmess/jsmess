...
//	PORT_CATEGORY_ITEM( 0x40, "Lightpen", 24 )
	...
	PORT_START("LIGHTX") 
	PORT_BIT( 0x7e, 0x00, IPT_TRACKBALL_X) PORT_NAME("Lightpen X Axis") PORT_SENSITIVITY(100) PORT_KEYDELTA(0) PORT_PLAYER(1) PORT_CATEGORY(14)
	...
	PORT_START("LIGHTY") 
	PORT_BIT( 0x7e, 0x00, IPT_TRACKBALL_Y) PORT_NAME("Lightpen Y Axis") PORT_SENSITIVITY(100) PORT_KEYDELTA(0) PORT_PLAYER(1) PORT_CATEGORY(14) PORT_REVERSE
