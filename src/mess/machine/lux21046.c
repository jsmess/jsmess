...
static Z80DMA_INTERFACE( dma_intf )
{
	...
	DEVCB_DEVICE_LINE_MEMBER(DEVICE_SELF, luxor_55_21046_device, dma_int_w),
	DEVCB_NULL,
...
{
	DEVCB_NULL,
	DEVCB_DEVICE_LINE_MEMBER(DEVICE_SELF, luxor_55_21046_device, fdc_intrq_w),
...
/*  UINT8 *rom = subregion(Z80_TAG)->base();
