...
static ADDRESS_MAP_START( wangpc_rtc_io, AS_IO, 8, wangpc_rtc_device )
	...
	AM_RANGE(0x10, 0x1f) AM_DEVREADWRITE_LEGACY(AM9517A_TAG, i8237_r, i8237_w)
...
void wangpc_rtc_device::wangpcbus_aiowc_w(address_space &space, offs_t offset, UINT16 data, UINT16 mem_mask)
{
	if (sad(offset))
	{
		switch (offset & 0x7f)
