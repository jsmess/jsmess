...
static const m6502_interface m6510t_intf =
{
	...
	DEVCB_DEVICE_MEMBER(DEVICE_SELF, c1551_device, port_r),
	DEVCB_DEVICE_MEMBER(DEVICE_SELF, c1551_device, port_w)
};
...
{
	DEVCB_NULL,
	DEVCB_DEVICE_MEMBER(DEVICE_SELF, c1551_device, tcbm_data_r),
	DEVCB_DEVICE_MEMBER(DEVICE_SELF, c1551_device, tcbm_data_w),
	DEVCB_DEVICE_MEMBER(C64H156_TAG, c64h156_device, yb_r),
	DEVCB_DEVICE_MEMBER(C64H156_TAG, c64h156_device, yb_w),
	DEVCB_DEVICE_MEMBER(DEVICE_SELF, c1551_device, tpi0_pc_r),
	DEVCB_DEVICE_MEMBER(DEVICE_SELF, c1551_device, tpi0_pc_w),
	DEVCB_NULL,
	DEVCB_NULL
};
...
static const tpi6525_interface tpi1_intf =
{
	...
	DEVCB_DEVICE_MEMBER(DEVICE_SELF, c1551_device, tcbm_data_r),
	DEVCB_DEVICE_MEMBER(DEVICE_SELF, c1551_device, tcbm_data_w),
	DEVCB_DEVICE_MEMBER(DEVICE_SELF, c1551_device, tpi1_pb_r),
	DEVCB_NULL,
	DEVCB_DEVICE_MEMBER(DEVICE_SELF, c1551_device, tpi1_pc_r),
	DEVCB_DEVICE_MEMBER(DEVICE_SELF, c1551_device, tpi1_pc_w),
	DEVCB_NULL,
	DEVCB_NULL
};
