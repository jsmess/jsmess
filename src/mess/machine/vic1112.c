...
{
	DEVCB_NULL,
	DEVCB_MEMBER(vic1112_device, dio_r),
	DEVCB_NULL,
	DEVCB_LINE_MEMBER(vic1112_device, srq_r),
	DEVCB_NULL,
	DEVCB_NULL,

	DEVCB_MEMBER(vic1112_device, dio_w),
	DEVCB_NULL,
	DEVCB_NULL,
	DEVCB_NULL,
	DEVCB_LINE_MEMBER(vic1112_device, atn_w),
	DEVCB_LINE_MEMBER(vic1112_device, eoi_w),
