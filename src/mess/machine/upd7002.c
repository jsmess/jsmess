...
static DEVICE_SET_INFO( uPD7002 )
{
	switch (state)
	{
...
DEVICE_GET_INFO( uPD7002 )
{
	switch (state)
	{
		...
		case DEVINFO_FCT_SET_INFO:						info->set_info = DEVICE_SET_INFO_NAME(uPD7002); break;
		...
		case DEVINFO_STR_NAME:							info->s = "uPD7002";						break;
		case DEVINFO_STR_FAMILY:						info->s = "uPD7002";						break;
