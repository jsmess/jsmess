...
{
	DEVCB_MEMBER(c2031_device, via0_pa_r),
	DEVCB_MEMBER(c2031_device, via0_pb_r),
	DEVCB_LINE_MEMBER(c2031_device, via0_ca1_r),
	DEVCB_NULL,
	DEVCB_LINE_MEMBER(c2031_device, via0_ca2_r),
	DEVCB_NULL,

	DEVCB_MEMBER(c2031_device, via0_pa_w),
	DEVCB_MEMBER(c2031_device, via0_pb_w),
	DEVCB_NULL,
	DEVCB_NULL,
	DEVCB_NULL,
	DEVCB_NULL, // PLL SYN

	DEVCB_LINE_MEMBER(c2031_device, via0_irq_w)
};
...
static const via6522_interface via1_intf =
{
	...
	DEVCB_MEMBER(c2031_device, via1_pb_r),
...
static C64H156_INTERFACE( ga_intf )
{
	DEVCB_NULL,
	DEVCB_NULL,
	DEVCB_LINE_MEMBER(c2031_device, byte_w)
};
