...
{
	DEVCB_DEVICE_MEMBER(DEVICE_SELF, c8280_device, dio_r),
	DEVCB_NULL,
	DEVCB_NULL,
	DEVCB_DEVICE_MEMBER(DEVICE_SELF, c8280_device, dio_w),
	DEVCB_NULL
};
...
{
	DEVCB_DEVICE_MEMBER(DEVICE_SELF, c8280_device, riot1_pa_r),
	DEVCB_DEVICE_MEMBER(DEVICE_SELF, c8280_device, riot1_pb_r),
	DEVCB_DEVICE_MEMBER(DEVICE_SELF, c8280_device, riot1_pa_w),
	DEVCB_DEVICE_MEMBER(DEVICE_SELF, c8280_device, riot1_pb_w),
