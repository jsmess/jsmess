...
{
	isa8_com_at_device	*com  = downcast<isa8_com_at_device *>(device->owner());
...
static const ins8250_interface at_com_interface[4]=
{
	{
		1843200,
...
static MACHINE_CONFIG_FRAGMENT( com_config )
	MCFG_NS16450_ADD( "ns16450_0", at_com_interface[0] ) /* Verified: IBM P/N 6320947 Serial/Parallel card uses an NS16450N */
	MCFG_NS16450_ADD( "ns16450_1", at_com_interface[1] )
	MCFG_NS16450_ADD( "ns16450_2", at_com_interface[2] )
	MCFG_NS16450_ADD( "ns16450_3", at_com_interface[3] )
MACHINE_CONFIG_END
...
void isa8_com_at_device::device_start()
{
	set_isa_device();
	m_isa->install_device(subdevice("ns16450_0"), 0x03f8, 0x03ff, 0, 0, FUNC(ins8250_r), FUNC(ins8250_w) );
	m_isa->install_device(subdevice("ns16450_1"), 0x02f8, 0x02ff, 0, 0, FUNC(ins8250_r), FUNC(ins8250_w) );
	m_isa->install_device(subdevice("ns16450_2"), 0x03e8, 0x03ef, 0, 0, FUNC(ins8250_r), FUNC(ins8250_w) );
	m_isa->install_device(subdevice("ns16450_3"), 0x02e8, 0x02ef, 0, 0, FUNC(ins8250_r), FUNC(ins8250_w) );
}
...
void isa8_com_at_device::device_reset()
{
}
