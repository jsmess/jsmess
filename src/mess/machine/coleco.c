...
static INPUT_PORTS_START( sac1 )
	...
	PORT_BIT( 0x1000, IP_ACTIVE_LOW, IPT_BUTTON4 ) PORT_NAME("Blue Action Button P1") PORT_PLAYER(1)		PORT_CONDITION("CTRLSEL", 0x07, PORTCOND_EQUALS, 0x02)
	PORT_BIT( 0x2000, IP_ACTIVE_LOW, IPT_BUTTON3 ) PORT_NAME("Purple Action Button P1") PORT_PLAYER(1)		PORT_CONDITION("CTRLSEL", 0x07, PORTCOND_EQUALS, 0x02)
...
static INPUT_PORTS_START( sac2 )
	...
	PORT_BIT( 0x1000, IP_ACTIVE_LOW, IPT_BUTTON4 ) PORT_NAME("Blue Action Button P2") PORT_PLAYER(2)		PORT_CONDITION("CTRLSEL", 0x70, PORTCOND_EQUALS, 0x20)
	PORT_BIT( 0x2000, IP_ACTIVE_LOW, IPT_BUTTON3 ) PORT_NAME("Purple Action Button P2") PORT_PLAYER(2)		PORT_CONDITION("CTRLSEL", 0x70, PORTCOND_EQUALS, 0x20)
