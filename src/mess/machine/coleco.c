...
READ8_HANDLER ( coleco_paddle_r )
{
	...
	if ((offset & 0x02)==0)
	{
		...
		if (JoyMode==0)
		{
			...
			inport0 = input_port_read(machine, "IN0");
			inport1 = input_port_read(machine, "IN1");
			inport6 = input_port_read(machine, "IN6");
		...
		{
			int data = input_port_read(machine, "IN2") & 0xCF;
			int inport6 = input_port_read(machine, "IN6");
	...
	else
	{
		...
		if (JoyMode==0)
		{
			...
			inport3 = input_port_read(machine, "IN3");
			inport4 = input_port_read(machine, "IN4");
		...
		{
			int data = input_port_read(machine, "IN5") & 0xCF;
			int inport6 = input_port_read(machine, "IN6");
