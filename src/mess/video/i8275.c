...
static DEVICE_START( i8275 )
{
	...
	assert(i8275->intf->dma_request != NULL);
	...
	state_save_register_item(device->machine, "I8275", NULL, 0, i8275->status_reg);
	state_save_register_item(device->machine, "I8275", NULL, 0, i8275->num_of_params);
	state_save_register_item(device->machine, "I8275", NULL, 0, i8275->current_command);
	state_save_register_item(device->machine, "I8275", NULL, 0, i8275->param_type);

	state_save_register_item(device->machine, "I8275", NULL, 0, i8275->cursor_col);
	state_save_register_item(device->machine, "I8275", NULL, 0, i8275->cursor_row);

	state_save_register_item(device->machine, "I8275", NULL, 0, i8275->light_pen_col);
	state_save_register_item(device->machine, "I8275", NULL, 0, i8275->light_pen_row);

	state_save_register_item(device->machine, "I8275", NULL, 0, i8275->rows_type);
	state_save_register_item(device->machine, "I8275", NULL, 0, i8275->chars_per_row);
	state_save_register_item(device->machine, "I8275", NULL, 0, i8275->vert_retrace_rows);
	state_save_register_item(device->machine, "I8275", NULL, 0, i8275->rows_per_frame);
	state_save_register_item(device->machine, "I8275", NULL, 0, i8275->undeline_line_num);
	state_save_register_item(device->machine, "I8275", NULL, 0, i8275->lines_per_row);
	state_save_register_item(device->machine, "I8275", NULL, 0, i8275->line_counter_mode);
	state_save_register_item(device->machine, "I8275", NULL, 0, i8275->field_attribute_mode);
	state_save_register_item(device->machine, "I8275", NULL, 0, i8275->cursor_format);
	state_save_register_item(device->machine, "I8275", NULL, 0, i8275->hor_retrace_count);

	state_save_register_item(device->machine, "I8275", NULL, 0, i8275->burst_space_code);
	state_save_register_item(device->machine, "I8275", NULL, 0, i8275->burst_count_code);
...
DEVICE_GET_INFO( i8275 )
{
	switch (state)
	{
		...
		case DEVINFO_FCT_SET_INFO:						info->set_info = DEVICE_SET_INFO_NAME(i8275); break;
