...
static void primo_draw_scanline(running_machine *machine,bitmap_t *bitmap, int primo_scanline)
{
	...
	const UINT8* primo_video_ram_line = (const UINT8*)memory_get_read_ptr(cputag_get_address_space(machine, "maincpu", ADDRESS_SPACE_PROGRAM), primo_video_memory_base + 32 * primo_scanline);
