...
{
	DEVCB_NULL,
	DEVCB_DEVICE_MEMBER(DEVICE_SELF, iq151_grafik_device, x_write),
	DEVCB_NULL,
	DEVCB_DEVICE_MEMBER(DEVICE_SELF, iq151_grafik_device, y_write),
	DEVCB_NULL,
	DEVCB_DEVICE_MEMBER(DEVICE_SELF, iq151_grafik_device, control_w),
};
