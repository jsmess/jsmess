...
typedef void (*upd7220_draw_text_line)(device_t *device, bitmap_t *bitmap, UINT16 *vram, UINT32 addr, int y, int wd, int pitch);
#define UPD7220_DRAW_TEXT_LINE(name) void name(device_t *device, bitmap_t *bitmap, UINT16 *vram, UINT32 addr, int y, int wd, int pitch)
