...
{
	UINT8 *RAM = memory_region(machine, REGION_CPU1) + shifter.ofs;
...
{
	UINT8 *RAM = memory_region(machine, REGION_CPU1) + blitter.src;
...
{
	UINT8 *dst = memory_region(machine, REGION_CPU1) + dstaddr;
