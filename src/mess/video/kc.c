...
{
	EventList_AddItemOffset(KC85_VIDEO_EVENT_SET_BLINK_STATE, ((data & 0x01)<<7), TIME_TO_CYCLES(0,video_screen_get_vpos(0)*mame_time_to_double(video_screen_get_scan_period(0))));
}
