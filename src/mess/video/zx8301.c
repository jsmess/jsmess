...
static DEVICE_START( zx8301 )
{
	...
	state_save_register_item("zx8301", device->tag, 0, zx8301->dispoff);
	state_save_register_item("zx8301", device->tag, 0, zx8301->mode8);
	state_save_register_item("zx8301", device->tag, 0, zx8301->base);
	state_save_register_item("zx8301", device->tag, 0, zx8301->flash);
	state_save_register_item("zx8301", device->tag, 0, zx8301->vsync);
	state_save_register_item("zx8301", device->tag, 0, zx8301->vda);
