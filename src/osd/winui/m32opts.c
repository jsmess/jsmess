...
static const options_entry regSettings[] =
{
	...
	{ M32OPTION_COLUMN_WIDTHS,				"185,78,84,84,64,88,74,108,60,144,84,60", 0, NULL },
...
{
	return options_get_string(settings, M32OPTION_PCB_DIRECTORY);
}

void SetPcbDir(const char *path)
{
	options_set_string(settings, M32OPTION_PCB_DIRECTORY, path, OPTION_PRIORITY_CMDLINE);
}
