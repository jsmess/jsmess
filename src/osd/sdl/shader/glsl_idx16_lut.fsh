...
void main()
{
	...
	//color_map_coord.x = floor( 65535.0 * color_tex.a + 0.5 ); // the explanation, why 65536.0 just works ;-)
	...
	gl_FragColor = texture2D(colortable_texture, color_map_coord / colortable_pow2_sz);
}
